---
id: 0x99b791969d8647f4
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Opacity Texture Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Opacity Texture Rl Cops Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:NVIDIA:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS`, `0x99b791969d8647f4`)
