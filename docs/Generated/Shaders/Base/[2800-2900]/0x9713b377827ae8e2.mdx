---
id: 0x9713b377827ae8e2
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Self Illumination Self Illumination Bloom
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x9713b377827ae8e2`)
