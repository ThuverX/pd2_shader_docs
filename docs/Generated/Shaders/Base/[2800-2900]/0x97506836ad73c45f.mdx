---
id: 0x97506836ad73c45f
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Self Illumination Self Illumination Bloom
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x97506836ad73c45f`)
