---
id: 0x979651733a401945
title: "Generic Shadow Caster Ati Contour Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Skinned 1weight"
---

# Generic Shadow Caster Ati Contour Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Skinned 1weight
(`generic:shadow_caster:ATI:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT`, `0x979651733a401945`)
