---
id: 0x9518285cf2865a96
title: "Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Self Illumination Self Illumination Bloom
(`generic:default:DEPTH_SCALING:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x9518285cf2865a96`)
