---
id: 0x978889127f6dc729
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Nvidia Rl Bigprops Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Nvidia Rl Bigprops Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:NVIDIA:RL_BIGPROPS:SKINNED_1WEIGHT`, `0x978889127f6dc729`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-normalmap-rl-bigprops-skinned-1weight).
