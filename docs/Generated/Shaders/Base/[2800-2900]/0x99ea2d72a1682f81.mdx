---
id: 0x99ea2d72a1682f81
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NVIDIA:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_CHARACTER`, `0x99ea2d72a1682f81`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-opacity-texture-rl-civilians-skinned-3weights-vertex-color-vertex-color-character).
