---
id: 0x948a84b31de080b9
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller Self Illumination Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller Self Illumination Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:SELF_ILLUMINATION:VERTEX_COLOR`, `0x948a84b31de080b9`)
