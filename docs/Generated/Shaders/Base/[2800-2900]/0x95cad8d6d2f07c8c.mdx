---
id: 0x95cad8d6d2f07c8c
title: "Generic Customizable Shadow Caster Contour Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Rl Players Skinned 3weights Wear Tear Masking"
---

# Generic Customizable Shadow Caster Contour Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Rl Players Skinned 3weights Wear Tear Masking
(`generic_customizable:shadow_caster:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:RL_PLAYERS:SKINNED_3WEIGHTS:WEAR_TEAR_MASKING`, `0x95cad8d6d2f07c8c`)
