---
id: 0x995e129d7e7e1da2
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Normalmap Vegetation Bending Vertex Color Alpha"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Normalmap Vegetation Bending Vertex Color Alpha
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:VEGETATION_BENDING:VERTEX_COLOR_ALPHA`, `0x995e129d7e7e1da2`)
