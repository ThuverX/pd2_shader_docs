...
This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SIMPLE_TINT:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-double-sided-self-illumination-self-illumination-tint-simple-tint-vegetation-bending).
