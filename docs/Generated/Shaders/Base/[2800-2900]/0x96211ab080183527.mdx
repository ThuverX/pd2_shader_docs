---
id: 0x96211ab080183527
title: "Generic Shadow Caster Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Nvidia Opacity Texture Rl Players Simple Tint Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Nvidia Opacity Texture Rl Players Simple Tint Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:OPACITY_TEXTURE:RL_PLAYERS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0x96211ab080183527`)
