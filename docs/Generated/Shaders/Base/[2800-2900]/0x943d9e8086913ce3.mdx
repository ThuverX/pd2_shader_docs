---
id: 0x943d9e8086913ce3
title: "Opacity Default Cube Environment Mapping Diffuse Texture Opacity Controller Vertex Color"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Opacity Controller Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:VERTEX_COLOR`, `0x943d9e8086913ce3`)
