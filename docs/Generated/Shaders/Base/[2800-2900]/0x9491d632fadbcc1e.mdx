---
id: 0x9491d632fadbcc1e
title: "Generic Shadow Caster Blue Mask Tint Contour Cube Environment Mapping Diffuse Texture Normalmap Nvidia"
---

# Generic Shadow Caster Blue Mask Tint Contour Cube Environment Mapping Diffuse Texture Normalmap Nvidia
(`generic:shadow_caster:BLUE_MASK_TINT:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA`, `0x9491d632fadbcc1e`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-contour-cube-environment-mapping-diffuse-texture-normalmap).
