---
id: 0xe4c1246494c278a
title: "Generic Default Blend Diffuse Blend Mask Control Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Control Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:VERTEX_COLOR`, `0xe4c1246494c278a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-cube-environment-mapping-diffuse-texture-gloss-control-value-normalmap-vertex-color).
