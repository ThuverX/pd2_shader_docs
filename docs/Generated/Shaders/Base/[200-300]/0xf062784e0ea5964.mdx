---
id: 0xf062784e0ea5964
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:VERTEX_COLOR`, `0xf062784e0ea5964`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-vertex-color).
