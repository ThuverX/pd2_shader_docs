---
id: 0xe4f454170cb0eb8
title: "Generic Default Alpha Masked Diffuse Texture Double Sided Normalmap Opacity Texture Rl Environment"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided Normalmap Opacity Texture Rl Environment
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:OPACITY_TEXTURE:RL_ENVIRONMENT`, `0xe4f454170cb0eb8`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:OPACITY_TEXTURE:RL_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-normalmap-opacity-texture-rl-environment).
