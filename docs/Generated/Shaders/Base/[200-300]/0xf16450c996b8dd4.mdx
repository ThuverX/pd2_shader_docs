---
id: 0xf16450c996b8dd4
title: "Generic Shadow Caster Alpha Masked Ati Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Players Simple Tint Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Ati Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Players Simple Tint Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_PLAYERS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0xf16450c996b8dd4`)
