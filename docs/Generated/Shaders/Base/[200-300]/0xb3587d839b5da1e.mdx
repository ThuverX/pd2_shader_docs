---
id: 0xb3587d839b5da1e
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Texture Nvidia Opacity Texture Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Texture Nvidia Opacity Texture Rl Cops Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NVIDIA:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS`, `0xb3587d839b5da1e`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-gsma-texture-opacity-texture-rl-cops-skinned-3weights).
