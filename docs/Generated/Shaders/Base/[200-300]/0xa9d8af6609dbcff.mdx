---
id: 0xa9d8af6609dbcff
title: "Generic Default Blend Diffuse Blend Mask D A Blend Normal Diffuse Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Normal Diffuse Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP`, `0xa9d8af6609dbcff`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-normal-diffuse-texture-normalmap).
