---
id: 0xc33d04f82c19964
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Self Illumination Self Illumination Bloom Skinned 3weights"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Self Illumination Self Illumination Bloom Skinned 3weights
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS`, `0xc33d04f82c19964`)
