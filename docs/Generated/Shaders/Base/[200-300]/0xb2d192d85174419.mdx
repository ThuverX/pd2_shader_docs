---
id: 0xb2d192d85174419
title: "Shadow Caster Only Shadow Caster Alpha Masked External Alpha Ref Instanced Nvidia Shadow Caster Only"
---

# Shadow Caster Only Shadow Caster Alpha Masked External Alpha Ref Instanced Nvidia Shadow Caster Only
(`shadow_caster_only:shadow_caster:ALPHA_MASKED:EXTERNAL_ALPHA_REF:INSTANCED:NVIDIA:SHADOW_CASTER_ONLY`, `0xb2d192d85174419`)

This template is referenced 1 time by [shadow_caster_only:ALPHA_MASKED:EXTERNAL_ALPHA_REF:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-alpha-masked-external-alpha-ref-instanced).
