---
id: 0xddd4b62a77b33f6
title: "Generic Default Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xddd4b62a77b33f6`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-civilians-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
