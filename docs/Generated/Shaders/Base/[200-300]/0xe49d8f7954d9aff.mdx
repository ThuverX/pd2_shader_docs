---
id: 0xe49d8f7954d9aff
title: "Generic Shadow Caster Diffuse Texture Nvidia Vegetation Bending Vertex Color Alpha"
---

# Generic Shadow Caster Diffuse Texture Nvidia Vegetation Bending Vertex Color Alpha
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:VEGETATION_BENDING:VERTEX_COLOR_ALPHA`, `0xe49d8f7954d9aff`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:VEGETATION_BENDING:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-vegetation-bending-vertex-color-alpha).
