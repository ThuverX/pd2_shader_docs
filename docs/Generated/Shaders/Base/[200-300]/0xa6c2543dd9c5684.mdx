---
id: 0xa6c2543dd9c5684
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VEGETATION_BENDING`, `0xa6c2543dd9c5684`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-instanced-normalmap-opacity-texture-vegetation-bending).
