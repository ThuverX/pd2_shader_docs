---
id: 0xa26600909d8e3eb
title: "Opacity Default Diffuse Texture Normalmap Vertex Color"
---

# Opacity Default Diffuse Texture Normalmap Vertex Color
(`opacity:default:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xa26600909d8e3eb`)
