---
id: 0xe60c4d40f6a27ed
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia Self Illumination"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia Self Illumination
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NVIDIA:SELF_ILLUMINATION`, `0xe60c4d40f6a27ed`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-self-illumination).
