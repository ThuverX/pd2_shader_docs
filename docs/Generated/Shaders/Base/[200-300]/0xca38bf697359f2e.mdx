---
id: 0xca38bf697359f2e
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Cops Self Illumination Self Illumination Bloom Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Cops Self Illumination Self Illumination Bloom Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_COPS:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS`, `0xca38bf697359f2e`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-cops-self-illumination-self-illumination-bloom-skinned-3weights).
