---
id: 0xc0bc6b08a01f5ff
title: "Generic Shadow Caster Diffuse Texture Nvidia Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Nvidia Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION`, `0xc0bc6b08a01f5ff`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination).
