---
id: 0xde9d5ce97eec90e
title: "Generic Default Contour Diffuse Texture Global Environment Mapping Normalmap Rl Players Vertex Color Vertex Color Alpha"
---

# Generic Default Contour Diffuse Texture Global Environment Mapping Normalmap Rl Players Vertex Color Vertex Color Alpha
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_PLAYERS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0xde9d5ce97eec90e`)
