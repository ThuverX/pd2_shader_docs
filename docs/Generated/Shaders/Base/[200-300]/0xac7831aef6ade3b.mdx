---
id: 0xac7831aef6ade3b
title: "Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xac7831aef6ade3b`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-normal-diffuse-texture-normalmap-vertex-color).
