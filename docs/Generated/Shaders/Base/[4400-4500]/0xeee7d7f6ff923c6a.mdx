---
id: 0xeee7d7f6ff923c6a
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Instanced Normalmap Opacity Fade"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Instanced Normalmap Opacity Fade
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:OPACITY_FADE`, `0xeee7d7f6ff923c6a`)
