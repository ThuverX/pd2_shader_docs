---
id: 0xed662693685fe843
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Nvidia Skinned 1weight"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Nvidia Skinned 1weight
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT`, `0xed662693685fe843`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gloss-control-value-normalmap-skinned-1weight).
