---
id: 0xec80927fb5cf524b
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:SIMPLE_TINT`, `0xec80927fb5cf524b`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-simple-tint).
