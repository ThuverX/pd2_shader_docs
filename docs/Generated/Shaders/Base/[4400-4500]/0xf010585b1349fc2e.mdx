---
id: 0xf010585b1349fc2e
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Nvidia Take Fog Take Global Light"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Nvidia Take Fog Take Global Light
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NORMALMAP:NVIDIA:TAKE_FOG:TAKE_GLOBAL_LIGHT`, `0xf010585b1349fc2e`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NORMALMAP:TAKE_FOG:TAKE_GLOBAL_LIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-fps-normalmap-take-fog-take-global-light).
...
float3 GLOBAL_fog_far_low_color : register(ps_3_0, c21);
float GLOBAL_fog_max_range : register(ps_3_0, c23);
float GLOBAL_fog_min_range : register(ps_3_0, c22);
float3 GLOBAL_fog_start_color : register(ps_3_0, c20);
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    float3 temp2;
    // def c24, -0.5, 1, -1, 0.5773672
    // def c25, 0.9, 511.5, 0.3, 0
    // def c26, 0, 1, 2, 3
    // dcl_texcoord5 v0
    ...
    // mul_sat_pp r0.y, r0.y, c24.w
    ;// error
    // add r0.zw, -r0.xyyw, c24.y
    ...
    // mad r5, v0.xyzx, c26.yyyx, c26.xxxy
    ...
    // add_sat r2.xyz, r2, c25.z
    temp2.xyz = saturate(temp2.xyz + float3(0.3, 0.3, 0.3));
    // cmp r3.xyz, -r0.x, c26.x, r3.yzww
    ...
    temp0.xyz = /* not implemented _pp modifier */ temp1.yzw * temp1.xxx + temp0.xyz;
    // add r0.w, -c22.x, v0.w
