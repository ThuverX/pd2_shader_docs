---
id: 0xeb5fbb861d2044c5
title: "Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Cops Skinned 1weight"
---

# Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Cops Skinned 1weight
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_1WEIGHT`, `0xeb5fbb861d2044c5`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-double-sided-external-alpha-ref-normalmap-opacity-texture-rl-cops-skinned-1weight).
