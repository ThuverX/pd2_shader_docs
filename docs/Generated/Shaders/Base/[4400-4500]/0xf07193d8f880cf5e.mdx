---
id: 0xf07193d8f880cf5e
title: "Generic Default Contour Diffuse Texture Normalmap Rl Cops Skinned 3weights"
---

# Generic Default Contour Diffuse Texture Normalmap Rl Cops Skinned 3weights
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS`, `0xf07193d8f880cf5e`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-cops-skinned-3weights).
