---
id: 0xeb146601302175f0
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT`, `0xeb146601302175f0`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-rl-core-environment).
