---
id: 0xefe41f8c2e05e360
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade To Solid"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade To Solid
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_FADE_TO_SOLID`, `0xefe41f8c2e05e360`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE_TO_SOLID](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-opacity-fade-to-solid).
