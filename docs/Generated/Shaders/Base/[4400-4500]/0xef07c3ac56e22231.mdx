---
id: 0xef07c3ac56e22231
title: "Effect Default Diffuse0 Texture Double Sided Skinned 3weights View Angle Falloff Op"
---

# Effect Default Diffuse0 Texture Double Sided Skinned 3weights View Angle Falloff Op
(`effect:default:DIFFUSE0_TEXTURE:DOUBLE_SIDED:SKINNED_3WEIGHTS:VIEW_ANGLE_FALLOFF_OP`, `0xef07c3ac56e22231`)

This template is referenced 1 time by [effect:DIFFUSE0_TEXTURE:DOUBLE_SIDED:SKINNED_3WEIGHTS:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-diffuse0-texture-double-sided-skinned-3weights-view-angle-falloff-op).
