---
id: 0xeb1ff89f1fd5a728
title: "Generic Shadow Caster Ati Depth Scaling Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Ati Depth Scaling Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:ATI:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xeb1ff89f1fd5a728`)
