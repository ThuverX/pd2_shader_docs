---
id: 0xf04f6491e5f3f899
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:SELF_ILLUMINATION:VERTEX_COLOR`, `0xf04f6491e5f3f899`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-self-illumination-vertex-color).
