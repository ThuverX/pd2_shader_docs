---
id: 0xec03016790a66fd4
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_BIGPROPS`, `0xec03016790a66fd4`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-normalmap-rl-bigprops).
