---
id: 0xebacaba285af47ad
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Nvidia Opacity Fade To Solid Take Fog"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Nvidia Opacity Fade To Solid Take Fog
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:NORMALMAP:NVIDIA:OPACITY_FADE_TO_SOLID:TAKE_FOG`, `0xebacaba285af47ad`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:NORMALMAP:OPACITY_FADE_TO_SOLID:TAKE_FOG](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-distortion-normalmap-opacity-fade-to-solid-take-fog).
