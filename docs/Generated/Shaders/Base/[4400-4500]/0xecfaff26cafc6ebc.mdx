---
id: 0xecfaff26cafc6ebc
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Ati Diffuse Texture Double Sided External Alpha Ref Foliage Rendering Normalmap Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Ati Diffuse Texture Double Sided External Alpha Ref Foliage Rendering Normalmap Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:FOLIAGE_RENDERING:NORMALMAP:VEGETATION_BENDING`, `0xecfaff26cafc6ebc`)
