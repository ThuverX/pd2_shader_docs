---
id: 0xf01a53738cc3478f
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 4 External Alpha Ref Instanced Normalmap Vegetation Bending"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 4 External Alpha Ref Instanced Normalmap Vegetation Bending
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:VEGETATION_BENDING`, `0xf01a53738cc3478f`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-4-external-alpha-ref-instanced-normalmap-vegetation-bending).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // def c216, 2, -0.5, 3, -7800
    // def c217, 0.00023809524, 0, 0, 0
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord1 v2
    // dcl_texcoord v3
    ...
    temp0.x = temp0.y * temp0.x + float1(-7800);
    // mov o1.x, r0.y
