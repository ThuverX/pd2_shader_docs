---
id: 0xefdd9aa1dc5226ad
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Fade Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Fade Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE:VERTEX_COLOR`, `0xefdd9aa1dc5226ad`)
