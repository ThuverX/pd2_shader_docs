---
id: 0xce6f89df852341a3
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Self Illumination Self Illumination Tint"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Self Illumination Self Illumination Tint
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT`, `0xce6f89df852341a3`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-instanced-normalmap-opacity-texture-self-illumination-self-illumination-tint).
