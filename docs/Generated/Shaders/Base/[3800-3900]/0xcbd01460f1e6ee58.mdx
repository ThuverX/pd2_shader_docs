---
id: 0xcbd01460f1e6ee58
title: "Generic Default Diffuse Texture Normalmap Simple Tint Skinned 1weight"
---

# Generic Default Diffuse Texture Normalmap Simple Tint Skinned 1weight
(`generic:default:DIFFUSE_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_1WEIGHT`, `0xcbd01460f1e6ee58`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-simple-tint-skinned-1weight).
