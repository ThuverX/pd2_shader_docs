---
id: 0xcfb5376b6904426f
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Backdrop"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Backdrop
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BACKDROP`, `0xcfb5376b6904426f`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_BACKDROP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-backdrop).
