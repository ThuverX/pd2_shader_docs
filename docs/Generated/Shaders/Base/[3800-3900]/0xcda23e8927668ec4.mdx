---
id: 0xcda23e8927668ec4
title: "Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 3weights"
---

# Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 3weights
(`shadow_caster_only:shadow_caster:NVIDIA:SHADOW_CASTER_ONLY:SKINNED_3WEIGHTS`, `0xcda23e8927668ec4`)

This template is referenced 1 time by [shadow_caster_only:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-skinned-3weights).
