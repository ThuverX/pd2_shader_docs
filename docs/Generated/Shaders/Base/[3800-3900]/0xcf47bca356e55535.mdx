---
id: 0xcf47bca356e55535
title: "Generic Default Align Normal World Z Alpha Masked Diffuse Texture External Alpha Ref Normalmap"
---

# Generic Default Align Normal World Z Alpha Masked Diffuse Texture External Alpha Ref Normalmap
(`generic:default:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP`, `0xcf47bca356e55535`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-external-alpha-ref-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    temp1.yzw = /* not implemented _pp modifier */ temp1.xxx * temp2.xyz;
    // mad r2.xyz, r2, -r1.x, c2.wwxw
    temp2.xyz = temp2.xyz * -temp1.xxx + float3(0, 0, 1);
    // mad_pp r1.xyz, c1.x, r2, r1.yzww
    temp1.xyz = /* not implemented _pp modifier */ ref_normal_world_z_blend.xxx * temp2.xyz + temp1.yzw;
    // nrm_pp r2.xyz, r1
