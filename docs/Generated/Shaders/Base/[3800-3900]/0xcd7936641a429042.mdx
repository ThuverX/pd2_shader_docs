---
id: 0xcd7936641a429042
title: "Generic Default Contour Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Contour Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xcd7936641a429042`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
