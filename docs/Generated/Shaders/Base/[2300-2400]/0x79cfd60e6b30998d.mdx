---
id: 0x79cfd60e6b30998d
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x79cfd60e6b30998d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-civilians-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
