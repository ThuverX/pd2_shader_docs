---
id: 0x7cca7953c61d5b5e
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Simple Tint"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Simple Tint
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:SIMPLE_TINT`, `0x7cca7953c61d5b5e`)
