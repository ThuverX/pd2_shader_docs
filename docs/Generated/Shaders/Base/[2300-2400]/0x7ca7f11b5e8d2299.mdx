---
id: 0x7ca7f11b5e8d2299
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA`, `0x7ca7f11b5e8d2299`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-global-environment-mapping-gloss-blurs-cubemap-gloss-control-value-normalmap-vegetation-bending-vertex-alpha).
