---
id: 0x79d96fc3e0a0badb
title: "Generic Shadow Caster Ati Blend Diffuse Blend Normal Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Normal Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x79d96fc3e0a0badb`)
