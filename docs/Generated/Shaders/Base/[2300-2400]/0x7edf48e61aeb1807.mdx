---
id: 0x7edf48e61aeb1807
title: "Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Mask Control Blend Normal Blend Normal Uv2 Diffuse Texture Gloss Control Value Normalmap Rl Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Mask Control Blend Normal Blend Normal Uv2 Diffuse Texture Gloss Control Value Normalmap Rl Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_MASK_CONTROL:BLEND_NORMAL:BLEND_NORMAL_UV2:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR`, `0x7edf48e61aeb1807`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_MASK_CONTROL:BLEND_NORMAL:BLEND_NORMAL_UV2:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-diffuse-uv2-blend-mask-control-blend-normal-blend-normal-uv2-diffuse-texture-gloss-control-value-normalmap-rl-environment-vertex-color).
