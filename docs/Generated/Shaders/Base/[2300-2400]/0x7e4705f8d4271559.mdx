---
id: 0x7e4705f8d4271559
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture Normalmap"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture Normalmap
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOSS_BLURS_CUBEMAP:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP`, `0x7e4705f8d4271559`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOSS_BLURS_CUBEMAP:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-double-sided-external-alpha-ref-gloss-blurs-cubemap-gsma-alpha-masking-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // cmp_pp r1.xyz, -r0.w, r1, -r1
    temp1.xyz = /* not implemented _pp modifier */ (-temp0.www >= 0) ? temp1.xyz : -temp1.xyz;
    // add r2.x, c0.w, -v5.x
    ...
    // texldl r1, r2, s3
    temp1 = texCUBElod(reflection_texture, temp2);
    // mul r1.xyz, r0.w, r1
