---
id: 0x79bf8a3ea665b8a9
title: "Generic Shadow Caster Diffuse Texture Normalmap Rl Core Environment Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Normalmap Rl Core Environment Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION`, `0x79bf8a3ea665b8a9`)
