---
id: 0x7dea9723f9dbcdea
title: "Generic Default Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Opacity Texture"
---

# Generic Default Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Opacity Texture
(`generic:default:ALPHA_MASKED:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_TEXTURE`, `0x7dea9723f9dbcdea`)
