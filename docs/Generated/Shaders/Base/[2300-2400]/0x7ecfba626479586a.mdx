---
id: 0x7ecfba626479586a
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Environment Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Environment Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_ENVIRONMENT:VERTEX_COLOR`, `0x7ecfba626479586a`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-rl-environment-vertex-color).
