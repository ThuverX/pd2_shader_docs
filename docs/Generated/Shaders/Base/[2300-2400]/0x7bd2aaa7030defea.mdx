---
id: 0x7bd2aaa7030defea
title: "Generic Default Cube Environment Mapping Diffuse Texture Instanced Normalmap Self Illumination"
---

# Generic Default Cube Environment Mapping Diffuse Texture Instanced Normalmap Self Illumination
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION`, `0x7bd2aaa7030defea`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-normalmap-self-illumination).
