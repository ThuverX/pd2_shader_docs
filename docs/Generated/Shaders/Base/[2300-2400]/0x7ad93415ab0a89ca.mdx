---
id: 0x7ad93415ab0a89ca
title: "Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced Nvidia"
---

# Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced Nvidia
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED:NVIDIA`, `0x7ad93415ab0a89ca`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-blend-tint-second-diffuse-texture-instanced).
