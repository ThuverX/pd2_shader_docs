---
id: 0x7abb6eedcae72d03
title: "Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Cops Skinned 3weights"
---

# Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Cops Skinned 3weights
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS`, `0x7abb6eedcae72d03`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-external-alpha-ref-normalmap-opacity-texture-rl-cops-skinned-3weights).
