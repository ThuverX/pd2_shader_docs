---
id: 0x7ecb8e5403cd93df
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Instanced Self Illumination"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Instanced Self Illumination
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:INSTANCED:SELF_ILLUMINATION`, `0x7ecb8e5403cd93df`)
