---
id: 0x79c9e1fe01e533d2
title: "Generic Customizable Shadow Caster Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Nvidia Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Skinned 3weights Wear Tear Masking"
---

# Generic Customizable Shadow Caster Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Nvidia Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Skinned 3weights Wear Tear Masking
(`generic_customizable:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:NVIDIA:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:SKINNED_3WEIGHTS:WEAR_TEAR_MASKING`, `0x79c9e1fe01e533d2`)

This template is referenced 1 time by [generic_customizable:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:SKINNED_3WEIGHTS:WEAR_TEAR_MASKING](/docs/Generated/Render%20Templates/base.render_template_database#generic-customizable-cube-environment-mapping-decal-sticker-uv2-diffuse-texture-gradientmap-normalmap-pattern-gradientmap-pattern-gradientmap-angle-offset-pattern-uv2-skinned-3weights-wear-tear-masking).
