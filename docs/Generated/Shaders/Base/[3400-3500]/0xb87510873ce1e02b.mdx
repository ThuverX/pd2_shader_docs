---
id: 0xb87510873ce1e02b
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Vertex Color"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Vertex Color
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xb87510873ce1e02b`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-external-alpha-ref-gsma-texture-normalmap-vertex-color).
