...
This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DOF_CUTTER:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-dof-cutter-view-angle-falloff-op).
