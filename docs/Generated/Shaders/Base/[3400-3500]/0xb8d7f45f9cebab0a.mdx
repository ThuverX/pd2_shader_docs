---
id: 0xb8d7f45f9cebab0a
title: "Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Environment Vertex Color"
---

# Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Environment Vertex Color
(`generic:shadow_caster:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_ENVIRONMENT:VERTEX_COLOR`, `0xb8d7f45f9cebab0a`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-cube-environment-mapping-diffuse-texture-instanced-rl-environment-vertex-color).
