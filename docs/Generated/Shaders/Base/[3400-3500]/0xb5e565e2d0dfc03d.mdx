---
id: 0xb5e565e2d0dfc03d
title: "Opacity Default Ati Cube Environment Mapping Diffuse Texture Opacity Controller Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Diffuse Texture Opacity Controller Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:VERTEX_COLOR`, `0xb5e565e2d0dfc03d`)
