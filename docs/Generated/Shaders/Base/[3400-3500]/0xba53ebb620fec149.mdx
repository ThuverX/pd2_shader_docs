---
id: 0xba53ebb620fec149
title: "Generic Default Cube Environment Mapping Diffuse Texture Double Sided"
---

# Generic Default Cube Environment Mapping Diffuse Texture Double Sided
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED`, `0xba53ebb620fec149`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-double-sided).
