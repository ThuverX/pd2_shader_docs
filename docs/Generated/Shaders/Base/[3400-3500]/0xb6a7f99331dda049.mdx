---
id: 0xb6a7f99331dda049
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Skinned 1weight Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Skinned 1weight Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT:VERTEX_COLOR`, `0xb6a7f99331dda049`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SKINNED_1WEIGHT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-normalmap-skinned-1weight-vertex-color).
