---
id: 0xb777de1301718bed
title: "Generic Default Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xb777de1301718bed`)
