---
id: 0xb9aa7e5cebcb6706
title: "Generic Default Blend Diffuse Blend Mask D A Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask D A Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0xb9aa7e5cebcb6706`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap).
