---
id: 0xb8c82d71c0f6ea5e
title: "Generic Default Detail Texture Diffuse Texture Instanced Normalmap"
---

# Generic Default Detail Texture Diffuse Texture Instanced Normalmap
(`generic:default:DETAIL_TEXTURE:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP`, `0xb8c82d71c0f6ea5e`)

This template is referenced 1 time by [generic:DETAIL_TEXTURE:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-detail-texture-diffuse-texture-instanced-normalmap).
This template uses the following inputs:
 |Name|UI Name|Type|
|---|---|---|
|diffuse_texture|Diffuse Texture (UV1)|texture|
|bump_normal_texture|Normal map (UV2 else UV1)|texture|
|detail_diffuse_texture|Detail Diffuse Texture|texture|
|detail_normal_map|Detail Normal Map|texture|
|detail_scale|Detail Texture Scale|vector3|.
...
float3 ref_detail_scale : register(vs_3_0, c205);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mul o6.xy, c205, v2
    o.texcoord6 = ref_detail_scale * i.texcoord1;
    // mov o2.xy, v3
