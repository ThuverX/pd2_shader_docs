---
id: 0xb882607962101106
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Nvidia Vegetation Bending Vertex Alpha"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Nvidia Vegetation Bending Vertex Alpha
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:VEGETATION_BENDING:VERTEX_ALPHA`, `0xb882607962101106`)
