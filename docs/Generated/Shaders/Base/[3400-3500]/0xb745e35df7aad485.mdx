---
id: 0xb745e35df7aad485
title: "Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Civilians Simple Tint Skinned 3weights"
---

# Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Civilians Simple Tint Skinned 3weights
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0xb745e35df7aad485`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-double-sided-external-alpha-ref-normalmap-opacity-texture-rl-civilians-simple-tint-skinned-3weights).
