---
id: 0xb714a364b5ba4b8d
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VERTEX_COLOR`, `0xb714a364b5ba4b8d`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-normalmap-opacity-texture-vertex-color).
