---
id: 0xba234a8bfe0c8a95
title: "Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0xba234a8bfe0c8a95`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-normalmap-skinned-3weights).
