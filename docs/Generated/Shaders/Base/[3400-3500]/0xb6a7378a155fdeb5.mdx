---
id: 0xb6a7378a155fdeb5
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0xb6a7378a155fdeb5`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-gloss-blurs-cubemap-gsma-texture-normalmap-skinned-3weights).
