---
id: 0xb92e9e614d4ecadc
title: "Generic Shadow Caster Blend Diffuse Blend Mask Gg Blend Smooth Blend Tint Second Diffuse Texture Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Blend Diffuse Blend Mask Gg Blend Smooth Blend Tint Second Diffuse Texture Instanced Normalmap Nvidia
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_GG:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA`, `0xb92e9e614d4ecadc`)
