---
id: 0x48fc72bd60bdc617
title: "Generic Default Blend Diffuse Blend Mask D A Blend Normal Blend Smooth Blend Tint Second Diffuse Texture Normalmap Rl Environment"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Normal Blend Smooth Blend Tint Second Diffuse Texture Normalmap Rl Environment
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT`, `0x48fc72bd60bdc617`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-normal-blend-smooth-blend-tint-second-diffuse-texture-normalmap-rl-environment).
