---
id: 0x45ce8ade9b065b46
title: "Generic Shadow Caster Alpha Masked Ati Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Ati Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:ATI:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_TEXTURE`, `0x45ce8ade9b065b46`)
