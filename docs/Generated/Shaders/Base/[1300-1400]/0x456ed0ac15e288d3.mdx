---
id: 0x456ed0ac15e288d3
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap World Up Blend"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap World Up Blend
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:WORLD_UP_BLEND`, `0x456ed0ac15e288d3`)
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r1.w, r3.x, -v1.x
    temp1.w = /* not implemented _pp modifier */ temp3.x + -i.texcoord7.x;
    // rcp r2.w, c3.x
    ...
    // mad_pp oC0.xyz, r1, r0.z, r4
    o.color.xyz = /* not implemented _pp modifier */ temp1.xyz * temp0.zzz + temp4.xyz;
    // mov oC0.w, r0.y
    o.color.w = temp0.y;
    // mov_pp oC1.w, r0.x
