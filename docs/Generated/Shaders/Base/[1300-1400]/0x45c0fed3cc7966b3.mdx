---
id: 0x45c0fed3cc7966b3
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0x45c0fed3cc7966b3`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-instanced-normalmap-vertex-color).
