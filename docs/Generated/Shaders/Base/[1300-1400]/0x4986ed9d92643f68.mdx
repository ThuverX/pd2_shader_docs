---
id: 0x4986ed9d92643f68
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture Normalmap Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture Normalmap Rl Civilians Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x4986ed9d92643f68`)
