---
id: 0x49a8dd2aaffedbad
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Controller Vegetation Bending"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Controller Vegetation Bending
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:NVIDIA:OPACITY_CONTROLLER:VEGETATION_BENDING`, `0x49a8dd2aaffedbad`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_CONTROLLER:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-opacity-controller-vegetation-bending).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v6.xxyz, c18.x, c18.y
    ...
    // dp3 r4.x, r0.yzww, c0
    temp4.x = dot(temp0.yzw, (world_matrix._m00_m10_m20_m30).xyz);
    // mad r0.yzw, v7.xxyz, c18.x, c18.y
    ...
    // dp3 r4.y, -r0.yzww, c0
    temp4.y = dot(-temp0.yzw, (world_matrix._m00_m10_m20_m30).xyz);
    // mov o5.xyz, r4
    o.texcoord2 = temp4;
    // mov r1.x, c13.x
    temp1.x = ref_time.x;
    ...
    // mad o4.zw, r1.x, c14.xyxy, v3.xyxy
