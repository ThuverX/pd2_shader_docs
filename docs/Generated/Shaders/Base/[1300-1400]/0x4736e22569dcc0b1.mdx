---
id: 0x4736e22569dcc0b1
title: "Generic Shadow Caster Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided External Alpha Ref Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided External Alpha Ref Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NVIDIA:OPACITY_TEXTURE`, `0x4736e22569dcc0b1`)
