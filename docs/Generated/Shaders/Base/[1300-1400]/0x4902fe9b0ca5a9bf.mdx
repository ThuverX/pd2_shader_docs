---
id: 0x4902fe9b0ca5a9bf
title: "Generic Default Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights"
---

# Generic Default Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights
(`generic:default:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS`, `0x4902fe9b0ca5a9bf`)
