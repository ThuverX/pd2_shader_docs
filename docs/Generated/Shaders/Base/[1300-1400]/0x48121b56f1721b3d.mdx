---
id: 0x48121b56f1721b3d
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Opacity Texture"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Opacity Texture
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE`, `0x48121b56f1721b3d`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-gsma-texture-normalmap-opacity-texture).
