---
id: 0x4755af9e3b55de18
title: "Generic Shadow Caster Ati Contour Diffuse Texture Normalmap Rl Players Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Ati Contour Diffuse Texture Normalmap Rl Players Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:ATI:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_PLAYERS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x4755af9e3b55de18`)
