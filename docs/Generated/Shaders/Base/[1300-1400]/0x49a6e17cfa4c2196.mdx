---
id: 0x49a6e17cfa4c2196
title: "Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment"
---

# Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT`, `0x49a6e17cfa4c2196`)
