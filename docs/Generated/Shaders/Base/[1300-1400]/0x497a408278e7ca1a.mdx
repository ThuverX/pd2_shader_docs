---
id: 0x497a408278e7ca1a
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination Self Illumination Bloom Skinned 3weights"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination Self Illumination Bloom Skinned 3weights
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS`, `0x497a408278e7ca1a`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-normalmap-self-illumination-self-illumination-bloom-skinned-3weights).
