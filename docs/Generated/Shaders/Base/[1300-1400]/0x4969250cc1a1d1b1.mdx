---
id: 0x4969250cc1a1d1b1
title: "Generic Default Alpha Masked Diffuse Texture Gsma Alpha Masking Gsma Texture Normalmap Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture Gsma Alpha Masking Gsma Texture Normalmap Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x4969250cc1a1d1b1`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-gsma-alpha-masking-gsma-texture-normalmap-vertex-color).
