---
id: 0x497eb4a72b0adbf1
title: "Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Opacity Controller Vertex Color"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Opacity Controller Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:OPACITY_CONTROLLER:VERTEX_COLOR`, `0x497eb4a72b0adbf1`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-opacity-controller-vertex-color).
