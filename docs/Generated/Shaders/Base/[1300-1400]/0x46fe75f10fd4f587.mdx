---
id: 0x46fe75f10fd4f587
title: "Opacity Default Diffuse Texture Normalmap Nvidia Opacity Controller Vertex Color"
---

# Opacity Default Diffuse Texture Normalmap Nvidia Opacity Controller Vertex Color
(`opacity:default:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_CONTROLLER:VERTEX_COLOR`, `0x46fe75f10fd4f587`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_CONTROLLER:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-normalmap-opacity-controller-vertex-color).
