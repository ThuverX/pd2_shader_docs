---
id: 0x45fa1998fe7620bb
title: "Generic Shadow Caster Blend Diffuse Blend Gsma Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Blend Diffuse Blend Gsma Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Nvidia Vertex Color
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0x45fa1998fe7620bb`)
