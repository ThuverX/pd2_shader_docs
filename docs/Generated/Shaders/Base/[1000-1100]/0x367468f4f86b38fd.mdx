---
id: 0x367468f4f86b38fd
title: "Generic Default Diffuse Texture Gloss Control Value Normalmap Simple Tint"
---

# Generic Default Diffuse Texture Gloss Control Value Normalmap Simple Tint
(`generic:default:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT`, `0x367468f4f86b38fd`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gloss-control-value-normalmap-simple-tint).
