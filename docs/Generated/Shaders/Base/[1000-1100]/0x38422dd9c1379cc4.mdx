---
id: 0x38422dd9c1379cc4
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Nvidia Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Nvidia Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:OPACITY_FADE`, `0x38422dd9c1379cc4`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_FADE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-instanced-normalmap-opacity-fade).
...
float3 ref_opacity_fade : register(vs_3_0, c209);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // rcp r1.x, c209.y
    temp1.x = 1.0f / ref_opacity_fade.y;
    // dp4 r1.w, r0, c207
    ...
    temp0.x = saturate(temp1.x * temp0.x);
    // add o2.x, -r0.x, -c210.y
    o.texcoord7 = -temp0.x + float4(1, 1, 1, 1);
    // mad r0.xyz, v6, c210.x, c210.y
