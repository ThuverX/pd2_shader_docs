---
id: 0x38fbd2a0da5fa8f6
title: "Generic Default Cube Environment Mapping Diffuse Texture Normalmap Normal Uvanim Rl Backdrop"
---

# Generic Default Cube Environment Mapping Diffuse Texture Normalmap Normal Uvanim Rl Backdrop
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM:RL_BACKDROP`, `0x38fbd2a0da5fa8f6`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM:RL_BACKDROP](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-normal-uvanim-rl-backdrop).
