---
id: 0x36581baf0844a33c
title: "Generic Default Contour Diffuse Texture Normalmap Skinned 3weights Vertex Color"
---

# Generic Default Contour Diffuse Texture Normalmap Skinned 3weights Vertex Color
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR`, `0x36581baf0844a33c`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-skinned-3weights-vertex-color).
