---
id: 0x372592ceebe9ca5a
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Control Value Normalmap Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Control Value Normalmap Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_CONTROL_VALUE:NORMALMAP:SKINNED_3WEIGHTS`, `0x372592ceebe9ca5a`)
