---
id: 0x3887f5bb336b0788
title: "Effect Default Diffuse0 Texture Diffuse0 Uvanim View Angle Falloff Op"
---

# Effect Default Diffuse0 Texture Diffuse0 Uvanim View Angle Falloff Op
(`effect:default:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:VIEW_ANGLE_FALLOFF_OP`, `0x3887f5bb336b0788`)

This template is referenced 1 time by [effect:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-diffuse0-texture-diffuse0-uvanim-view-angle-falloff-op).
