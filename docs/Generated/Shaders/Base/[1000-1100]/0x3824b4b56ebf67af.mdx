---
id: 0x3824b4b56ebf67af
title: "Decal Default Diffuse Texture Simple Tint"
---

# Decal Default Diffuse Texture Simple Tint
(`decal:default:DIFFUSE_TEXTURE:SIMPLE_TINT`, `0x3824b4b56ebf67af`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-simple-tint).
