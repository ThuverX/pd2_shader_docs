---
id: 0x38104c570728ba0a
title: "Generic Default Blend Diffuse Blend Mask Gg Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap"
---

# Generic Default Blend Diffuse Blend Mask Gg Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_GG:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP`, `0x38104c570728ba0a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_GG:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-gg-blend-normal-blend-smooth-diffuse-texture-instanced-normalmap).
