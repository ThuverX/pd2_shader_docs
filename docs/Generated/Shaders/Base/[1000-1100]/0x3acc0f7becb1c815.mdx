---
id: 0x3acc0f7becb1c815
title: "Generic Default Cube Environment Mapping Detail Texture 2 Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Cube Environment Mapping Detail Texture 2 Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DETAIL_TEXTURE_2:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x3acc0f7becb1c815`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DETAIL_TEXTURE_2:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-detail-texture-2-diffuse-texture-gsma-texture-normalmap-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r1.xy, c3.x, v1
    temp1.xy = float2(8, 8) * i.texcoord.xy;
    // texld_pp r1, r1, s1
    temp1 = /* not implemented _pp modifier */ tex2D(diffuse_layer1_texture, temp1.xy);
    // add_pp r0.w, r1.y, r1.y
    temp0.w = /* not implemented _pp modifier */ temp1.y + temp1.y;
    // texld_pp r1, v1, s0
    temp1 = /* not implemented _pp modifier */ tex2D(diffuse_texture, i.texcoord.xy);
    // mul_pp r1.xyz, r0.w, r1
    temp1.xyz = /* not implemented _pp modifier */ temp0.www * temp1.xyz;
    // mad_pp oC0.xyz, r1, v6, r0
