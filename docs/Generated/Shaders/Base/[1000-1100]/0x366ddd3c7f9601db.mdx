---
id: 0x366ddd3c7f9601db
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT`, `0x366ddd3c7f9601db`)
