---
id: 0x381f02dc6ca37662
title: "Effect Default Dof Cutter Cut Far Dof Cutter Standard"
---

# Effect Default Dof Cutter Cut Far Dof Cutter Standard
(`effect:default:DOF_CUTTER_CUT_FAR:DOF_CUTTER_STANDARD`, `0x381f02dc6ca37662`)

This template is referenced 1 time by [effect:DOF_CUTTER_CUT_FAR:DOF_CUTTER_STANDARD](/docs/Generated/Render%20Templates/base.render_template_database#effect-dof-cutter-cut-far-dof-cutter-standard).
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    temp0.x = saturate(temp0.x + temp0.x);
