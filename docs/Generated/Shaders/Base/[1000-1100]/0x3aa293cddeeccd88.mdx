---
id: 0x3aa293cddeeccd88
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Nvidia Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Nvidia Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NVIDIA:SELF_ILLUMINATION`, `0x3aa293cddeeccd88`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-self-illumination).
