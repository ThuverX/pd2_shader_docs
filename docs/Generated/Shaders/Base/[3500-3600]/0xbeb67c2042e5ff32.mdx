---
id: 0xbeb67c2042e5ff32
title: "Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Controller Opacity Uvanim"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Controller Opacity Uvanim
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NVIDIA:OPACITY_CONTROLLER:OPACITY_UVANIM`, `0xbeb67c2042e5ff32`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_CONTROLLER:OPACITY_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-diffuse-uvanim-opacity-controller-opacity-uvanim).
