---
id: 0xbf0a3e521599ccdf
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Double Sided Normalmap Normal Uvanim Skinned 3weights Vegetation Bending"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Double Sided Normalmap Normal Uvanim Skinned 3weights Vegetation Bending
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS:VEGETATION_BENDING`, `0xbf0a3e521599ccdf`)
