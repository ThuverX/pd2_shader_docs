---
id: 0xbfd952518deb90e4
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:SIMPLE_TINT`, `0xbfd952518deb90e4`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-simple-tint).
