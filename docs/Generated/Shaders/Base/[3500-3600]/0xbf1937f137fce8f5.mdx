---
id: 0xbf1937f137fce8f5
title: "Generic Default Diffuse Texture Instanced Simple Tint Vertex Color"
---

# Generic Default Diffuse Texture Instanced Simple Tint Vertex Color
(`generic:default:DIFFUSE_TEXTURE:INSTANCED:SIMPLE_TINT:VERTEX_COLOR`, `0xbf1937f137fce8f5`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:SIMPLE_TINT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-simple-tint-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // dcl_2d s0
    // mul r0.xyz, c0, v3
    temp0.xyz = ref_tint_color.xyz * i.color.xyz;
    // texld_pp r1, v1, s0
