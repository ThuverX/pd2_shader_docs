---
id: 0xbefe5671b91a3f4a
title: "Generic Shadow Caster Ati Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Ati Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights
(`generic:shadow_caster:ATI:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0xbefe5671b91a3f4a`)
