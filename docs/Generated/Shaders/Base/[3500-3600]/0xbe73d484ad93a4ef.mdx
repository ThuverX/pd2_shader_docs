---
id: 0xbe73d484ad93a4ef
title: "Generic Default Alpha Masked Depth Scaling Detail Texture 2 Diffuse Texture Global Environment Mapping Normalmap Opacity Texture"
---

# Generic Default Alpha Masked Depth Scaling Detail Texture 2 Diffuse Texture Global Environment Mapping Normalmap Opacity Texture
(`generic:default:ALPHA_MASKED:DEPTH_SCALING:DETAIL_TEXTURE_2:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:OPACITY_TEXTURE`, `0xbe73d484ad93a4ef`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DEPTH_SCALING:DETAIL_TEXTURE_2:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-depth-scaling-detail-texture-2-diffuse-texture-global-environment-mapping-normalmap-opacity-texture).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    PixelMain_Output o;
    float4 temp0, temp1;
    // def c0, -0.00390625, 1, -1, 8
    // def c1, -0.5, 0.5, 0.4, 0
    // dcl_texcoord1 v0.x
    // dcl_texcoord v1
