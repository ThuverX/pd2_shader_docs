---
id: 0xbe53316a44a15acc
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Cube Environment Mapping Diffuse Texture Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Cube Environment Mapping Diffuse Texture Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xbe53316a44a15acc`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-smooth-cube-environment-mapping-diffuse-texture-rl-core-environment-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r0.y, r2.y, -v4.w
    temp0.y = /* not implemented _pp modifier */ temp2.y + -i.color.w;
    ...
    temp4 = /* not implemented _pp modifier */ lerp(temp3, temp2, temp0.y);
    // mul r0.x, r0.x, r4.w
    temp0.x = temp0.x * temp4.w;
    // mul r0.xyz, r0.x, r1
    temp0.xyz = temp0.xxx * temp1.xyz;
    // mad_pp oC0.xyz, r4, v4, r0
