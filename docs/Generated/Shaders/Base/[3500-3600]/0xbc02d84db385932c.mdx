---
id: 0xbc02d84db385932c
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Instanced Nvidia Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Instanced Nvidia Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NVIDIA:OPACITY_FADE`, `0xbc02d84db385932c`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:OPACITY_FADE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-instanced-opacity-fade).
