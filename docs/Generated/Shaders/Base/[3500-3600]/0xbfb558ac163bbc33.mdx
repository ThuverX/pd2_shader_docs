---
id: 0xbfb558ac163bbc33
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Skinned 3weights Vegetation Bending"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Skinned 3weights Vegetation Bending
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:NVIDIA:SKINNED_3WEIGHTS:VEGETATION_BENDING`, `0xbfb558ac163bbc33`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-skinned-3weights-vegetation-bending).
