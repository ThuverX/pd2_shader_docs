---
id: 0xc0011185dcc5f3dc
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Self Illumination Bloom Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Self Illumination Bloom Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:VERTEX_COLOR`, `0xc0011185dcc5f3dc`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-self-illumination-self-illumination-bloom-vertex-color).
