---
id: 0xbbd948e51995404a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE:VERTEX_COLOR`, `0xbbd948e51995404a`)
