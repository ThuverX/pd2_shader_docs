---
id: 0xbd7547bccd8c138b
title: "Generic Default Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT`, `0xbd7547bccd8c138b`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-blend-tint-second-cube-environment-mapping-diffuse-texture-normalmap-rl-core-environment).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add r0.xyz, c3.y, v6
    temp0.xyz = float3(-1, -1, -1) + i.color.xyz;
    // texld_pp r3, v1, s1
    temp3 = /* not implemented _pp modifier */ tex2D(diffuse_layer0_texture, i.texcoord.xy);
    // mad r0.xyz, r3.z, r0, c3.z
    temp0.xyz = temp3.zzz * temp0.xyz + float3(1, 1, 1);
    // mul_pp r4.xyz, r0, r3.y
    temp4.xyz = /* not implemented _pp modifier */ temp0.xyz * temp3.yyy;
    // add_pp r0.x, r3.w, -v6.w
    temp0.x = /* not implemented _pp modifier */ temp3.w + -i.color.w;
    // mov_pp r4.w, r3.x
    temp4.w = /* not implemented _pp modifier */ temp3.x;
    // mul_sat_pp r0.x, r0.x, c3.x
    ;// error
    // lrp_pp r3, r0.x, r2, r4
    temp3 = /* not implemented _pp modifier */ lerp(temp4, temp2, temp0.x);
    // mul r0.x, r0.w, r3.w
    temp0.x = temp0.w * temp3.w;
