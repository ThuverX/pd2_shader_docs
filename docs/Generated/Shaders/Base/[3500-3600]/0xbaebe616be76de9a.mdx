---
id: 0xbaebe616be76de9a
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Skinned 1weight Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Skinned 1weight Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT:VERTEX_COLOR`, `0xbaebe616be76de9a`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-skinned-1weight-vertex-color).
