---
id: 0x44dec7e4e9bd776c
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x44dec7e4e9bd776c`)
