---
id: 0x402a04a3a29f13a7
title: "Generic Default Alpha Masked Diffuse Texture Instanced Normalmap Opacity Texture"
---

# Generic Default Alpha Masked Diffuse Texture Instanced Normalmap Opacity Texture
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_TEXTURE`, `0x402a04a3a29f13a7`)
