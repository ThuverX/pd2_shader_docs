---
id: 0x426d4fc6c8d014be
title: "Decal Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Texture Opacity Uvanim Simple Tint"
---

# Decal Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Texture Opacity Uvanim Simple Tint
(`decal:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_TEXTURE:OPACITY_UVANIM:SIMPLE_TINT`, `0x426d4fc6c8d014be`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_TEXTURE:OPACITY_UVANIM:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-opacity-texture-opacity-uvanim-simple-tint).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    VertexMain_Output o;
    float4 temp0;
    // def c13, 2, -1, 0.0004, 0
    // def c14, 9.995, 0.005, 0, 0
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord v2
    // dcl_tangent v3
