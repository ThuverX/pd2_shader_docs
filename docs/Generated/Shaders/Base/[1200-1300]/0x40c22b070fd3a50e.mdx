---
id: 0x40c22b070fd3a50e
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gloss Control Value Normalmap Nvidia Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gloss Control Value Normalmap Nvidia Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VERTEX_COLOR`, `0x40c22b070fd3a50e`)
