---
id: 0x42cc1041e399ddfb
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Tint Skinned 2weights"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Tint Skinned 2weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SKINNED_2WEIGHTS`, `0x42cc1041e399ddfb`)
