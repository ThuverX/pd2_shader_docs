---
id: 0x403c66515233a00a
title: "Effect Default Blend Add Diffuse0 Texture View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:VIEW_ANGLE_FALLOFF_OP`, `0x403c66515233a00a`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-view-angle-falloff-op).
