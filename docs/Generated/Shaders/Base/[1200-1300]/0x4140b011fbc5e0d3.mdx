---
id: 0x4140b011fbc5e0d3
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Take Fog Take Global Light"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Take Fog Take Global Light
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NORMALMAP:TAKE_FOG:TAKE_GLOBAL_LIGHT`, `0x4140b011fbc5e0d3`)
