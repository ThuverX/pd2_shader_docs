---
id: 0x40a64545d62ed573
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BIGPROPS:SKINNED_1WEIGHT`, `0x40a64545d62ed573`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-bigprops-skinned-1weight).
