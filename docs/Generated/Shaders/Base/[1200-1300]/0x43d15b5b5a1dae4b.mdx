---
id: 0x43d15b5b5a1dae4b
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Skinned 2weights Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Skinned 2weights Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SKINNED_2WEIGHTS:VERTEX_COLOR`, `0x43d15b5b5a1dae4b`)
