---
id: 0x41565186a94caf83
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Take Global Light"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Take Global Light
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:NORMALMAP:TAKE_GLOBAL_LIGHT`, `0x41565186a94caf83`)
