---
id: 0x42e74b89135a1d01
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Core Environment Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Core Environment Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION`, `0x42e74b89135a1d01`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-core-environment-self-illumination).
