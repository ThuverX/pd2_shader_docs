---
id: 0x4093816072d3d9b8
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Self Illumination Self Illumination Bloom
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x4093816072d3d9b8`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-normalmap-self-illumination-self-illumination-bloom).
