---
id: 0x4024e52136aa3dee
title: "Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap Opacity Texture Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap Opacity Texture Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT`, `0x4024e52136aa3dee`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-gloss-control-value-normalmap-opacity-texture-simple-tint).
