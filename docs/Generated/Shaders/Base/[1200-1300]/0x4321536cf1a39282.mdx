---
id: 0x4321536cf1a39282
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Nvidia Vegetation Bending Vertex Alpha Vertex Color Alpha"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Nvidia Vegetation Bending Vertex Alpha Vertex Color Alpha
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA`, `0x4321536cf1a39282`)
