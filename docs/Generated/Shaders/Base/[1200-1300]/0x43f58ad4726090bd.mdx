---
id: 0x43f58ad4726090bd
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Distance Fade 1 Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Distance Fade 1 Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:DISTANCE_FADE_1:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x43f58ad4726090bd`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:DISTANCE_FADE_1:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-control-blend-mask-crossblend-blend-normal-diffuse-texture-distance-fade-1-gsma-texture-normalmap-vertex-color).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    temp0.x = temp0.z * temp0.x + float1(-520);
    // mov o1.x, r0.z
