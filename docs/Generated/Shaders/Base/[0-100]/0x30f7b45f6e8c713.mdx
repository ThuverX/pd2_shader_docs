---
id: 0x30f7b45f6e8c713
title: "Generic Default Cube Environment Mapping Diffuse Texture Self Illumination Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Self Illumination Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:SELF_ILLUMINATION:VERTEX_COLOR`, `0x30f7b45f6e8c713`)
