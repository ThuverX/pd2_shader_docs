---
id: 0x4addbd34fa63adf
title: "Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Players"
---

# Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Players
(`generic:shadow_caster:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_PLAYERS`, `0x4addbd34fa63adf`)

This template is referenced 1 time by [generic:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_PLAYERS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-cube-environment-mapping-diffuse-texture-normalmap-rl-players).
