---
id: 0x947cd7960c2f9
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Skinned 3weights"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Skinned 3weights
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x947cd7960c2f9`)
