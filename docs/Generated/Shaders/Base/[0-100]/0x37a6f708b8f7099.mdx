---
id: 0x37a6f708b8f7099
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x37a6f708b8f7099`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-skinned-3weights).
