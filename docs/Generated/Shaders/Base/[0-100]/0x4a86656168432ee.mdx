---
id: 0x4a86656168432ee
title: "Generic Default Diffuse Texture Simple Tint"
---

# Generic Default Diffuse Texture Simple Tint
(`generic:default:DIFFUSE_TEXTURE:SIMPLE_TINT`, `0x4a86656168432ee`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-simple-tint).
