---
id: 0x77f457f71015bf
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Simple Tint Vegetation Bending"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Simple Tint Vegetation Bending
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:SIMPLE_TINT:VEGETATION_BENDING`, `0x77f457f71015bf`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:SIMPLE_TINT:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-double-sided-simple-tint-vegetation-bending).
