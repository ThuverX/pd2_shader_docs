---
id: 0x1d6f794d9d45252
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Nvidia Opacity Controller"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Nvidia Opacity Controller
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NVIDIA:OPACITY_CONTROLLER`, `0x1d6f794d9d45252`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:OPACITY_CONTROLLER](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-fps-opacity-controller).
