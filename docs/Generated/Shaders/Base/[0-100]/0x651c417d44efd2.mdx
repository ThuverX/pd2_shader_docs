---
id: 0x651c417d44efd2
title: "Generic Default Alpha Masked Diffuse Texture Double Sided Gsma Alpha Masking Gsma Texture"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided Gsma Alpha Masking Gsma Texture
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:GSMA_ALPHA_MASKING:GSMA_TEXTURE`, `0x651c417d44efd2`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:GSMA_ALPHA_MASKING:GSMA_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-gsma-alpha-masking-gsma-texture).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // cmp_pp r1.xyz, -r0.z, v2, -v2
    temp1.xyz = /* not implemented _pp modifier */ (-temp0.zzz >= 0) ? i.texcoord2.xyz : -i.texcoord2.xyz;
    // nrm_pp r2.xyz, r1
