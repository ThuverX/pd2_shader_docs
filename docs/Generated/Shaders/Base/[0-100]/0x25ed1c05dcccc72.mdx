---
id: 0x25ed1c05dcccc72
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Instanced Nvidia Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Instanced Nvidia Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:OPACITY_TEXTURE:VERTEX_COLOR`, `0x25ed1c05dcccc72`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:INSTANCED:OPACITY_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-instanced-opacity-texture-vertex-color).
