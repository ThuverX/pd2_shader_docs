---
id: 0x3625a9bfa662f96
title: "Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap"
---

# Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP`, `0x3625a9bfa662f96`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-diffuse-uvanim-normalmap).
