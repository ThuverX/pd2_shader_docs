---
id: 0x33293283b63edf4
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Self Illumination Self Illumination Bloom Skinned 3weights"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Self Illumination Self Illumination Bloom Skinned 3weights
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS`, `0x33293283b63edf4`)
