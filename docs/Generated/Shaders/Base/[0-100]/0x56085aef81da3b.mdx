---
id: 0x56085aef81da3b
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep Diffuse1 Blend Op Rgb Add Diffuse1 Texture"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep Diffuse1 Blend Op Rgb Add Diffuse1 Texture
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP:DIFFUSE1_BLEND_OP_RGB_ADD:DIFFUSE1_TEXTURE`, `0x56085aef81da3b`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP:DIFFUSE1_BLEND_OP_RGB_ADD:DIFFUSE1_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-threshold-sweep-diffuse1-blend-op-rgb-add-diffuse1-texture).
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    // texld_pp r1, v1, s1
    temp1 = /* not implemented _pp modifier */ tex2D(detail_diffuse_texture, i.texcoord1.xy);
