---
id: 0x38078d26a11bcbc
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture Diffuse Uvanim Double Sided Self Illumination Self Illumination Tint Simple Tint Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture Diffuse Uvanim Double Sided Self Illumination Self Illumination Tint Simple Tint Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SIMPLE_TINT:VEGETATION_BENDING`, `0x38078d26a11bcbc`)
