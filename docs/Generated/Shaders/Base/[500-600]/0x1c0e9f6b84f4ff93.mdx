---
id: 0x1c0e9f6b84f4ff93
title: "Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops"
---

# Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops
(`generic:shadow_caster:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_BIGPROPS`, `0x1c0e9f6b84f4ff93`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-cube-environment-mapping-diffuse-texture-instanced-normalmap-rl-bigprops).
