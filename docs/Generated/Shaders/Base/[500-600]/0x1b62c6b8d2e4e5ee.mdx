---
id: 0x1b62c6b8d2e4e5ee
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Simple Tint Skinned 3weights"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Simple Tint Skinned 3weights
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0x1b62c6b8d2e4e5ee`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap-simple-tint-skinned-3weights).
