---
id: 0x1d5add821ecc1031
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Skinned 2weights View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Skinned 2weights View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:SKINNED_2WEIGHTS:VIEW_ANGLE_FALLOFF_OP`, `0x1d5add821ecc1031`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:SKINNED_2WEIGHTS:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-uvanim-skinned-2weights-view-angle-falloff-op).
