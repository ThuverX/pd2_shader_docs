---
id: 0x1ce76cd6e49f19c7
title: "Generic Default Alpha Masked Diffuse Texture Gsma Texture Normalmap Self Illumination"
---

# Generic Default Alpha Masked Diffuse Texture Gsma Texture Normalmap Self Illumination
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION`, `0x1ce76cd6e49f19c7`)
