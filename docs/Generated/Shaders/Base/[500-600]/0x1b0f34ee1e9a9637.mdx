---
id: 0x1b0f34ee1e9a9637
title: "Generic Default Contour Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap"
---

# Generic Default Contour Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap
(`generic:default:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP`, `0x1b0f34ee1e9a9637`)
