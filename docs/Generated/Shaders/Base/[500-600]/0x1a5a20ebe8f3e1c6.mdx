---
id: 0x1a5a20ebe8f3e1c6
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:VERTEX_COLOR`, `0x1a5a20ebe8f3e1c6`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-smooth-diffuse-texture-vertex-color).
