---
id: 0x1d99e0adc3f81e4c
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Opacity Fade To Solid"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Opacity Fade To Solid
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:OPACITY_FADE_TO_SOLID`, `0x1d99e0adc3f81e4c`)
