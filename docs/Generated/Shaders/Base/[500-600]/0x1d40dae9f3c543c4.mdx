---
id: 0x1d40dae9f3c543c4
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Core Environment Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Core Environment Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0x1d40dae9f3c543c4`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-rl-core-environment-vertex-color).
