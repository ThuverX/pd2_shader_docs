---
id: 0x1b3368dd8e4f91cd
title: "Opacity Default Cube Environment Mapping Diffuse Texture Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:SKINNED_3WEIGHTS`, `0x1b3368dd8e4f91cd`)
