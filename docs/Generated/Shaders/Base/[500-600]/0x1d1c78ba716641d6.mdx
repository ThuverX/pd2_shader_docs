---
id: 0x1d1c78ba716641d6
title: "Generic Default Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Simple Tint"
---

# Generic Default Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Simple Tint
(`generic:default:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT`, `0x1d1c78ba716641d6`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-gsma-texture-normalmap-simple-tint).
