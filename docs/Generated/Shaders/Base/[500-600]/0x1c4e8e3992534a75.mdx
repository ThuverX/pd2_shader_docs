---
id: 0x1c4e8e3992534a75
title: "Generic Default Blend Diffuse Blend Mask Seperate Diffuse Texture Global Environment Mapping Normalmap"
---

# Generic Default Blend Diffuse Blend Mask Seperate Diffuse Texture Global Environment Mapping Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP`, `0x1c4e8e3992534a75`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-diffuse-texture-global-environment-mapping-normalmap).
