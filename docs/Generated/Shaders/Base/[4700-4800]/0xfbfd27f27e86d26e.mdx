...
This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_CONTROLLER:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-double-sided-opacity-controller-vertex-color).
