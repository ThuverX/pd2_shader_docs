---
id: 0xfd9bc765ed1971f8
title: "Generic Shadow Caster Blue Mask Tint Diffuse Texture Normalmap Nvidia"
---

# Generic Shadow Caster Blue Mask Tint Diffuse Texture Normalmap Nvidia
(`generic:shadow_caster:BLUE_MASK_TINT:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA`, `0xfd9bc765ed1971f8`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-normalmap).
