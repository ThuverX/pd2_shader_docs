---
id: 0xfcac499df832adf3
title: "Generic Default Diffuse Texture Self Illumination Self Illumination Bloom Simple Tint"
---

# Generic Default Diffuse Texture Self Illumination Self Illumination Bloom Simple Tint
(`generic:default:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SIMPLE_TINT`, `0xfcac499df832adf3`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination-self-illumination-bloom-simple-tint).
