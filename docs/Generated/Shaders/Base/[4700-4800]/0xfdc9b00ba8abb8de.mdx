---
id: 0xfdc9b00ba8abb8de
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade Take Fog"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade Take Fog
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE:TAKE_FOG`, `0xfdc9b00ba8abb8de`)
