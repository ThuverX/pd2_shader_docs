---
id: 0xff9c0c1791270a73
title: "Generic Shadow Caster Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Vertex Color"
---

# Generic Shadow Caster Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Vertex Color
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SIMPLE_TINT:VERTEX_COLOR`, `0xff9c0c1791270a73`)
