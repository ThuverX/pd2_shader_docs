---
id: 0xfba5a97e4d32a521
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Normalmap"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Normalmap
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP`, `0xfba5a97e4d32a521`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-normalmap).
