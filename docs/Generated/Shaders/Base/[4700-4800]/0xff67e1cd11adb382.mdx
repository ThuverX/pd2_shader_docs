---
id: 0xff67e1cd11adb382
title: "Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:VERTEX_COLOR`, `0xff67e1cd11adb382`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-vertex-color).
