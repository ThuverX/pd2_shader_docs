---
id: 0xfca5adc617948dfd
title: "Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Rl Environment Vertex Color"
---

# Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Rl Environment Vertex Color
(`generic:default:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_ENVIRONMENT:VERTEX_COLOR`, `0xfca5adc617948dfd`)
