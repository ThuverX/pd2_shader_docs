---
id: 0xff995028dcb236de
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Opacity Texture Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Opacity Texture Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SIMPLE_TINT`, `0xff995028dcb236de`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-opacity-texture-simple-tint).
