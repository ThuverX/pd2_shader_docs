---
id: 0xffbf82bd63108b26
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value Normalmap Opacity Texture Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value Normalmap Opacity Texture Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR`, `0xffbf82bd63108b26`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gloss-control-value-normalmap-opacity-texture-vertex-color).
