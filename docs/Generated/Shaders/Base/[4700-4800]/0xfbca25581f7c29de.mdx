---
id: 0xfbca25581f7c29de
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Self Illumination Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Self Illumination Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SKINNED_1WEIGHT`, `0xfbca25581f7c29de`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-self-illumination-skinned-1weight).
