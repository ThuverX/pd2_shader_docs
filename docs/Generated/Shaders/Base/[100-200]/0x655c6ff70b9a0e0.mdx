---
id: 0x655c6ff70b9a0e0
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE`, `0x655c6ff70b9a0e0`)
