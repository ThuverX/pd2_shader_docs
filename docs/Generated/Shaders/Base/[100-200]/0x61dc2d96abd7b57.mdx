---
id: 0x61dc2d96abd7b57
title: "Generic Shadow Caster Contour Nvidia Vertex Color"
---

# Generic Shadow Caster Contour Nvidia Vertex Color
(`generic:shadow_caster:CONTOUR:NVIDIA:VERTEX_COLOR`, `0x61dc2d96abd7b57`)

This template is referenced 1 time by [generic:CONTOUR:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-vertex-color).
