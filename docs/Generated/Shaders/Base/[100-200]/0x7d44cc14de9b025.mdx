---
id: 0x7d44cc14de9b025
title: "Generic Default Contour Diffuse Texture Normalmap Rl Players Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Contour Diffuse Texture Normalmap Rl Players Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_PLAYERS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x7d44cc14de9b025`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_PLAYERS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-players-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
