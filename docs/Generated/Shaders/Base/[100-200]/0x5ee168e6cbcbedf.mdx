---
id: 0x5ee168e6cbcbedf
title: "Generic Shadow Caster Ati Diffuse Texture Normalmap Rl Core Environment Self Illumination"
---

# Generic Shadow Caster Ati Diffuse Texture Normalmap Rl Core Environment Self Illumination
(`generic:shadow_caster:ATI:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION`, `0x5ee168e6cbcbedf`)
