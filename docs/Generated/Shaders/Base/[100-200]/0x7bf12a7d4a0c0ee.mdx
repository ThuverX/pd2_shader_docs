---
id: 0x7bf12a7d4a0c0ee
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Opacity Texture Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Opacity Texture Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SKINNED_3WEIGHTS`, `0x7bf12a7d4a0c0ee`)
