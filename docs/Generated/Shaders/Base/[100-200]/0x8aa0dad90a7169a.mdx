---
id: 0x8aa0dad90a7169a
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Cube Environment Mapping Diffuse Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Cube Environment Mapping Diffuse Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP`, `0x8aa0dad90a7169a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-cube-environment-mapping-diffuse-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mad_pp oC0.xyz, r2, r0.x, r5
    o.color.xyz = /* not implemented _pp modifier */ temp2.xyz * temp0.xxx + temp5.xyz;
    // mov_pp oC1.w, r5.w
