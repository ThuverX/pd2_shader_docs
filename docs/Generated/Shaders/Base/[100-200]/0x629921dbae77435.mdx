---
id: 0x629921dbae77435
title: "Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 2weights"
---

# Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 2weights
(`shadow_caster_only:shadow_caster:NVIDIA:SHADOW_CASTER_ONLY:SKINNED_2WEIGHTS`, `0x629921dbae77435`)

This template is referenced 1 time by [shadow_caster_only:SKINNED_2WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-skinned-2weights).
