---
id: 0x8a7fb8f27bd8a68
title: "Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:SKINNED_1WEIGHT`, `0x8a7fb8f27bd8a68`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination-skinned-1weight).
