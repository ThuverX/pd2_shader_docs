---
id: 0x5abfee21cf95ca7
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0x5abfee21cf95ca7`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-instanced-normalmap-vertex-color).
