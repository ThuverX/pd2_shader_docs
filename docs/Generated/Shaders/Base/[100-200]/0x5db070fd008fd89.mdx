---
id: 0x5db070fd008fd89
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Fps Detail Normalmap Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Fps Detail Normalmap Vertex Color Vertex Color Alpha
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:FPS_DETAIL:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x5db070fd008fd89`)
