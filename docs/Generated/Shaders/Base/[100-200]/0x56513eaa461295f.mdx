---
id: 0x56513eaa461295f
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Skinned 3weights"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Skinned 3weights
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:SKINNED_3WEIGHTS`, `0x56513eaa461295f`)
