---
id: 0x7498b58d5b26bd0
title: "Generic Shadow Caster Nvidia Skinned 3weights Vertex Color"
---

# Generic Shadow Caster Nvidia Skinned 3weights Vertex Color
(`generic:shadow_caster:NVIDIA:SKINNED_3WEIGHTS:VERTEX_COLOR`, `0x7498b58d5b26bd0`)

This template is referenced 1 time by [generic:SKINNED_3WEIGHTS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-skinned-3weights-vertex-color).
