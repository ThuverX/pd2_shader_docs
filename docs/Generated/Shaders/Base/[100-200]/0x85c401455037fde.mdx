---
id: 0x85c401455037fde
title: "Generic Default Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights"
---

# Generic Default Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x85c401455037fde`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-civilians-skinned-3weights).
