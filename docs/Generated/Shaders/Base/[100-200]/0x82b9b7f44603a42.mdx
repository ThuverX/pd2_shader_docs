---
id: 0x82b9b7f44603a42
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:VERTEX_COLOR`, `0x82b9b7f44603a42`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-vertex-color).
