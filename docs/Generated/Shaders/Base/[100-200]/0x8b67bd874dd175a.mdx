---
id: 0x8b67bd874dd175a
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Cops"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Cops
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_COPS`, `0x8b67bd874dd175a`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_COPS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-cops).
