---
id: 0x968aa951da569cb
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Opacity Texture"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Opacity Texture
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE`, `0x968aa951da569cb`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gsma-alpha-masking-gsma-texture-normalmap-opacity-texture).
