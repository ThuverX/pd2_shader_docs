---
id: 0x5316f9ad7a1e6db
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Self Illumination"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Self Illumination
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION`, `0x5316f9ad7a1e6db`)
