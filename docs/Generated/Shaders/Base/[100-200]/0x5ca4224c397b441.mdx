---
id: 0x5ca4224c397b441
title: "Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 1weight"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 1weight
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT`, `0x5ca4224c397b441`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-normalmap-skinned-1weight).
