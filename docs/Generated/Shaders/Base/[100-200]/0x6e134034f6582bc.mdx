---
id: 0x6e134034f6582bc
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Nvidia Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Nvidia Rl Civilians Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:NVIDIA:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x6e134034f6582bc`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-normalmap-rl-civilians-skinned-3weights).
