---
id: 0x8d4e473b1ac3669
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Take Global Light"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Normalmap Take Global Light
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NORMALMAP:TAKE_GLOBAL_LIGHT`, `0x8d4e473b1ac3669`)
