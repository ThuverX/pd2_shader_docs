---
id: 0x8b3699ed49a502c
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Self Illumination Self Illumination Bloom
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x8b3699ed49a502c`)
