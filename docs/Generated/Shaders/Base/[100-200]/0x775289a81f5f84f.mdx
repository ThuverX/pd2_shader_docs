---
id: 0x775289a81f5f84f
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Skinned 1weight Vertex Color"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Skinned 1weight Vertex Color
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SKINNED_1WEIGHT:VERTEX_COLOR`, `0x775289a81f5f84f`)
