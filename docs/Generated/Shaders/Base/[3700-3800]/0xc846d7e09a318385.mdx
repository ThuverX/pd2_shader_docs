---
id: 0xc846d7e09a318385
title: "Generic Default Blend Diffuse Blend Mask Control Blend Normal Diffuse Texture Gsma Texture Normalmap Rl Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Control Blend Normal Diffuse Texture Gsma Texture Normalmap Rl Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR`, `0xc846d7e09a318385`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-blend-normal-diffuse-texture-gsma-texture-normalmap-rl-environment-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // rcp r0.w, c0.x
    temp0.w = 1.0f / ref_blend_control.x;
    // texld_pp r1, v1, s1
