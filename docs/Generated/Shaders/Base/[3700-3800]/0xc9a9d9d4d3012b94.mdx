---
id: 0xc9a9d9d4d3012b94
title: "Generic Default Blend Diffuse Blend Mask D A Blend Normal Diffuse Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Normal Diffuse Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xc9a9d9d4d3012b94`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-normal-diffuse-texture-normalmap-vertex-color).
