---
id: 0xc653791c9d8a7639
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0xc653791c9d8a7639`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gsma-texture-normalmap-skinned-3weights).
