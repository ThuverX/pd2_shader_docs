---
id: 0xc76a7ed4b6bf62d2
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Core Environment Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Core Environment Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS`, `0xc76a7ed4b6bf62d2`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-rl-core-environment-skinned-3weights).
