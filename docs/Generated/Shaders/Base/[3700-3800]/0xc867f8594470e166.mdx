---
id: 0xc867f8594470e166
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT`, `0xc867f8594470e166`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gsma-texture-normalmap-simple-tint).
