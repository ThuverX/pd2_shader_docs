---
id: 0xc9635bcd61a85f30
title: "Generic Default Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Control Value Normalmap Simple Tint"
---

# Generic Default Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Control Value Normalmap Simple Tint
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT`, `0xc9635bcd61a85f30`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-blend-mask-seperate-diffuse-texture-gloss-control-value-normalmap-simple-tint).
