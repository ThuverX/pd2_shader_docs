---
id: 0xc9686c0371a5254c
title: "Generic Shadow Caster Diffuse Texture Nvidia"
---

# Generic Shadow Caster Diffuse Texture Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA`, `0xc9686c0371a5254c`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture).
