---
id: 0xc8e964d87138ab83
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Backdrop"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Backdrop
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_BACKDROP`, `0xc8e964d87138ab83`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_BACKDROP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-backdrop).
