---
id: 0xc85049e2f394bc19
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BIGPROPS:SKINNED_3WEIGHTS`, `0xc85049e2f394bc19`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-bigprops-skinned-3weights).
