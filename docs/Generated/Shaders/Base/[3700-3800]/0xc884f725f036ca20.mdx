---
id: 0xc884f725f036ca20
title: "Shadow Caster Only Shadow Caster Alpha Masked Nvidia Shadow Caster Only Skinned 1weight"
---

# Shadow Caster Only Shadow Caster Alpha Masked Nvidia Shadow Caster Only Skinned 1weight
(`shadow_caster_only:shadow_caster:ALPHA_MASKED:NVIDIA:SHADOW_CASTER_ONLY:SKINNED_1WEIGHT`, `0xc884f725f036ca20`)

This template is referenced 1 time by [shadow_caster_only:ALPHA_MASKED:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-alpha-masked-skinned-1weight).
