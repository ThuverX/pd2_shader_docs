---
id: 0xc968fc82c3fab129
title: "Generic Shadow Caster Contour Diffuse Texture Nvidia Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Contour Diffuse Texture Nvidia Self Illumination Self Illumination Bloom
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0xc968fc82c3fab129`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-self-illumination-self-illumination-bloom).
