---
id: 0xc752453abf682114
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Normalmap"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Normalmap
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP`, `0xc752453abf682114`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-4-double-sided-external-alpha-ref-instanced-normalmap).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    float addr0;
    // def c210, 2, -1, 4, -0
    // def c211, -7800, 0.00023809524, 0, 0
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord1 v2
    // dcl_texcoord v3
    ...
    temp0.x = temp0.z * temp0.y + float1(-7800);
    // mov o1.x, r0.z
