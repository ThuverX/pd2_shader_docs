---
id: 0xde77358dd8fb089a
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Opacity Texture"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Opacity Texture
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE`, `0xde77358dd8fb089a`)
