---
id: 0xda1a0d9c9195b782
title: "Generic Shadow Caster Diffuse Texture Double Sided Nvidia"
---

# Generic Shadow Caster Diffuse Texture Double Sided Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA`, `0xda1a0d9c9195b782`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided).
