---
id: 0xdce5ed3cc03d365e
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Foliage Rendering Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Opacity Texture Rl Civilians Skinned 3weights"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Foliage Rendering Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Opacity Texture Rl Civilians Skinned 3weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:FOLIAGE_RENDERING:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0xdce5ed3cc03d365e`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:FOLIAGE_RENDERING:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-foliage-rendering-global-environment-mapping-gloss-blurs-cubemap-gsma-texture-normalmap-opacity-texture-rl-civilians-skinned-3weights).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // add r0.xyz, c170.y, v8
    temp0.xyz = float3(-0.5, -0.5, -0.5) + i.color.xyz;
    // mul r0.w, c170.x, v8.w
    temp0.w = float1(2000) * i.color.w;
    // mul r0.xyz, r0.w, r0
    temp0.xyz = temp0.www * temp0.xyz;
    // rcp r0.w, r0.w
    temp0.w = 1.0f / temp0.w;
    // mad r0.xyz, r0, -c170.z, v0
    temp0.xyz = temp0.xyz * float3(-2, -2, -2) + i.position.xyz;
    // dp3 r1.x, r0, r0
...
sampler2D opacity_texture : register(ps_3_0, s3);
