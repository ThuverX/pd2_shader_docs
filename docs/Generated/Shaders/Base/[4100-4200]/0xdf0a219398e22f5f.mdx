---
id: 0xdf0a219398e22f5f
title: "Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Opacity Controller Vertex Color"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Opacity Controller Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_CONTROLLER:VERTEX_COLOR`, `0xdf0a219398e22f5f`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_CONTROLLER:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-normalmap-opacity-controller-vertex-color).
