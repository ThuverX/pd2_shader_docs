---
id: 0xdda47dd462eb3da0
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_FADE`, `0xdda47dd462eb3da0`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-opacity-fade).
