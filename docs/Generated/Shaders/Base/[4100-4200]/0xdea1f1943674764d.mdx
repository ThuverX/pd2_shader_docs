---
id: 0xdea1f1943674764d
title: "Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Self Illumination Skinned 1weight"
---

# Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Self Illumination Skinned 1weight
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SKINNED_1WEIGHT`, `0xdea1f1943674764d`)
