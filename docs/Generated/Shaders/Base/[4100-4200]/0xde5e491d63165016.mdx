---
id: 0xde5e491d63165016
title: "Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xde5e491d63165016`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-normal-diffuse-texture-normalmap-rl-core-environment-vertex-color).
