---
id: 0xe03d2de41d3483b7
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Opacity Texture Self Illumination Self Illumination Bloom"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Opacity Texture Self Illumination Self Illumination Bloom
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0xe03d2de41d3483b7`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-external-alpha-ref-gsma-texture-normalmap-opacity-texture-self-illumination-self-illumination-bloom).
