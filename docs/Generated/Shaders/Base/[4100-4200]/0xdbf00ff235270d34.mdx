...
This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvanim-vertex-color-alpha).
