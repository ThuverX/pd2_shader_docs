---
id: 0xdf677a2c42beef4d
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Vegetation Bending Vertex Alpha Vertex Color Alpha"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Vegetation Bending Vertex Alpha Vertex Color Alpha
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA`, `0xdf677a2c42beef4d`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-normalmap-vegetation-bending-vertex-alpha-vertex-color-alpha).
