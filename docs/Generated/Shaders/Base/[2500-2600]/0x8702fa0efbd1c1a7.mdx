---
id: 0x8702fa0efbd1c1a7
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Bloom Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Bloom Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SKINNED_3WEIGHTS`, `0x8702fa0efbd1c1a7`)
