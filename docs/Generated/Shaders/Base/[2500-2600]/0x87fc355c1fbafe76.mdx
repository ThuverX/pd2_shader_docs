---
id: 0x87fc355c1fbafe76
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Opacity Texture Self Illumination Self Illumination Bloom Self Illumination Uvanim"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Opacity Texture Self Illumination Self Illumination Bloom Self Illumination Uvanim
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM`, `0x87fc355c1fbafe76`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-opacity-texture-self-illumination-self-illumination-bloom-self-illumination-uvanim).
