---
id: 0x89578e1d37f84ab0
title: "Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Gsma Texture Normalmap Normal Uvanim Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Gsma Texture Normalmap Normal Uvanim Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:GSMA_TEXTURE:NORMALMAP:NORMAL_UVANIM:VERTEX_COLOR`, `0x89578e1d37f84ab0`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:GSMA_TEXTURE:NORMALMAP:NORMAL_UVANIM:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-diffuse-uvanim-gsma-texture-normalmap-normal-uvanim-vertex-color).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mov r0.x, c13.x
    temp0.x = ref_time.x;
    // mad o2.xy, r0.x, c14, v3
    o.texcoord.xy = temp0.xx * ref_uv_speed.xy + i.texcoord.xy;
    // mad o2.zw, r0.x, c14.xyxy, v2.xyxy
