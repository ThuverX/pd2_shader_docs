---
id: 0x88c66585f0762997
title: "Generic Shadow Caster Diffuse Texture Gloss Control Value Normalmap Nvidia Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Gloss Control Value Normalmap Nvidia Rl Cops Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:RL_COPS:SKINNED_3WEIGHTS`, `0x88c66585f0762997`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gloss-control-value-normalmap-rl-cops-skinned-3weights).
