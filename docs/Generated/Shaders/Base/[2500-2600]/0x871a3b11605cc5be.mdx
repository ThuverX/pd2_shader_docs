---
id: 0x871a3b11605cc5be
title: "Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Backdrop Vertex Color"
---

# Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Backdrop Vertex Color
(`generic:shadow_caster:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_BACKDROP:VERTEX_COLOR`, `0x871a3b11605cc5be`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_BACKDROP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-cube-environment-mapping-diffuse-texture-instanced-rl-backdrop-vertex-color).
