---
id: 0x855862a66a8a3710
title: "Generic Default Blue Mask Tint Diffuse Texture Vertex Color"
---

# Generic Default Blue Mask Tint Diffuse Texture Vertex Color
(`generic:default:BLUE_MASK_TINT:DIFFUSE_TEXTURE:VERTEX_COLOR`, `0x855862a66a8a3710`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-vertex-color).
