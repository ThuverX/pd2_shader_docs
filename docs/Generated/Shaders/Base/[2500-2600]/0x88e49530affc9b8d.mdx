---
id: 0x88e49530affc9b8d
title: "Generic Shadow Caster Ati Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Ati Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights
(`generic:shadow_caster:ATI:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x88e49530affc9b8d`)
