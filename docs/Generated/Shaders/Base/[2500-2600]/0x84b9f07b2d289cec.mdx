---
id: 0x84b9f07b2d289cec
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture Diffuse Uvanim External Alpha Ref Instanced Self Illumination"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture Diffuse Uvanim External Alpha Ref Instanced Self Illumination
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:INSTANCED:SELF_ILLUMINATION`, `0x84b9f07b2d289cec`)
