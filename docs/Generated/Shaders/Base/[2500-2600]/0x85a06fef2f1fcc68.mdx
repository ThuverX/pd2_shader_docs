---
id: 0x85a06fef2f1fcc68
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Normalmap Rl Core Environment Skinned 3weights Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Normalmap Rl Core Environment Skinned 3weights Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS:VERTEX_COLOR`, `0x85a06fef2f1fcc68`)
