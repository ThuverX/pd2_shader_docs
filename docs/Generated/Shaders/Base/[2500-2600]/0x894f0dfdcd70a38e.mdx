---
id: 0x894f0dfdcd70a38e
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided Instanced Normalmap Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided Instanced Normalmap Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:NVIDIA:OPACITY_TEXTURE`, `0x894f0dfdcd70a38e`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-instanced-normalmap-opacity-texture).
