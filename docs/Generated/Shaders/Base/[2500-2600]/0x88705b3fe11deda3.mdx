---
id: 0x88705b3fe11deda3
title: "Generic Default Blend Fade Blend Mask Control Blend Mask Seperate Blend Normal Blend Normal Uv2 Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Fade Blend Mask Control Blend Mask Seperate Blend Normal Blend Normal Uv2 Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_FADE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_NORMAL_UV2:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0x88705b3fe11deda3`)

This template is referenced 1 time by [generic:BLEND_FADE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_NORMAL_UV2:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-fade-blend-mask-control-blend-mask-seperate-blend-normal-blend-normal-uv2-diffuse-texture-gsma-texture-normalmap).
...
float ref_blend_fade_mask_fuzziness : register(ps_3_0, c1);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mov r0.xy, c2
    temp0.xy = float2(2, 1);
    // mad r0.x, c1.x, r0.x, r0.y
    temp0.x = ref_blend_fade_mask_fuzziness.x * temp0.x + temp0.y;
    // mov r1.x, c1.x
    temp1.x = ref_blend_fade_mask_fuzziness.x;
    // mad r0.x, c0.x, r0.x, -r1.x
    temp0.x = ref_blend_fade_value.x * temp0.x + -temp1.x;
    // texld r1, v1, s1
    ...
    // mad r1.xy, r1, c2.x, -r0.yzzw
    temp1.xy = temp1.xy * float2(2, 2) + -temp0.yz;
    // mad r0.xy, r0.x, r1, r0.yzzw
    temp0.xy = temp0.xx * temp1.xy + temp0.yz;
    // mul r0.w, r0.x, r0.x
