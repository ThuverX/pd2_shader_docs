---
id: 0x8534ff217207f25c
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT`, `0x8534ff217207f25c`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-control-blend-mask-crossblend-blend-normal-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gsma-texture-normalmap-simple-tint).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r1.xyz, r4, c4
    temp1.xyz = temp4.xyz * ref_tint_color.xyz;
    // add_pp r1.xyz, r1, r1
    ...
    // add r3.w, r1.w, -r2.x
    temp3.w = temp1.w + -temp2.x;
    // texldl r2, r3, s6
    temp2 = texCUBElod(reflection_texture, temp3);
    // mul r0.w, r0.x, r0.w
    temp0.w = temp0.x * temp0.w;
    // mul r2.xyz, r0.w, r2
    temp2.xyz = temp0.www * temp2.xyz;
    // mad_pp oC0.xyz, r2, r0.z, r1
    o.color.xyz = /* not implemented _pp modifier */ temp2.xyz * temp0.zzz + temp1.xyz;
    // mov oC0.w, r0.y
    o.color.w = temp0.y;
    // mov_pp oC1.w, r0.x
