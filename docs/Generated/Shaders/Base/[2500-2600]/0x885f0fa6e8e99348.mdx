---
id: 0x885f0fa6e8e99348
title: "Generic Shadow Caster Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS`, `0x885f0fa6e8e99348`)
