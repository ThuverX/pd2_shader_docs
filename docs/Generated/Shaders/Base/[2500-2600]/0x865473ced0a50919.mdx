---
id: 0x865473ced0a50919
title: "Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend"
---

# Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:WORLD_UP_BLEND`, `0x865473ced0a50919`)
