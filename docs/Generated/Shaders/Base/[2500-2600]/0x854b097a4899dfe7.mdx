---
id: 0x854b097a4899dfe7
title: "Generic Shadow Caster Instanced Nvidia Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Instanced Nvidia Vertex Color Vertex Color Alpha
(`generic:shadow_caster:INSTANCED:NVIDIA:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x854b097a4899dfe7`)

This template is referenced 1 time by [generic:INSTANCED:VERTEX_COLOR:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-instanced-vertex-color-vertex-color-alpha).
