---
id: 0x88ba4171af62100b
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha Vertex Color Alpha"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha Vertex Color Alpha
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA`, `0x88ba4171af62100b`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-global-environment-mapping-gloss-blurs-cubemap-gloss-control-value-normalmap-vegetation-bending-vertex-alpha-vertex-color-alpha).
...
float ref_glossiness_control : register(ps_3_0, c1);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // texkill r1
    clip(temp1);
    // mul_pp oC0.xyz, r0, v5.w
    o.color.xyz = /* not implemented _pp modifier */ temp0.xyz * i.color.www;
    // mov_pp oC1.w, r0.w
