---
id: 0x88a551d18a0bbb1b
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Fps Intersection Fadeout View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Fps Intersection Fadeout View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:FPS:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP`, `0x88a551d18a0bbb1b`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:FPS:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-tint-fps-intersection-fadeout-view-angle-falloff-op).
...
float ref_fadeout_distance : register(ps_3_0, c2);
float ref_falloff_exp : register(ps_3_0, c0);
float ref_intensity : register(ps_3_0, c3);
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    // mul r0.yzw, r1.xxyz, c1.xxyz
    temp0.yzw = temp1.xyz * ref_tint_diffuse0_color.xyz;
    // add_sat_pp r0.yzw, r0, r0
    ;// error
    // mul oC0.xyz, r0.yzww, c3.x
    out_color.xyz = temp0.yzw * ref_intensity.xxx;
    // texld r1, v3, s1
