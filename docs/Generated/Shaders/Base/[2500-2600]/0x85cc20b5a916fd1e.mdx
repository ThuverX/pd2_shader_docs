---
id: 0x85cc20b5a916fd1e
title: "Opacity Default Diffuse Texture Double Sided Is Water Normalmap Nvidia Take Fog"
---

# Opacity Default Diffuse Texture Double Sided Is Water Normalmap Nvidia Take Fog
(`opacity:default:DIFFUSE_TEXTURE:DOUBLE_SIDED:IS_WATER:NORMALMAP:NVIDIA:TAKE_FOG`, `0x85cc20b5a916fd1e`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DOUBLE_SIDED:IS_WATER:NORMALMAP:TAKE_FOG](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-double-sided-is-water-normalmap-take-fog).
