---
id: 0x872a0cd85969dddd
title: "Generic Default Blend Diffuse Blend Normal Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Normal Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x872a0cd85969dddd`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-normal-diffuse-texture-gsma-texture-normalmap-vertex-color).
