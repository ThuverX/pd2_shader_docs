---
id: 0x872f6abdce23c4cf
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade To Solid"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade To Solid
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE_TO_SOLID`, `0x872f6abdce23c4cf`)
