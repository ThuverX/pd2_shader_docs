---
id: 0xd234fcb4767ba4fa
title: "Opacity Default Diffuse Texture Double Sided Is Water Normalmap Nvidia Take Fog Take Global Light"
---

# Opacity Default Diffuse Texture Double Sided Is Water Normalmap Nvidia Take Fog Take Global Light
(`opacity:default:DIFFUSE_TEXTURE:DOUBLE_SIDED:IS_WATER:NORMALMAP:NVIDIA:TAKE_FOG:TAKE_GLOBAL_LIGHT`, `0xd234fcb4767ba4fa`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DOUBLE_SIDED:IS_WATER:NORMALMAP:TAKE_FOG:TAKE_GLOBAL_LIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-double-sided-is-water-normalmap-take-fog-take-global-light).
...
|water_col_a|Water color A|vector3|
|water_col_b|Water color B|vector3|
|water_settingz_b|Water settings, Dist A, Dist B, Distortion size|vector3|
|water_settingz_c|Water settings, Speed A, Speed B, Not used|vector3|
|surface_settings|Water surface Settings (Reflection Instensity, Reflection Falloff Curve, Max Opacity dimmer)|vector3|.
