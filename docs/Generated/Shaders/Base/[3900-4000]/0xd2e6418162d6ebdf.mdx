---
id: 0xd2e6418162d6ebdf
title: "Generic Default Blend Diffuse Diffuse Texture Normalmap World Up Blend"
---

# Generic Default Blend Diffuse Diffuse Texture Normalmap World Up Blend
(`generic:default:BLEND_DIFFUSE:DIFFUSE_TEXTURE:NORMALMAP:WORLD_UP_BLEND`, `0xd2e6418162d6ebdf`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:DIFFUSE_TEXTURE:NORMALMAP:WORLD_UP_BLEND](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-diffuse-texture-normalmap-world-up-blend).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r2.x, r1.w, -v1.x
    temp2.x = /* not implemented _pp modifier */ temp1.w + -i.texcoord7.x;
