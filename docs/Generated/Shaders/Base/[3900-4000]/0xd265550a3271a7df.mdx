---
id: 0xd265550a3271a7df
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Nvidia Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Nvidia Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NVIDIA:OPACITY_TEXTURE:VEGETATION_BENDING`, `0xd265550a3271a7df`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-opacity-texture-vegetation-bending).
