---
id: 0xd0e313126e66443b
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Controller Self Illumination Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Controller Self Illumination Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:OPACITY_CONTROLLER:SELF_ILLUMINATION:VERTEX_COLOR`, `0xd0e313126e66443b`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-opacity-controller-self-illumination-vertex-color).
