---
id: 0xd046d0654c0f3c05
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Nvidia Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Nvidia Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:VERTEX_COLOR`, `0xd046d0654c0f3c05`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-instanced-vertex-color).
