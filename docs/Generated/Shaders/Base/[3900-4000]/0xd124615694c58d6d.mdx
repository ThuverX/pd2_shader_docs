---
id: 0xd124615694c58d6d
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:VERTEX_COLOR`, `0xd124615694c58d6d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-self-illumination-vertex-color).
