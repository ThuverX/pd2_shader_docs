---
id: 0xd0b9f16eb43cf409
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_COPS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xd0b9f16eb43cf409`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_COPS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-cops-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
