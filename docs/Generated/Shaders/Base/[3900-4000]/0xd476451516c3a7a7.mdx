---
id: 0xd476451516c3a7a7
title: "Generic Default Contour Diffuse Texture Normalmap Rl Bigprops Skinned 1weight"
---

# Generic Default Contour Diffuse Texture Normalmap Rl Bigprops Skinned 1weight
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT`, `0xd476451516c3a7a7`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-bigprops-skinned-1weight).
