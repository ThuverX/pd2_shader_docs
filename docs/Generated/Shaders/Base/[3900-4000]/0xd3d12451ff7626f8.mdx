---
id: 0xd3d12451ff7626f8
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Civilians Simple Tint Skinned 3weights"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Rl Civilians Simple Tint Skinned 3weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0xd3d12451ff7626f8`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-normalmap-opacity-texture-rl-civilians-simple-tint-skinned-3weights).
