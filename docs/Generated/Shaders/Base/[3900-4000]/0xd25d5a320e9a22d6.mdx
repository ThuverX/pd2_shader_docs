---
id: 0xd25d5a320e9a22d6
title: "Generic Default Cube Environment Mapping Diffuse Texture Normalmap Skinned 2weights"
---

# Generic Default Cube Environment Mapping Diffuse Texture Normalmap Skinned 2weights
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_2WEIGHTS`, `0xd25d5a320e9a22d6`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_2WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-skinned-2weights).
