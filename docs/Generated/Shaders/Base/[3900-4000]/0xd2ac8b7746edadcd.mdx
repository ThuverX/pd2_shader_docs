---
id: 0xd2ac8b7746edadcd
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Normalmap Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xd2ac8b7746edadcd`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-blend-smooth-diffuse-texture-normalmap-rl-core-environment-vertex-color).
