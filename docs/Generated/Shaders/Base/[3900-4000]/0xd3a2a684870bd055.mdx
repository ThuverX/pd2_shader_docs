---
id: 0xd3a2a684870bd055
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Nvidia Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Nvidia Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:SKINNED_3WEIGHTS`, `0xd3a2a684870bd055`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-skinned-3weights).
