---
id: 0x18a30d94a924a239
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Opacity Texture"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Opacity Texture
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE`, `0x18a30d94a924a239`)
