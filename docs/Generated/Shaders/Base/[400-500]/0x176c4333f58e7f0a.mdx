---
id: 0x176c4333f58e7f0a
title: "Generic Default Diffuse Texture Normalmap Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Diffuse Texture Normalmap Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x176c4333f58e7f0a`)
