---
id: 0x153dd60fa05a1ec0
title: "Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Rl Core Environment"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Rl Core Environment
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:RL_CORE_ENVIRONMENT`, `0x153dd60fa05a1ec0`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gloss-control-value-rl-core-environment).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // dp2add r1.x, r1.x, r1.x, c4.y
    temp1.x = dot(temp1.xx, temp1.xx) + float1(0.25);
    // mad r0.xyz, r1.y, -v2, r2
    temp0.xyz = temp1.yyy * -i.texcoord2.xyz + temp2.xyz;
    // texldl r0, r0, s1
    temp0 = texCUBElod(reflection_texture, temp0);
    // texld_pp r2, v1, s0
    temp2 = /* not implemented _pp modifier */ tex2D(diffuse_texture, i.texcoord.xy);
    // mul r0.w, r1.x, r2.w
    temp0.w = temp1.x * temp2.w;
    // mul r0.xyz, r0.w, r0
