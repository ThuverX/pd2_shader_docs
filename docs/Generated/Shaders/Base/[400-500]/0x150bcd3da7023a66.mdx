---
id: 0x150bcd3da7023a66
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Fps Normalmap Nvidia"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Fps Normalmap Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:FPS:NORMALMAP:NVIDIA`, `0x150bcd3da7023a66`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:FPS:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-distortion-fps-normalmap).
