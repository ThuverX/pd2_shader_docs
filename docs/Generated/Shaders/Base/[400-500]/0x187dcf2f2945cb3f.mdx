---
id: 0x187dcf2f2945cb3f
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Opacity Texture Skinned 3weights"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Opacity Texture Skinned 3weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SKINNED_3WEIGHTS`, `0x187dcf2f2945cb3f`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gsma-texture-normalmap-opacity-texture-skinned-3weights).
