---
id: 0x17fd5262737d4a9b
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref Normalmap Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref Normalmap Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x17fd5262737d4a9b`)
