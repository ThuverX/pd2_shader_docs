---
id: 0x18830adbd19463c4
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS`, `0x18830adbd19463c4`)
