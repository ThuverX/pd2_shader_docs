---
id: 0x17513423d42467eb
title: "Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:NORMALMAP`, `0x17513423d42467eb`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-diffuse-texture-normalmap).
