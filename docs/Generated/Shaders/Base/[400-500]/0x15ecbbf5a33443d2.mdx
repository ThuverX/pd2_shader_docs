---
id: 0x15ecbbf5a33443d2
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Double Sided Normalmap Normal Uvanim Skinned 3weights Vegetation Bending"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Double Sided Normalmap Normal Uvanim Skinned 3weights Vegetation Bending
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS:VEGETATION_BENDING`, `0x15ecbbf5a33443d2`)
