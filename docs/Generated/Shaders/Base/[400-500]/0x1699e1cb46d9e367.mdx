---
id: 0x1699e1cb46d9e367
title: "Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Normalmap Vertex Color Vertex Color Alpha"
---

# Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Normalmap Vertex Color Vertex Color Alpha
(`generic:default:DEPTH_SCALING:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x1699e1cb46d9e367`)
