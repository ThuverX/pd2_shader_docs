---
id: 0x1889bc7b8b50a6e2
title: "Generic Default Contour Diffuse Texture Global Environment Mapping Normalmap Rl Players Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Contour Diffuse Texture Global Environment Mapping Normalmap Rl Players Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_PLAYERS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x1889bc7b8b50a6e2`)
