...
(`decal:default:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT`, `0x18ebf6f4b92d3481`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-normalmap-opacity-texture-simple-tint).
