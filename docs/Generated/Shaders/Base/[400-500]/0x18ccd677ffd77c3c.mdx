---
id: 0x18ccd677ffd77c3c
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color Vertex Color Alpha
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x18ccd677ffd77c3c`)
