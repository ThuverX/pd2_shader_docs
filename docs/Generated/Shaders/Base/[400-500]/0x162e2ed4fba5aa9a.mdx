---
id: 0x162e2ed4fba5aa9a
title: "Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Control Value Normalmap Simple Tint"
---

# Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Control Value Normalmap Simple Tint
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT`, `0x162e2ed4fba5aa9a`)
