...
This template is referenced 1 time by [effect:BLEND_ADD:SCOPE:SCOPE_INNER_RETICLE](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-scope-scope-inner-reticle).
