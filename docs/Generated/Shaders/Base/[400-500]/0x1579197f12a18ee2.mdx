---
id: 0x1579197f12a18ee2
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Nvidia Self Illumination Self Illumination Tint Simple Tint Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Nvidia Self Illumination Self Illumination Tint Simple Tint Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SIMPLE_TINT:VEGETATION_BENDING`, `0x1579197f12a18ee2`)
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    // add r0.x, r0.w, c0.x
    temp0.x = temp0.w + float1(-0.00390625);
