---
id: 0x1976bbd75eaabdbf
title: "Generic Default Alpha Masked Depth Scaling Diffuse Texture Gsma Alpha Masking Gsma Texture Normalmap"
---

# Generic Default Alpha Masked Depth Scaling Diffuse Texture Gsma Alpha Masking Gsma Texture Normalmap
(`generic:default:ALPHA_MASKED:DEPTH_SCALING:DIFFUSE_TEXTURE:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP`, `0x1976bbd75eaabdbf`)
