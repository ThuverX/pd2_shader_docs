---
id: 0x1670f96af7fb54c8
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x1670f96af7fb54c8`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-normalmap-skinned-3weights).
