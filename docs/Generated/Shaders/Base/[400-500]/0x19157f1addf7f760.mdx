---
id: 0x19157f1addf7f760
title: "Generic Shadow Caster Ati Blend Diffuse Blend Gsma Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Gsma Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_GSMA:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0x19157f1addf7f760`)
