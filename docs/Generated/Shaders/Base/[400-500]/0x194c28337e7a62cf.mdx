---
id: 0x194c28337e7a62cf
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Nvidia Opacity Fade Opacity Uvanim"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Nvidia Opacity Fade Opacity Uvanim
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NVIDIA:OPACITY_FADE:OPACITY_UVANIM`, `0x194c28337e7a62cf`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_FADE:OPACITY_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-diffuse-uvanim-opacity-fade-opacity-uvanim).
...
float3 ref_opacity_fade : register(vs_3_0, c15);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mov r0.x, c13.x
    temp0.x = ref_time.x;
    // mad o4.xy, r0.x, c14, v3
    o.texcoord = temp0.x * ref_uv_speed + i.texcoord;
    // mad o3.xy, r0.x, c14, v2
    o.texcoord1 = temp0.x * ref_uv_speed + i.texcoord4;
    // 
