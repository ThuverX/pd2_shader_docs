---
id: 0x8ad4cda7047b9417
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Skinned 2weights"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Skinned 2weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:SKINNED_2WEIGHTS`, `0x8ad4cda7047b9417`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:SKINNED_2WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-skinned-2weights).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v0.x, r2.xxyz, r1.xxyz
    temp0.yzw = i.blendweight.xxx * temp2.xyz + temp1.xyz;
    // nrm r1.xyz, r0.yzww
