---
id: 0x8d5d7099472c4c17
title: "Generic Shadow Caster Diffuse Texture Double Sided Nvidia Vegetation Bending"
---

# Generic Shadow Caster Diffuse Texture Double Sided Nvidia Vegetation Bending
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:VEGETATION_BENDING`, `0x8d5d7099472c4c17`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-vegetation-bending).
