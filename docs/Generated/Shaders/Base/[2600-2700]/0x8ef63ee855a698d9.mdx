---
id: 0x8ef63ee855a698d9
title: "Generic Shadow Caster Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Instanced Vertex Color"
---

# Generic Shadow Caster Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Instanced Vertex Color
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:INSTANCED:VERTEX_COLOR`, `0x8ef63ee855a698d9`)
