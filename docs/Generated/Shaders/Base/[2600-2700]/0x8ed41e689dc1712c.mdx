---
id: 0x8ed41e689dc1712c
title: "Generic Default Diffuse Texture Normalmap Self Illumination Self Illumination Uvanim Skinned 3weights"
---

# Generic Default Diffuse Texture Normalmap Self Illumination Self Illumination Uvanim Skinned 3weights
(`generic:default:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM:SKINNED_3WEIGHTS`, `0x8ed41e689dc1712c`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-self-illumination-self-illumination-uvanim-skinned-3weights).
...
float3 ref_uv_speed : register(vs_3_0, c167);
column_major float4x4 view_proj_matrix : register(vs_3_0, c162);
struct VertexMain_Input
{
    float4 blendweight : BLENDWEIGHT;
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mov r0.x, c166.x
    temp0.x = ref_time.x;
    // mad o2.xy, r0.x, c167, v4
    o.texcoord6 = temp0.x * ref_uv_speed + i.texcoord3;
    // mad o1.xy, r0.x, c167, v3
