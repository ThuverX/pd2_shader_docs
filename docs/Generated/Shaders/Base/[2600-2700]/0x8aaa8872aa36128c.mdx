---
id: 0x8aaa8872aa36128c
title: "Generic Default Cube Environment Mapping Depth Scaling Diffuse Texture Fps Detail Normalmap Vertex Color Vertex Color Alpha"
---

# Generic Default Cube Environment Mapping Depth Scaling Diffuse Texture Fps Detail Normalmap Vertex Color Vertex Color Alpha
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:FPS_DETAIL:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x8aaa8872aa36128c`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:FPS_DETAIL:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-depth-scaling-diffuse-texture-fps-detail-normalmap-vertex-color-vertex-color-alpha).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r0.zw, r0.xyxy, r0.xyxy
    temp0.zw = /* not implemented _pp modifier */ temp0.xy + temp0.xy;
    // mul_pp r0.z, r0.z, r0.z
    temp0.z = /* not implemented _pp modifier */ temp0.z * temp0.z;
    // mad_pp r0.z, r0.w, r0.w, -r0.z
    temp0.z = /* not implemented _pp modifier */ temp0.w * temp0.w + -temp0.z;
    ...
    temp2 = /* not implemented _pp modifier */ tex2D(normal_layer0_texture, i.texcoord.zw);
    // add_pp r2.xyz, r2, c3.x
    temp2.xyz = /* not implemented _pp modifier */ temp2.xyz + float3(-0.5, -0.5, -0.5);
    // mad r1.xy, r0, c3.z, r2
    temp1.xy = temp0.xy * float2(2, 2) + temp2.xy;
    // dp3 r0.x, r1, v2
    ...
    // dp3 r0.x, r1, r3
    temp0.x = dot(temp1.xyz, temp3.xyz);
    // add r0.y, r0.x, r0.x
    ...
    temp0.yzw = temp0.yyy * -temp1.xyz + temp3.xyz;
    // mad_pp oC1.xyz, r1, -c3.x, -c3.x
    ...
    // mad_pp r0.yzw, r3.xxyz, v6.xxyz, r2.z
    temp0.yzw = /* not implemented _pp modifier */ temp3.xyz * i.color.xyz + temp2.zzz;
    // mov_pp oC1.w, r3.w
