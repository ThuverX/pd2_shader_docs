---
id: 0x8e2d53c1a4ec2baa
title: "Generic Shadow Caster Ati Depth Scaling Diffuse Texture Normalmap Skinned 3weights"
---

# Generic Shadow Caster Ati Depth Scaling Diffuse Texture Normalmap Skinned 3weights
(`generic:shadow_caster:ATI:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x8e2d53c1a4ec2baa`)
