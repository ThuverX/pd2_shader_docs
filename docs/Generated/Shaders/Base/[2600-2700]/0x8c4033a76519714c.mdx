---
id: 0x8c4033a76519714c
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA:OPACITY_TEXTURE`, `0x8c4033a76519714c`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-instanced-normalmap-opacity-texture).
