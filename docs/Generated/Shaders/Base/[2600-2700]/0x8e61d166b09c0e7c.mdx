---
id: 0x8e61d166b09c0e7c
title: "Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops"
---

# Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops
(`generic:default:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS`, `0x8e61d166b09c0e7c`)
