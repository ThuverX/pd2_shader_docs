---
id: 0x8b25214e10e20ddc
title: "Effect Default Blend Add Diffuse0 Texture Diffuse1 Texture Diffuse1 Uvanim Double Sided View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse1 Texture Diffuse1 Uvanim Double Sided View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE1_TEXTURE:DIFFUSE1_UVANIM:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP`, `0x8b25214e10e20ddc`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE1_TEXTURE:DIFFUSE1_UVANIM:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse1-texture-diffuse1-uvanim-double-sided-view-angle-falloff-op).
...
float3 ref_uv1_speed : register(vs_3_0, c16);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mov r0.xy, c16
    temp0.xy = ref_uv1_speed.xy;
    // mad o4.xy, r0, c15.x, v2
    o.texcoord1 = temp0 * ref_time.x + i.texcoord;
    // mov o3.xy, v2
