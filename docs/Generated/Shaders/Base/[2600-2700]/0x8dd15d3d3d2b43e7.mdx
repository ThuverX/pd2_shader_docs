---
id: 0x8dd15d3d3d2b43e7
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Self Illumination Self Illumination Bloom"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Self Illumination Self Illumination Bloom
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x8dd15d3d3d2b43e7`)
