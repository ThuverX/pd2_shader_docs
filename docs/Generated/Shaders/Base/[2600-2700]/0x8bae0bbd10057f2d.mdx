---
id: 0x8bae0bbd10057f2d
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Normalmap Opacity Texture Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Normalmap Opacity Texture Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR`, `0x8bae0bbd10057f2d`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-3-external-alpha-ref-normalmap-opacity-texture-vertex-color).
