---
id: 0x8b36ed25763b1d09
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Nvidia Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Nvidia Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NVIDIA:OPACITY_TEXTURE:VERTEX_COLOR`, `0x8b36ed25763b1d09`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:OPACITY_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-instanced-opacity-texture-vertex-color).
