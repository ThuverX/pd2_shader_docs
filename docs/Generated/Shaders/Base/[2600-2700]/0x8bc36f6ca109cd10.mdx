---
id: 0x8bc36f6ca109cd10
title: "Generic Shadow Caster Blue Mask Tint Diffuse Texture Nvidia"
---

# Generic Shadow Caster Blue Mask Tint Diffuse Texture Nvidia
(`generic:shadow_caster:BLUE_MASK_TINT:DIFFUSE_TEXTURE:NVIDIA`, `0x8bc36f6ca109cd10`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture).
