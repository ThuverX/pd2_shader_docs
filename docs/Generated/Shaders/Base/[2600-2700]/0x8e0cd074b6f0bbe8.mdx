---
id: 0x8e0cd074b6f0bbe8
title: "Generic Default Blend Diffuse Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color"
---

# Generic Default Blend Diffuse Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color
(`generic:default:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR`, `0x8e0cd074b6f0bbe8`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-cube-environment-mapping-diffuse-texture-instanced-normalmap-rl-bigprops-vertex-color).
