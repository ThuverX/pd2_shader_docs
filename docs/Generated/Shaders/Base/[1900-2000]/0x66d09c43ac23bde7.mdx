---
id: 0x66d09c43ac23bde7
title: "Effect Default Blend Add Diffuse0 Texture Intersection Fadeout View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Intersection Fadeout View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP`, `0x66d09c43ac23bde7`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-intersection-fadeout-view-angle-falloff-op).
