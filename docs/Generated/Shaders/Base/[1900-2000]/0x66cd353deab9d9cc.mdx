---
id: 0x66cd353deab9d9cc
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP`, `0x66cd353deab9d9cc`)
