...
(`landscape:default:BLEND_MASKS:CUBEMAP:MAT0:MAT0_BLEND_WORLD_MASK:MAT0_NM:MAT0_W_UV_A:MAT1:MAT1_BLEND_WORLD_MASK:MAT1_NM:MAT1_W_UV_A:MAT2:MAT2_BLEND_WORLD_MASK:MAT2_NM:MAT2_W_UV_A:MAT3:MAT3_BLEND_WORLD_MASK:MAT3_NM:MAT3_W_UV_A:OVERLAY_OVER_DETAIL:SNM_MAP:WORLD_OVERLAY_MASK_TEXTURE:WORLD_OVERLAY_TEXTURE`, `0x669bf57a745de55c`)

This template is referenced 1 time by [landscape:BLEND_MASKS:CUBEMAP:MAT0:MAT0_BLEND_WORLD_MASK:MAT0_NM:MAT0_W_UV_A:MAT1:MAT1_BLEND_WORLD_MASK:MAT1_NM:MAT1_W_UV_A:MAT2:MAT2_BLEND_WORLD_MASK:MAT2_NM:MAT2_W_UV_A:MAT3:MAT3_BLEND_WORLD_MASK:MAT3_NM:MAT3_W_UV_A:OVERLAY_OVER_DETAIL:SNM_MAP:WORLD_OVERLAY_MASK_TEXTURE:WORLD_OVERLAY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#landscape-blend-masks-cubemap-mat0-mat0-blend-world-mask-mat0-nm-mat0-w-uv-a-mat1-mat1-blend-world-mask-mat1-nm-mat1-w-uv-a-mat2-mat2-blend-world-mask-mat2-nm-mat2-w-uv-a-mat3-mat3-blend-world-mask-mat3-nm-mat3-w-uv-a-overlay-over-detail-snm-map-world-overlay-mask-texture-world-overlay-texture).
...
{
    PixelMain_Output o;
    float4 temp0, temp1, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11;
    float3 temp2, temp12;
    // def c5, 2.2, 1, 5, 0.3
    // def c6, -0.3, -0.5, 2.5, 7
    // def c7, 1, 0, 0, 0
    // dcl_texcoord7 v0.xy
    // dcl_texcoord1 v1
    ...
    if (i.texcoord1.w < ref_detail_fadeout.y) {
        ...
        // add r12.xyz, -r12, c5.y
        temp12.xyz = -temp12.xyz + float3(1, 1, 1);
        // add r3.xyz, r3, -r12
        temp3.xyz = temp3.xyz + -temp12.xyz;
        // mul_sat_pp r3.xyz, r3, c5.z
        ;// error
        ...
        // add r3.xyz, r5.zyww, c6.xyyw
        temp3.xyz = temp5.zyw + float3(-0.3, -0.5, -0.5);
        // mad r1.z, r1.y, r3.x, c5.w
        temp1.z = temp1.y * temp3.x + float1(0.3);
        // add r1.w, -r0.w, r5.x
        temp1.w = -temp0.w + temp5.x;
        // mad_pp oC1.w, r1.y, r1.w, r0.w
        o.color1.w = /* not implemented _pp modifier */ temp1.y * temp1.w + temp0.w;
        // mul_pp r0.xyz, r0, r4
        ...
        temp1.y = /* not implemented _pp modifier */ temp3.x * temp3.x;
        // mad_pp r1.y, r3.y, r3.y, -r1.y
        temp1.y = /* not implemented _pp modifier */ temp3.y * temp3.y + -temp1.y;
        ...
        // rcp_pp r3.z, r1.y
        temp3.z = /* not implemented _pp modifier */ 1.0f / temp1.y;
        // lrp_pp r4.xyz, r1.x, r3, v2
        temp4.xyz = /* not implemented _pp modifier */ lerp(i.texcoord2.xyz, temp3.xyz, temp1.xxx);
        // add r3.x, c0.w, -v1.x
        temp3.x = (camera_world_matrix._m00_m10_m20_m30).w + -i.texcoord1.x;
        // add r3.y, c1.w, -v1.y
        temp3.y = (camera_world_matrix._m01_m11_m21_m31).w + -i.texcoord1.y;
        // add r3.z, c2.w, -v1.z
        temp3.z = (camera_world_matrix._m02_m12_m22_m32).w + -i.texcoord1.z;
        // nrm r5.xyz, r3
        temp5.xyz = normalize(temp3.xyz).xyz;
        // dp3 r1.x, r4, r5
        temp1.x = dot(temp4.xyz, temp5.xyz);
        // add r1.y, r1.x, r1.x
        temp1.y = temp1.x + temp1.x;
        // mad r3.xyz, r1.y, -r4, r5
        temp3.xyz = temp1.yyy * -temp4.xyz + temp5.xyz;
        // mov_sat r1.x, r1.x
        temp1.x = saturate(temp1.x);
        // add r1.x, -r1.x, c5.y
        temp1.x = -temp1.x + float1(1);
        // add r1.y, -r1.z, c5.y
        temp1.y = -temp1.z + float1(1);
        // mul r1.y, r1.y, c6.w
        temp1.y = temp1.y * float1(7);
        // frc r1.w, r1.y
        temp1.w = frac(temp1.y);
        // add r3.w, -r1.w, r1.y
        temp3.w = -temp1.w + temp1.y;
        // texldl r3, r3, s2
        temp3 = texCUBElod(reflection_texture, temp3);
        // mad_sat_pp oC0.xyz, r3, r1.x, r0
        ;// error
        // mov_pp oC0.w, r1.z
