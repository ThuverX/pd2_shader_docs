---
id: 0x687a942fd72ecd22
title: "Generic Shadow Caster Contour Diffuse Texture Normalmap Nvidia Rl 3rd Weapons"
---

# Generic Shadow Caster Contour Diffuse Texture Normalmap Nvidia Rl 3rd Weapons
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_3RD_WEAPONS`, `0x687a942fd72ecd22`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_3RD_WEAPONS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-3rd-weapons).
