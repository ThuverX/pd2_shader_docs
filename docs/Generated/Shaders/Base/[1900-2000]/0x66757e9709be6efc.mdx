---
id: 0x66757e9709be6efc
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x66757e9709be6efc`)
