---
id: 0x6920864e68fe3b7b
title: "Generic Default Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0x6920864e68fe3b7b`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-normal-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap).
...
{
    PixelMain_Output o;
    float4 temp0, temp1, temp2, temp4;
    float3 temp3;
    // def c3, 25, -0.5, 2, 1
    // def c4, 0.25, 0, 0, 0
    // dcl_texcoord1 v0.x
    ...
    temp1.xy = temp1.wy;
    // texld r4, v1, s5
    temp4 = tex2D(normal_layer0_texture, i.texcoord.xy);
    // mov r1.zw, r4.xywy
    temp1.zw = temp4.wy;
    // add r1, r1, c3.y
    ...
    // mad_pp oC0.xyz, r1, r0.w, r3
    o.color.xyz = /* not implemented _pp modifier */ temp1.xyz * temp0.www + temp3.xyz;
    // mov oC2, v0.x
