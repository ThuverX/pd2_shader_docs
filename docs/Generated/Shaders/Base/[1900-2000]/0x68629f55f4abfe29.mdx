---
id: 0x68629f55f4abfe29
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Nvidia Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x68629f55f4abfe29`)
