---
id: 0x6707cee573cbf413
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Opacity Fade Skinned 3weights"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Opacity Fade Skinned 3weights
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:OPACITY_FADE:SKINNED_3WEIGHTS`, `0x6707cee573cbf413`)
