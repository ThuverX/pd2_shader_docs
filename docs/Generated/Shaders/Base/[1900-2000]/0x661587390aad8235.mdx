---
id: 0x661587390aad8235
title: "Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:SKINNED_3WEIGHTS`, `0x661587390aad8235`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination-skinned-3weights).
