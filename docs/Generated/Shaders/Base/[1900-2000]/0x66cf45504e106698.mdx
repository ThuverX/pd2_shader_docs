---
id: 0x66cf45504e106698
title: "Decal Default Diffuse Texture Instanced Normalmap Opacity Texture"
---

# Decal Default Diffuse Texture Instanced Normalmap Opacity Texture
(`decal:default:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_TEXTURE`, `0x66cf45504e106698`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-instanced-normalmap-opacity-texture).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // dp4 r0.x, r1, c202
    temp0.x = dot(temp1, (view_matrix._m02_m12_m22_m32));
    // mul_sat r0.y, r0.x, c209.x
    temp0.y = saturate(temp0.x * float1(0.0004));
    // mad r0.y, r0.y, c209.y, c209.z
    temp0.y = temp0.y * float1(9.995) + float1(0.005);
    // add r0.z, -r0.y, r0.x
    temp0.z = -temp0.y + temp0.x;
    // dp4 r0.x, r1, c200
