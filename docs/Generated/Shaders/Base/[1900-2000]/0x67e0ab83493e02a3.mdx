---
id: 0x67e0ab83493e02a3
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Opacity Texture Opacity Uvanim Self Illumination Self Illumination Bloom Self Illumination Uvanim"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Opacity Texture Opacity Uvanim Self Illumination Self Illumination Bloom Self Illumination Uvanim
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM`, `0x67e0ab83493e02a3`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-external-alpha-ref-opacity-texture-opacity-uvanim-self-illumination-self-illumination-bloom-self-illumination-uvanim).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v1.xxyz, c10.x, c10.y
