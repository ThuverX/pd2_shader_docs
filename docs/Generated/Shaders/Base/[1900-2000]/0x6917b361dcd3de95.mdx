---
id: 0x6917b361dcd3de95
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 3 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x6917b361dcd3de95`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-3-external-alpha-ref-instanced-normalmap-opacity-texture-vegetation-bending).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // dcl_texcoord7 o6.xy
    // mul r0.z, c213.x, v8.z
    temp0.z = ref_branch_settings.x * i.color.z;
    // add r0.w, c210.x, v8.y
