---
id: 0x6863e4996a3d7d08
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Normalmap Rl Core Environment Skinned 3weights Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Normalmap Rl Core Environment Skinned 3weights Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS:VERTEX_COLOR`, `0x6863e4996a3d7d08`)
