---
id: 0x69664ec61abf5e49
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Skinned 1weight"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Skinned 1weight
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:SKINNED_1WEIGHT`, `0x69664ec61abf5e49`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-skinned-1weight).
