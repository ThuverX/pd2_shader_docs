---
id: 0x68de3b81e59cc511
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Global Environment Mapping Normalmap Opacity Texture Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Global Environment Mapping Normalmap Opacity Texture Rl Civilians Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x68de3b81e59cc511`)
