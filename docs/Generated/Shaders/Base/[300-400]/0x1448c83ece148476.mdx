---
id: 0x1448c83ece148476
title: "Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Normalmap World Up Blend"
---

# Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Normalmap World Up Blend
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:NORMALMAP:WORLD_UP_BLEND`, `0x1448c83ece148476`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:NORMALMAP:WORLD_UP_BLEND](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-diffuse-texture-normalmap-world-up-blend).
