...
This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_FADE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-diffuse-uv2-blend-fade-blend-mask-control-blend-mask-crossblend-diffuse-texture-gsma-texture-normalmap).
