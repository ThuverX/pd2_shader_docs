---
id: 0xfe94c22fdfe722f
title: "Generic Default Diffuse Texture Gsma Texture Normalmap Simple Tint Skinned 3weights"
---

# Generic Default Diffuse Texture Gsma Texture Normalmap Simple Tint Skinned 3weights
(`generic:default:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0xfe94c22fdfe722f`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-normalmap-simple-tint-skinned-3weights).
