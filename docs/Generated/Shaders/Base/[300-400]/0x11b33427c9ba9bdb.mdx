---
id: 0x11b33427c9ba9bdb
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color Vertex Color Alpha
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x11b33427c9ba9bdb`)
