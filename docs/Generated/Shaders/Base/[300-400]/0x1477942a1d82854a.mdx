---
id: 0x1477942a1d82854a
title: "Generic Default Diffuse Texture Distance Fade 4 Instanced Normalmap"
---

# Generic Default Diffuse Texture Distance Fade 4 Instanced Normalmap
(`generic:default:DIFFUSE_TEXTURE:DISTANCE_FADE_4:INSTANCED:NORMALMAP`, `0x1477942a1d82854a`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DISTANCE_FADE_4:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-distance-fade-4-instanced-normalmap).
...
#### Vertex Shader
```hlsl
float GLOBAL_fov_ratio : register(vs_3_0, c205);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    float addr0;
    // def c206, 2, -1, 4, -0
    // def c207, -7800, 0.00023809524, 0, 0
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord1 v2
    // dcl_texcoord v3
