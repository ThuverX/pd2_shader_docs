---
id: 0x134dd0cbccda179e
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Intersection Fadeout View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Intersection Fadeout View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP`, `0x134dd0cbccda179e`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-tint-intersection-fadeout-view-angle-falloff-op).
