---
id: 0x1023059960d0fe71
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Gloss Control Value Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:VERTEX_COLOR`, `0x1023059960d0fe71`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-smooth-diffuse-texture-gloss-control-value-vertex-color).
