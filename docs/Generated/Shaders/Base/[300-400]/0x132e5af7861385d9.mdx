---
id: 0x132e5af7861385d9
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Opacity Texture Skinned 2weights"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Opacity Texture Skinned 2weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SKINNED_2WEIGHTS`, `0x132e5af7861385d9`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SKINNED_2WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-opacity-texture-skinned-2weights).
