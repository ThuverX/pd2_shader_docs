---
id: 0x12cea3e62b0fa76e
title: "Generic Default Diffuse Texture Diffuse Uvoffset Instanced"
---

# Generic Default Diffuse Texture Diffuse Uvoffset Instanced
(`generic:default:DIFFUSE_TEXTURE:DIFFUSE_UVOFFSET:INSTANCED`, `0x12cea3e62b0fa76e`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVOFFSET:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvoffset-instanced).
This template uses the following inputs:
 |Name|UI Name|Type|
|---|---|---|
|diffuse_texture|Diffuse Texture (UV1)|texture|
|uv_offset|UV Offset|vector3|.
...
float3 ref_uv_offset : register(vs_3_0, c205);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // add o2.xy, c205, v2
    o.texcoord = ref_uv_offset + i.texcoord;
