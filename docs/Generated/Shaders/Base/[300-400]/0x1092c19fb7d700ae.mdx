---
id: 0x1092c19fb7d700ae
title: "Generic Shadow Caster Alpha Masked Contour Diffuse Texture Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Contour Diffuse Texture Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:NVIDIA:OPACITY_TEXTURE`, `0x1092c19fb7d700ae`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-opacity-texture).
