---
id: 0x1377719b0149f57f
title: "Effect Default Blend Add Diffuse0 Texture Diffuse1 Blend Op Rgb Add Diffuse1 Texture Diffuse1 Threshold Sweep"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse1 Blend Op Rgb Add Diffuse1 Texture Diffuse1 Threshold Sweep
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE1_BLEND_OP_RGB_ADD:DIFFUSE1_TEXTURE:DIFFUSE1_THRESHOLD_SWEEP`, `0x1377719b0149f57f`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE1_BLEND_OP_RGB_ADD:DIFFUSE1_TEXTURE:DIFFUSE1_THRESHOLD_SWEEP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse1-blend-op-rgb-add-diffuse1-texture-diffuse1-threshold-sweep).
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    temp0.xyz = /* not implemented _pp modifier */ temp0.www * temp0.xyz;
    // cmp_pp r0.xyz, r1.x, c7.y, r0
    temp0.xyz = /* not implemented _pp modifier */ (temp1.xxx >= 0) ? float3(0, 0, 0) : temp0.xyz;
    // texld_pp r1, v0, s0
