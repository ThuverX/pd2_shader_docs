---
id: 0x14691193b92cf374
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Take Fog Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Take Fog Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:TAKE_FOG:VERTEX_COLOR`, `0x14691193b92cf374`)
