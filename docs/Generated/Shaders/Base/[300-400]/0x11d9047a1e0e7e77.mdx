---
id: 0x11d9047a1e0e7e77
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Normalmap Nvidia Rl Bigprops Vertex Color Vertex Color Alpha
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_BIGPROPS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x11d9047a1e0e7e77`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-normalmap-rl-bigprops-vertex-color-vertex-color-alpha).
