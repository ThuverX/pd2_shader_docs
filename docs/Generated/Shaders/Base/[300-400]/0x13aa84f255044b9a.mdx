---
id: 0x13aa84f255044b9a
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Opacity Texture Vegetation Bending"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Opacity Texture Vegetation Bending
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x13aa84f255044b9a`)
