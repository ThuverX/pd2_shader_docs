---
id: 0x14574a28df01a1d9
title: "Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Self Illumination Self Illumination Bloom
(`generic:shadow_caster:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x14574a28df01a1d9`)
