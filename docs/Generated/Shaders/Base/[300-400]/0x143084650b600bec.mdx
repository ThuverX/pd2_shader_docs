---
id: 0x143084650b600bec
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Environment Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Environment Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_ENVIRONMENT:VERTEX_COLOR`, `0x143084650b600bec`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-rl-environment-vertex-color).
