---
id: 0x11106ef4d2f2d30a
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Rl Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Rl Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:RL_ENVIRONMENT:VERTEX_COLOR`, `0x11106ef4d2f2d30a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-smooth-diffuse-texture-rl-environment-vertex-color).
