---
id: 0x139cb0345a62e9f8
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Nvidia Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Nvidia Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NVIDIA:VERTEX_COLOR`, `0x139cb0345a62e9f8`)
