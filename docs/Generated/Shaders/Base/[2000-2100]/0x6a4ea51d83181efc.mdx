---
id: 0x6a4ea51d83181efc
title: "Generic Default Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VERTEX_COLOR`, `0x6a4ea51d83181efc`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-blend-mask-crossblend-blend-normal-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gloss-control-value-normalmap-vertex-color).
...
float2 ref_blend_control : register(ps_3_0, c4);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // lrp_pp r4.x, c4.y, r2.x, r3.w
    temp4.x = /* not implemented _pp modifier */ lerp(temp3.w, temp2.x, ref_blend_control.y);
    // add_pp r2.x, r4.x, -v6.w
    temp2.x = /* not implemented _pp modifier */ temp4.x + -i.color.w;
    // rcp r2.y, c4.x
    ...
    // add r0.x, r0.x, -c3.x
    temp0.x = temp0.x + -ref_glossiness_control.x;
    // mul r0.x, r0.x, c6.x
