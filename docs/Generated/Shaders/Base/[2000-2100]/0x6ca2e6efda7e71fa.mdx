---
id: 0x6ca2e6efda7e71fa
title: "Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Self Illumination"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Self Illumination
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION`, `0x6ca2e6efda7e71fa`)
