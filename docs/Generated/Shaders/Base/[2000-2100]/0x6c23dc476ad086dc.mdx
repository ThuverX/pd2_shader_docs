---
id: 0x6c23dc476ad086dc
title: "Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Vegetation Bending"
---

# Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Vegetation Bending
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA:VEGETATION_BENDING`, `0x6c23dc476ad086dc`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-normalmap-vegetation-bending).
