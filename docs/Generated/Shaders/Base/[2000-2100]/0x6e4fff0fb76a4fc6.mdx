---
id: 0x6e4fff0fb76a4fc6
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0x6e4fff0fb76a4fc6`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-vertex-color).
