---
id: 0x6c923103cfa33756
title: "Generic Shadow Caster Contour Diffuse Texture Gsma Texture Normalmap Nvidia"
---

# Generic Shadow Caster Contour Diffuse Texture Gsma Texture Normalmap Nvidia
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA`, `0x6c923103cfa33756`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-gsma-texture-normalmap).
