---
id: 0x6b0b131a9cdbdc98
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Nvidia Opacity Texture Simple Tint"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Nvidia Opacity Texture Simple Tint
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:OPACITY_TEXTURE:SIMPLE_TINT`, `0x6b0b131a9cdbdc98`)
