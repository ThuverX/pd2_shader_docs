---
id: 0x6da629cb9b59f7a3
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 1weight Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 1weight Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT:VERTEX_COLOR`, `0x6da629cb9b59f7a3`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-skinned-1weight-vertex-color).
