---
id: 0x6cbb1ebe80401a2c
title: "Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap World Up Blend"
---

# Generic Shadow Caster Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap World Up Blend
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:WORLD_UP_BLEND`, `0x6cbb1ebe80401a2c`)
