---
id: 0x6f841e2d56fb8216
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Opacity Texture Rl Cops Skinned 3weights"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Opacity Texture Rl Cops Skinned 3weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS`, `0x6f841e2d56fb8216`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-global-environment-mapping-gloss-blurs-cubemap-gsma-texture-normalmap-opacity-texture-rl-cops-skinned-3weights).
