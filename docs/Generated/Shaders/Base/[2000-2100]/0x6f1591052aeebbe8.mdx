---
id: 0x6f1591052aeebbe8
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Opacity By Depth Take Fog"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Opacity By Depth Take Fog
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:NORMALMAP:OPACITY_BY_DEPTH:TAKE_FOG`, `0x6f1591052aeebbe8`)
