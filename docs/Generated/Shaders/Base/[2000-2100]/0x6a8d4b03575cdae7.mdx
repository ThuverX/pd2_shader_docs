---
id: 0x6a8d4b03575cdae7
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia Take Global Light"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia Take Global Light
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA:TAKE_GLOBAL_LIGHT`, `0x6a8d4b03575cdae7`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:TAKE_GLOBAL_LIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-normalmap-take-global-light).
