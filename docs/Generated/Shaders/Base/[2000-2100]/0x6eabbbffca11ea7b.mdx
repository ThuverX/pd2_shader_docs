---
id: 0x6eabbbffca11ea7b
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:OPACITY_TEXTURE:VERTEX_COLOR`, `0x6eabbbffca11ea7b`)
