---
id: 0x6cab1ea121bf96e0
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gloss Blurs Cubemap Gloss Control Value Normalmap Self Illumination Vegetation Bending Vertex Alpha"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gloss Blurs Cubemap Gloss Control Value Normalmap Self Illumination Vegetation Bending Vertex Alpha
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:SELF_ILLUMINATION:VEGETATION_BENDING:VERTEX_ALPHA`, `0x6cab1ea121bf96e0`)
