---
id: 0x6c93a2c0f4851eeb
title: "Generic Shadow Caster Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x6c93a2c0f4851eeb`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-depth-scaling-diffuse-texture-normalmap-skinned-3weights).
