---
id: 0x70bb8f8341b4f4b1
title: "Generic Default Blend Diffuse Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Normal Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0x70bb8f8341b4f4b1`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-normal-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // lrp_pp r0.yzw, r1.w, r4.xxyz, r1.xxyz
    temp0.yzw = /* not implemented _pp modifier */ lerp(temp1.xyz, temp4.xyz, temp1.www);
    // mad_pp oC0.xyz, r2, r0.x, r0.yzww
    o.color.xyz = /* not implemented _pp modifier */ temp2.xyz * temp0.xxx + temp0.yzw;
    // mov_pp oC0.w, r3.x
