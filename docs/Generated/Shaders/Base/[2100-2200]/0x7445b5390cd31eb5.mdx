---
id: 0x7445b5390cd31eb5
title: "Generic Default Blend Diffuse Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x7445b5390cd31eb5`)
