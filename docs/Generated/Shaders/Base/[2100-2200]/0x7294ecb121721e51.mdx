---
id: 0x7294ecb121721e51
title: "Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Double Sided Normalmap Nvidia Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA:SKINNED_1WEIGHT`, `0x7294ecb121721e51`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-normalmap-skinned-1weight).
