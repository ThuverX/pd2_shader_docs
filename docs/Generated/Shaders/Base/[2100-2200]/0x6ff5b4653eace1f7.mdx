---
id: 0x6ff5b4653eace1f7
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NVIDIA:SKINNED_1WEIGHT`, `0x6ff5b4653eace1f7`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-skinned-1weight).
