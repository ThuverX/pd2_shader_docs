---
id: 0x70bd8140b1365d5b
title: "Generic Shadow Caster Diffuse Texture Nvidia Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Nvidia Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:VERTEX_COLOR`, `0x70bd8140b1365d5b`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-vertex-color).
