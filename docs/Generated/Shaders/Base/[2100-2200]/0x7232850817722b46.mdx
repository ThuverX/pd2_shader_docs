---
id: 0x7232850817722b46
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Control Value Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Gloss Control Value Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_CONTROL_VALUE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x7232850817722b46`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_CONTROL_VALUE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-gloss-control-value-normalmap-skinned-3weights).
