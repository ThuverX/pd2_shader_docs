---
id: 0x72ca373396a8e922
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gsma Texture Opacity Texture Simple Tint"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gsma Texture Opacity Texture Simple Tint
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:OPACITY_TEXTURE:SIMPLE_TINT`, `0x72ca373396a8e922`)
