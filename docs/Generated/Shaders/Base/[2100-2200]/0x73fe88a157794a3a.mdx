---
id: 0x73fe88a157794a3a
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Diffuse0 Uvanim Instanced View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint Diffuse0 Uvanim Instanced View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:DIFFUSE0_UVANIM:INSTANCED:VIEW_ANGLE_FALLOFF_OP`, `0x73fe88a157794a3a`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:DIFFUSE0_UVANIM:INSTANCED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-tint-diffuse0-uvanim-instanced-view-angle-falloff-op).
