---
id: 0x730d5e9f7ef1f8cf
title: "Opacity Default Diffuse Texture Nvidia Opacity Fade"
---

# Opacity Default Diffuse Texture Nvidia Opacity Fade
(`opacity:default:DIFFUSE_TEXTURE:NVIDIA:OPACITY_FADE`, `0x730d5e9f7ef1f8cf`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:OPACITY_FADE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-opacity-fade).
