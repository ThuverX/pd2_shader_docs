---
id: 0x21d95f4412153acf
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:SELF_ILLUMINATION:VERTEX_COLOR`, `0x21d95f4412153acf`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-self-illumination-vertex-color).
