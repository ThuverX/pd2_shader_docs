---
id: 0x1f4c6ab2a28d775d
title: "Generic Default Cube Environment Mapping Diffuse Texture Rl Backdrop Self Illumination Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Rl Backdrop Self Illumination Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_BACKDROP:SELF_ILLUMINATION:VERTEX_COLOR`, `0x1f4c6ab2a28d775d`)
