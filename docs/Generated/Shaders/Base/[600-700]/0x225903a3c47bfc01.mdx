---
id: 0x225903a3c47bfc01
title: "Generic Shadow Caster Alpha Masked Ati Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Cops Simple Tint Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Ati Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Cops Simple Tint Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_COPS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0x225903a3c47bfc01`)
