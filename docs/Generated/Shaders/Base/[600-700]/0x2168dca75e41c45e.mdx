---
id: 0x2168dca75e41c45e
title: "Generic Shadow Caster Instanced Nvidia Self Illumination Self Illumination Mask Vertex Color"
---

# Generic Shadow Caster Instanced Nvidia Self Illumination Self Illumination Mask Vertex Color
(`generic:shadow_caster:INSTANCED:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_MASK:VERTEX_COLOR`, `0x2168dca75e41c45e`)

This template is referenced 1 time by [generic:INSTANCED:SELF_ILLUMINATION:SELF_ILLUMINATION_MASK:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-instanced-self-illumination-self-illumination-mask-vertex-color).
