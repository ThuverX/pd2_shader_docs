---
id: 0x219936a886bbde18
title: "Generic Shadow Caster Nvidia Vertex Color Alpha"
---

# Generic Shadow Caster Nvidia Vertex Color Alpha
(`generic:shadow_caster:NVIDIA:VERTEX_COLOR_ALPHA`, `0x219936a886bbde18`)

This template is referenced 1 time by [generic:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-vertex-color-alpha).
