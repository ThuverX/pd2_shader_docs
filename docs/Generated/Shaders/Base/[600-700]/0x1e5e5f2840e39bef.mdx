---
id: 0x1e5e5f2840e39bef
title: "Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap Rl Environment"
---

# Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap Rl Environment
(`generic:default:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT`, `0x1e5e5f2840e39bef`)
