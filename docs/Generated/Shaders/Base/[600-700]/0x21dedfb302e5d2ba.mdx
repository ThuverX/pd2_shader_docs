---
id: 0x21dedfb302e5d2ba
title: "Opacity Default Diffuse Texture Normalmap Nvidia Opacity Controller Skinned 3weights"
---

# Opacity Default Diffuse Texture Normalmap Nvidia Opacity Controller Skinned 3weights
(`opacity:default:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_CONTROLLER:SKINNED_3WEIGHTS`, `0x21dedfb302e5d2ba`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_CONTROLLER:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-normalmap-opacity-controller-skinned-3weights).
