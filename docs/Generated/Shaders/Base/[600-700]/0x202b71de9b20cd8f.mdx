---
id: 0x202b71de9b20cd8f
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Nvidia Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Nvidia Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NVIDIA:VEGETATION_BENDING`, `0x202b71de9b20cd8f`)
