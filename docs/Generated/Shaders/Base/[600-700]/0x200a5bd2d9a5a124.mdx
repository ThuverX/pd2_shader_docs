---
id: 0x200a5bd2d9a5a124
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Self Illumination Self Illumination Bloom Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Self Illumination Self Illumination Bloom Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:VERTEX_COLOR`, `0x200a5bd2d9a5a124`)
