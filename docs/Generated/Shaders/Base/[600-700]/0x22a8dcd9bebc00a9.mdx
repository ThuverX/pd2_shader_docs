---
id: 0x22a8dcd9bebc00a9
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_CHARACTER`, `0x22a8dcd9bebc00a9`)
