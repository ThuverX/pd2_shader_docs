---
id: 0x2033603a7a53a0a4
title: "Opacity Default Diffuse Texture Nvidia"
---

# Opacity Default Diffuse Texture Nvidia
(`opacity:default:DIFFUSE_TEXTURE:NVIDIA`, `0x2033603a7a53a0a4`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture).
