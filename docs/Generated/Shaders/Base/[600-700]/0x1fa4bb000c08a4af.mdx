---
id: 0x1fa4bb000c08a4af
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref Instanced Normalmap Opacity Texture Vegetation Bending
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING`, `0x1fa4bb000c08a4af`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-2-external-alpha-ref-instanced-normalmap-opacity-texture-vegetation-bending).
