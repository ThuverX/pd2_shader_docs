---
id: 0x1e182dfdd81b38c7
title: "Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Simple Tint Skinned 3weights"
---

# Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Simple Tint Skinned 3weights
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0x1e182dfdd81b38c7`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-external-alpha-ref-normalmap-opacity-texture-simple-tint-skinned-3weights).
