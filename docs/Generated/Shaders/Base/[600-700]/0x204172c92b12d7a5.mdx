---
id: 0x204172c92b12d7a5
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Backdrop Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Backdrop Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BACKDROP:SELF_ILLUMINATION`, `0x204172c92b12d7a5`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_BACKDROP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-backdrop-self-illumination).
