---
id: 0x21f1583cfd1f2eb5
title: "Generic Default Blend Diffuse Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x21f1583cfd1f2eb5`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-diffuse-texture-gsma-texture-normalmap-vertex-color).
