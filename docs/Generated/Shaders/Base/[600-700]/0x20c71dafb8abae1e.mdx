---
id: 0x20c71dafb8abae1e
title: "Effect Default Diffuse0 Texture View Angle Falloff Op"
---

# Effect Default Diffuse0 Texture View Angle Falloff Op
(`effect:default:DIFFUSE0_TEXTURE:VIEW_ANGLE_FALLOFF_OP`, `0x20c71dafb8abae1e`)

This template is referenced 1 time by [effect:DIFFUSE0_TEXTURE:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-diffuse0-texture-view-angle-falloff-op).
