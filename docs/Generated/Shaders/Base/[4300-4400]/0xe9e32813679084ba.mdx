---
id: 0xe9e32813679084ba
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Nvidia Opacity Texture Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Nvidia Opacity Texture Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:OPACITY_TEXTURE:SKINNED_3WEIGHTS`, `0xe9e32813679084ba`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-normalmap-opacity-texture-skinned-3weights).
