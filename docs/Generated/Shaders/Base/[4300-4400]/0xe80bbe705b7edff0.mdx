---
id: 0xe80bbe705b7edff0
title: "Generic Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Skinned 3weights Transparent"
---

# Generic Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Skinned 3weights Transparent
(`generic:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS:TRANSPARENT`, `0xe80bbe705b7edff0`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS:TRANSPARENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-skinned-3weights-transparent).
...
float ref_time : register(vs_3_0, c170);
float3 ref_uv_speed : register(vs_3_0, c171);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mov r0.x, c170.x
    temp0.x = ref_time.x;
    // mad o2.xy, r0.x, c171, v5
    o.texcoord.xy = temp0.xx * ref_uv_speed.xy + i.texcoord.xy;
    // mad o2.zw, r0.x, c171.xyxy, v4.xyxy
