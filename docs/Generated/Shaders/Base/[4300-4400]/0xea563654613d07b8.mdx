---
id: 0xea563654613d07b8
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Simple Tint"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Simple Tint
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:SIMPLE_TINT`, `0xea563654613d07b8`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-instanced-normalmap-simple-tint).
