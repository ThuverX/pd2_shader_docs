---
id: 0xe77dc5edc0d41ea9
title: "Generic Shadow Caster Blue Mask Tint Diffuse Texture Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Blue Mask Tint Diffuse Texture Instanced Normalmap Nvidia
(`generic:shadow_caster:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA`, `0xe77dc5edc0d41ea9`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-instanced-normalmap).
