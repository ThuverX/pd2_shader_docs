---
id: 0xe9a52068a0b1ee97
title: "Generic Shadow Caster Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap Nvidia Vertex Color
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0xe9a52068a0b1ee97`)
