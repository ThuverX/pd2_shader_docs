---
id: 0xe8d2d40717077ed0
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Nvidia Simple Tint Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Nvidia Simple Tint Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:SIMPLE_TINT:SKINNED_1WEIGHT`, `0xe8d2d40717077ed0`)
