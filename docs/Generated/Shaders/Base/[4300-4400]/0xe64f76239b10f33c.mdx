---
id: 0xe64f76239b10f33c
title: "Opacity Default Diffuse Texture Instanced Nvidia Self Illumination"
---

# Opacity Default Diffuse Texture Instanced Nvidia Self Illumination
(`opacity:default:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:SELF_ILLUMINATION`, `0xe64f76239b10f33c`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-instanced-self-illumination).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v4.xxyz, c209.x, c209.y
