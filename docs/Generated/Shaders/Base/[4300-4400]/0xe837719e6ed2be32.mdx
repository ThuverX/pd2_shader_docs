---
id: 0xe837719e6ed2be32
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Opacity Texture Simple Tint"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Opacity Texture Simple Tint
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT`, `0xe837719e6ed2be32`)
