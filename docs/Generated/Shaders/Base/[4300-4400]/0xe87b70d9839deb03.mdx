---
id: 0xe87b70d9839deb03
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Rl Core Environment Skinned 2weights"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Rl Core Environment Skinned 2weights
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_2WEIGHTS`, `0xe87b70d9839deb03`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_2WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-normalmap-rl-core-environment-skinned-2weights).
