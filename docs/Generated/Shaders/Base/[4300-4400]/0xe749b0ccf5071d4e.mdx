---
id: 0xe749b0ccf5071d4e
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Skinned 2weights Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Skinned 2weights Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SKINNED_2WEIGHTS:VERTEX_COLOR`, `0xe749b0ccf5071d4e`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SKINNED_2WEIGHTS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-normalmap-skinned-2weights-vertex-color).
