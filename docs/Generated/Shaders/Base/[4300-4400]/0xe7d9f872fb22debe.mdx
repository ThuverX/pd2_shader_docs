---
id: 0xe7d9f872fb22debe
title: "Generic Default Cube Environment Mapping Diffuse Texture Rl Core Environment Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Rl Core Environment Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xe7d9f872fb22debe`)
