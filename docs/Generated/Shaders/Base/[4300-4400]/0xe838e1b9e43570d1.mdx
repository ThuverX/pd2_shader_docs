---
id: 0xe838e1b9e43570d1
title: "Generic Shadow Caster Nvidia Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Nvidia Rl Cops Skinned 3weights
(`generic:shadow_caster:NVIDIA:RL_COPS:SKINNED_3WEIGHTS`, `0xe838e1b9e43570d1`)

This template is referenced 1 time by [generic:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-rl-cops-skinned-3weights).
