---
id: 0xe8418ff3296b5b0d
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0xe8418ff3296b5b0d`)
