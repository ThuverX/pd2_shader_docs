---
id: 0xe6b1b46ed9f2fd7a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_FADE`, `0xe6b1b46ed9f2fd7a`)
