---
id: 0xe8794ca7ef421ef2
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NVIDIA`, `0xe8794ca7ef421ef2`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture).
