---
id: 0xea5308a0b04f7cfe
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Rl Backdrop Self Illumination"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Rl Backdrop Self Illumination
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:RL_BACKDROP:SELF_ILLUMINATION`, `0xea5308a0b04f7cfe`)
