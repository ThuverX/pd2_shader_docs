---
id: 0xe6e44323a2261564
title: "Generic Shadow Caster Diffuse Texture Double Sided Gsma Texture Normalmap Nvidia"
---

# Generic Shadow Caster Diffuse Texture Double Sided Gsma Texture Normalmap Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:GSMA_TEXTURE:NORMALMAP:NVIDIA`, `0xe6e44323a2261564`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-gsma-texture-normalmap).
