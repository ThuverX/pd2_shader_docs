---
id: 0xe98b131eb0376f76
title: "Generic Shadow Caster Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Nvidia Opacity Texture Rl Civilians Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Nvidia Opacity Texture Rl Civilians Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:NVIDIA:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_1WEIGHT`, `0xe98b131eb0376f76`)
