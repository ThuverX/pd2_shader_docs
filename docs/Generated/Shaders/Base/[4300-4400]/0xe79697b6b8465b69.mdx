---
id: 0xe79697b6b8465b69
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0xe79697b6b8465b69`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-normalmap-skinned-3weights).
