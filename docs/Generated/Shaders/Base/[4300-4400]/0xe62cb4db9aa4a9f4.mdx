---
id: 0xe62cb4db9aa4a9f4
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Self Illumination"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Self Illumination
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:SELF_ILLUMINATION`, `0xe62cb4db9aa4a9f4`)
