---
id: 0xe9628b87dd8823a0
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Nvidia"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Nvidia
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NVIDIA`, `0xe9628b87dd8823a0`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-instanced).
