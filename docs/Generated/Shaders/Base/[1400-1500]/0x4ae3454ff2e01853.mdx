---
id: 0x4ae3454ff2e01853
title: "Generic Shadow Caster Contour Detail Normal Texture Blue Detail Normal Texture Green Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Normalmap Skinned 3weights"
---

# Generic Shadow Caster Contour Detail Normal Texture Blue Detail Normal Texture Green Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Normalmap Skinned 3weights
(`generic:shadow_caster:CONTOUR:DETAIL_NORMAL_TEXTURE_BLUE:DETAIL_NORMAL_TEXTURE_GREEN:DETAIL_NORMAL_TEXTURE_RED:DETAIL_RGB_MASK:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x4ae3454ff2e01853`)
