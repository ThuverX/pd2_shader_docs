---
id: 0x4c14457bfd575970
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 1 Double Sided External Alpha Ref Instanced Normalmap"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 1 Double Sided External Alpha Ref Instanced Normalmap
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP`, `0x4c14457bfd575970`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-1-double-sided-external-alpha-ref-instanced-normalmap).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    temp0.x = temp0.z * temp0.y + float1(-520);
    // mov o1.x, r0.z
