---
id: 0x4eadebebe3894049
title: "Generic Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Simple Tint"
---

# Generic Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Simple Tint
(`generic:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SIMPLE_TINT`, `0x4eadebebe3894049`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-simple-tint).
