---
id: 0x4acf0c226732f112
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Nvidia Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Gsma Texture Normalmap Nvidia Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VERTEX_COLOR`, `0x4acf0c226732f112`)
