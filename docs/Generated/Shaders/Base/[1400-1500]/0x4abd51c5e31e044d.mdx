---
id: 0x4abd51c5e31e044d
title: "Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:SKINNED_3WEIGHTS`, `0x4abd51c5e31e044d`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-skinned-3weights).
