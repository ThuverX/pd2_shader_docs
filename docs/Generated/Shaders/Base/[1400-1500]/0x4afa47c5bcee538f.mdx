---
id: 0x4afa47c5bcee538f
title: "Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap Opacity Texture"
---

# Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap Opacity Texture
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE`, `0x4afa47c5bcee538f`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-gloss-control-value-normalmap-opacity-texture).
