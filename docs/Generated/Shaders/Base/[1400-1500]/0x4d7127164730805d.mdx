---
id: 0x4d7127164730805d
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Alpha Masking Gsma Texture
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_ALPHA_MASKING:GSMA_TEXTURE`, `0x4d7127164730805d`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_ALPHA_MASKING:GSMA_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gsma-alpha-masking-gsma-texture).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add r2.x, -r0.x, c3.y
    temp2.x = -temp0.x + float1(1);
    // mul r2.x, r2.x, c4.x
    temp2.x = temp2.x * float1(7);
    // frc r2.y, r2.x
    temp2.y = frac(temp2.x);
    // add r1.w, -r2.y, r2.x
    temp1.w = -temp2.y + temp2.x;
    // texldl r1, r1, s2
