---
id: 0x4dfeefff6b479c58
title: "Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only"
---

# Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only
(`shadow_caster_only:shadow_caster:NVIDIA:SHADOW_CASTER_ONLY`, `0x4dfeefff6b479c58`)

This template is referenced 1 time by [shadow_caster_only](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only).
