---
id: 0x4ac1d3a014cfc00a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Take Fog Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Take Fog Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:TAKE_FOG:VERTEX_COLOR`, `0x4ac1d3a014cfc00a`)
