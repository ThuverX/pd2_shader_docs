---
id: 0x4c861851da0cc661
title: "Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0x4c861851da0cc661`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-diffuse-texture-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    o.color.xyz = /* not implemented _pp modifier */ temp0.xxx * temp0.yzw + temp1.xyz;
