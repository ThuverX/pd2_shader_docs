---
id: 0x4ca4bbdcbcdc175a
title: "Effect Default Blend Add Diffuse0 Texture Double Sided Skinned 1weight"
---

# Effect Default Blend Add Diffuse0 Texture Double Sided Skinned 1weight
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:SKINNED_1WEIGHT`, `0x4ca4bbdcbcdc175a`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-double-sided-skinned-1weight).
