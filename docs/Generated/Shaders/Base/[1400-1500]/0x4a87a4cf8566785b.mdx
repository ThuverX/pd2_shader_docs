---
id: 0x4a87a4cf8566785b
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Fade Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Fade Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:OPACITY_FADE:VERTEX_COLOR`, `0x4a87a4cf8566785b`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-opacity-fade-vertex-color).
