---
id: 0xab6f55546c0ce436
title: "Decal Default Diffuse Texture Distance Fade 1 Opacity Texture Skinned 3weights"
---

# Decal Default Diffuse Texture Distance Fade 1 Opacity Texture Skinned 3weights
(`decal:default:DIFFUSE_TEXTURE:DISTANCE_FADE_1:OPACITY_TEXTURE:SKINNED_3WEIGHTS`, `0xab6f55546c0ce436`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:DISTANCE_FADE_1:OPACITY_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-distance-fade-1-opacity-texture-skinned-3weights).
...
#### Vertex Shader
```hlsl
float GLOBAL_fov_ratio : register(vs_3_0, c171);
column_major float4x3 bones[54] : register(vs_3_0, c0);
float camera_near_range : register(vs_3_0, c170);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    float4 temp0, temp1;
    float2 addr0;
    // def c172, 3, 1, 0.0004, -520
    // def c173, 9.995, 0.005, 0.0035714286, 0
    // dcl_position v0
    // dcl_blendweight v1
    // dcl_blendindices v2
    // dcl_texcoord v3
    ...
    // mul_sat r1.y, r1.x, c172.z
    temp1.y = saturate(temp1.x * float1(0.0004));
    // mad r1.y, r1.y, c173.x, c173.y
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    out_color.w = /* not implemented _pp modifier */ temp0.x * i.texcoord1.x;
    // texld_pp r0, v0, s0
