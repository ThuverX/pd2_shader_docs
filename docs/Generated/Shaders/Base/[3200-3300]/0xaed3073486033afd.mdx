---
id: 0xaed3073486033afd
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xaed3073486033afd`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-seperate-blend-normal-blend-smooth-diffuse-texture-gsma-texture-normalmap-rl-core-environment-vertex-color).
