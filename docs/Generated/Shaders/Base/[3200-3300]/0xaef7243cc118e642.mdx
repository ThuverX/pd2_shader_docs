---
id: 0xaef7243cc118e642
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Nvidia Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NVIDIA:SKINNED_3WEIGHTS`, `0xaef7243cc118e642`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-skinned-3weights).
