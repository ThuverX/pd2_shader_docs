---
id: 0xac21710482a39ba0
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Nvidia Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Nvidia Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NVIDIA:OPACITY_TEXTURE:VEGETATION_BENDING`, `0xac21710482a39ba0`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-instanced-opacity-texture-vegetation-bending).
