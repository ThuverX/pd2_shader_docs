---
id: 0xa9f4d9a8e3d2403d
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Environment"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Environment
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_ENVIRONMENT`, `0xa9f4d9a8e3d2403d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-environment).
