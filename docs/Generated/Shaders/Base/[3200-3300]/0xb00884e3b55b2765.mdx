---
id: 0xb00884e3b55b2765
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Core Environment Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xb00884e3b55b2765`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-rl-core-environment-vertex-color).
