---
id: 0xaacefeac9196454f
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade To Solid Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade To Solid Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_FADE_TO_SOLID:VERTEX_COLOR`, `0xaacefeac9196454f`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE_TO_SOLID:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-opacity-fade-to-solid-vertex-color).
