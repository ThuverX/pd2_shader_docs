---
id: 0xaebcd7076d171760
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided Gsma Alpha Masking Gsma Texture Normalmap"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture Double Sided Gsma Alpha Masking Gsma Texture Normalmap
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP`, `0xaebcd7076d171760`)
