---
id: 0xaab8d9781c34acea
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Bigprops"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Rl Bigprops
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_BIGPROPS`, `0xaab8d9781c34acea`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_BIGPROPS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-rl-bigprops).
