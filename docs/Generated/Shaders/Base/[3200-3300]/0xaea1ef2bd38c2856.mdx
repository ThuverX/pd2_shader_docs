---
id: 0xaea1ef2bd38c2856
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Instanced"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Instanced
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:INSTANCED`, `0xaea1ef2bd38c2856`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-uvanim-instanced).
...
float3 ref_uv0_speed : register(vs_3_0, c205);
