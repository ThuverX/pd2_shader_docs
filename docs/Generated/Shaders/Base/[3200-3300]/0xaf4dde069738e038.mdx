...
This template is referenced 1 time by [generic:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED](/docs/Generated/Render%20Templates/base.render_template_database#generic-axis-aligned-billboard-billboard-center-offset-billboard-up-axis-diffuse-texture-double-sided).
