---
id: 0xaf84cb0f4e5c3f4b
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:OPACITY_TEXTURE:VEGETATION_BENDING`, `0xaf84cb0f4e5c3f4b`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-normalmap-opacity-texture-vegetation-bending).
