---
id: 0xac8539728a8aa33f
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Vertex Color Alpha"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Vertex Color Alpha
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR_ALPHA`, `0xac8539728a8aa33f`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-vertex-color-alpha).
