---
id: 0xada174f64b5b01f1
title: "Generic Shadow Caster Ati Blend Diffuse Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xada174f64b5b01f1`)
