---
id: 0xab4c2504209740ab
title: "Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Controller Opacity Uvanim Self Illumination Self Illumination Uvanim"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Controller Opacity Uvanim Self Illumination Self Illumination Uvanim
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_CONTROLLER:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0xab4c2504209740ab`)
