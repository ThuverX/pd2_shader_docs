---
id: 0xac7dfc696e2cd7f7
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Instanced Normalmap Opacity Texture Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Instanced Normalmap Opacity Texture Self Illumination Self Illumination Bloom
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0xac7dfc696e2cd7f7`)
