---
id: 0xaec642f911a3521f
title: "Generic Default Diffuse Texture Distance Fade 4 Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Diffuse Texture Distance Fade 4 Normalmap Rl Core Environment Vertex Color
(`generic:default:DIFFUSE_TEXTURE:DISTANCE_FADE_4:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0xaec642f911a3521f`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DISTANCE_FADE_4:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-distance-fade-4-normalmap-rl-core-environment-vertex-color).
