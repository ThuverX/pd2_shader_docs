---
id: 0xa0f8c03e4e301dbf
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Normal Uvanim Nvidia Take Global Light"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Normal Uvanim Nvidia Take Global Light
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NORMAL_UVANIM:NVIDIA:TAKE_GLOBAL_LIGHT`, `0xa0f8c03e4e301dbf`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NORMAL_UVANIM:TAKE_GLOBAL_LIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-normalmap-normal-uvanim-take-global-light).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v5.xxyz, c15.x, c15.y
    ...
    // mov r1.x, c13.x
    temp1.x = ref_time.x;
    // mad o4.zw, r1.x, c14.xyxy, v2.xyxy
