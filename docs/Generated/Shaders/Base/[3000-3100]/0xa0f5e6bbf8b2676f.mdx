---
id: 0xa0f5e6bbf8b2676f
title: "Generic Default Blend Diffuse Blend Gsma Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Gsma Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0xa0f5e6bbf8b2676f`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r0.w, r0.w, -v6.w
    temp0.w = /* not implemented _pp modifier */ temp0.w + -i.color.w;
    ...
    // lrp_pp r3.x, r0.w, r1.y, r2.y
    temp3.x = /* not implemented _pp modifier */ lerp(temp2.y, temp1.y, temp0.w);
    // mad oC0.w, r0.w, r1.x, r2.x
    o.color.w = temp0.w * temp1.x + temp2.x;
    // texld_pp r1, v1, s0
    ...
    // mad r1.xyz, r1.x, -r0, r4
    temp1.xyz = temp1.xxx * -temp0.xyz + temp4.xyz;
    // mad_pp oC1.xyz, r0, -c3.y, -c3.y
    o.color1.xyz = /* not implemented _pp modifier */ temp0.xyz * float3(0.5, 0.5, 0.5) + float3(0.5, 0.5, 0.5);
    // texld r1, r1, s5
    temp1 = texCUBE(reflection_texture, temp1.xyz);
    // mad_pp oC0.xyz, r1, r0.w, r2
    o.color.xyz = /* not implemented _pp modifier */ temp1.xyz * temp0.www + temp2.xyz;
    // mov oC2, v0.x
