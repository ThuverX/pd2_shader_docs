---
id: 0xa42d05a90aedc078
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided External Alpha Ref Opacity Texture Opacity Uvanim Self Illumination Self Illumination Bloom Self Illumination Uvanim"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided External Alpha Ref Opacity Texture Opacity Uvanim Self Illumination Self Illumination Bloom Self Illumination Uvanim
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM`, `0xa42d05a90aedc078`)
