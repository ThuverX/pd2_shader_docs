---
id: 0xa36ebc209d5932ee
title: "Generic Default Blend Diffuse Blend Fade Blend Fade Time Blend Gsma Blend Mask Seperate Blend Normal Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Fade Blend Fade Time Blend Gsma Blend Mask Seperate Blend Normal Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_FADE:BLEND_FADE_TIME:BLEND_GSMA:BLEND_MASK_SEPERATE:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0xa36ebc209d5932ee`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_FADE:BLEND_FADE_TIME:BLEND_GSMA:BLEND_MASK_SEPERATE:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-fade-blend-fade-time-blend-gsma-blend-mask-seperate-blend-normal-diffuse-texture-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add r0.yz, r1.xyxw, -r2.xyxw
    temp0.yz = temp1.yx + -temp2.yx;
    // mad_pp oC1.w, r0.x, r0.y, r2.y
    o.color1.w = /* not implemented _pp modifier */ temp0.x * temp0.y + temp2.y;
    // mad oC0.w, r0.x, r0.z, r2.x
    o.color.w = temp0.x * temp0.z + temp2.x;
    // texld_pp r1, v1, s0
