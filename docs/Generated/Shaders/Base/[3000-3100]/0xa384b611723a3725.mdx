---
id: 0xa384b611723a3725
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade Skinned 1weight"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade Skinned 1weight
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:OPACITY_FADE:SKINNED_1WEIGHT`, `0xa384b611723a3725`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_FADE:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-opacity-fade-skinned-1weight).
