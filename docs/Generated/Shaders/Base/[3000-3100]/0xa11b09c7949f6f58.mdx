---
id: 0xa11b09c7949f6f58
title: "Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint Vertex Color"
---

# Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:BLEND_NORMAL_UV2:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:VERTEX_COLOR`, `0xa11b09c7949f6f58`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:BLEND_NORMAL_UV2:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-diffuse-uv2-blend-gsma-blend-mask-control-blend-mask-crossblend-blend-normal-blend-normal-uv2-blue-mask-tint-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gsma-texture-normalmap-simple-tint-vertex-color).
...
float3 ref_tint_color : register(ps_3_0, c4);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r2.xyz, c4, v6
    temp2.xyz = ref_tint_color.xyz * i.color.xyz;
    // mul r2.xyz, r4, r2
    temp2.xyz = temp4.xyz * temp2.xyz;
    // mad_pp oC0.xyz, r2, c6.y, r1
    o.color.xyz = /* not implemented _pp modifier */ temp2.xyz * float3(4, 4, 4) + temp1.xyz;
    // mov oC0.w, r0.y
    o.color.w = temp0.y;
    // mov_pp oC1.w, r0.x
