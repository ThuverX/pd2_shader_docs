---
id: 0xa21a37752b5ce237
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Environment Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Environment Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_ENVIRONMENT:VERTEX_COLOR`, `0xa21a37752b5ce237`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-rl-environment-vertex-color).
