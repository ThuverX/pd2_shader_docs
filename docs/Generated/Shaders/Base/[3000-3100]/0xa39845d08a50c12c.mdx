---
id: 0xa39845d08a50c12c
title: "Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Rl Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Normal Diffuse Texture Normalmap Rl Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR`, `0xa39845d08a50c12c`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-normal-diffuse-texture-normalmap-rl-environment-vertex-color).
