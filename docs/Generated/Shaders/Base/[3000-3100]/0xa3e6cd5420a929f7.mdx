---
id: 0xa3e6cd5420a929f7
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP`, `0xa3e6cd5420a929f7`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-threshold-sweep).
