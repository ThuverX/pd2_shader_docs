---
id: 0xa35e6bfa28297d5a
title: "Generic Default Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend"
---

# Generic Default Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:WORLD_UP_BLEND`, `0xa35e6bfa28297d5a`)
