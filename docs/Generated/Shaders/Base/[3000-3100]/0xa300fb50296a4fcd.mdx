---
id: 0xa300fb50296a4fcd
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Rl Core Environment"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Rl Core Environment
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_CORE_ENVIRONMENT`, `0xa300fb50296a4fcd`)
