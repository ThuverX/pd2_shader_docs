---
id: 0xa447b976bc3425ea
title: "Generic Default Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint"
---

# Generic Default Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint
(`generic:default:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT`, `0xa447b976bc3425ea`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gloss-blurs-cubemap-gsma-texture-normalmap-simple-tint).
