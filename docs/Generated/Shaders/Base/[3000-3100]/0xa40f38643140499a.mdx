---
id: 0xa40f38643140499a
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Self Illumination"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Self Illumination
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:SELF_ILLUMINATION`, `0xa40f38643140499a`)
