---
id: 0xa07cfa676d17fb4c
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Nvidia Opacity Fade Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:OPACITY_FADE:VERTEX_COLOR`, `0xa07cfa676d17fb4c`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_FADE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-opacity-fade-vertex-color).
