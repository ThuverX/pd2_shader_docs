---
id: 0x80080e191bc151b0
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gsma Texture Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Double Sided External Alpha Ref Gsma Texture Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:OPACITY_TEXTURE`, `0x80080e191bc151b0`)
