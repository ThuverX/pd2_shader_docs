---
id: 0x8261b1989630f0d1
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Nvidia Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Nvidia Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NVIDIA:VERTEX_COLOR`, `0x8261b1989630f0d1`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-vertex-color).
