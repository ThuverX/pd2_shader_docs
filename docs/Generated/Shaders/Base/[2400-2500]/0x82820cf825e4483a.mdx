---
id: 0x82820cf825e4483a
title: "Generic Default Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Vertex Color Vertex Color Alpha"
---

# Generic Default Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Vertex Color Vertex Color Alpha
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x82820cf825e4483a`)
