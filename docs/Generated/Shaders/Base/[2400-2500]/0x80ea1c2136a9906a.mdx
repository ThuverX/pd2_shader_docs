---
id: 0x80ea1c2136a9906a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Opacity By Depth Take Fog"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Distortion Normalmap Opacity By Depth Take Fog
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DISTORTION:NORMALMAP:OPACITY_BY_DEPTH:TAKE_FOG`, `0x80ea1c2136a9906a`)
