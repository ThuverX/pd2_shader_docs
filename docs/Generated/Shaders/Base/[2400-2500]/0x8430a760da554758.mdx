---
id: 0x8430a760da554758
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION`, `0x8430a760da554758`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-normalmap-self-illumination).
