---
id: 0x819a243c982789f0
title: "Generic Default Diffuse Texture Diffuse Uvanim Instanced Self Illumination Self Illumination Uvanim"
---

# Generic Default Diffuse Texture Diffuse Uvanim Instanced Self Illumination Self Illumination Uvanim
(`generic:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:INSTANCED:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0x819a243c982789f0`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:INSTANCED:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvanim-instanced-self-illumination-self-illumination-uvanim).
...
float ref_time : register(vs_3_0, c205);
float3 ref_uv_speed : register(vs_3_0, c206);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mul r0.x, r0.x, c207.z
    temp0.x = temp0.x * float1(4);
    // mova a0.x, r0.x
    addr0.x = temp0.x;
    // mad r0, v0.xyzx, -c207.yyyw, -c207.wwwy
    ...
    // mov r0.x, c205.x
    temp0.x = ref_time.x;
    // mad o2.xy, r0.x, c206, v2
    o.texcoord = temp0.x * ref_uv_speed + i.texcoord;
    // mad r0.xyz, v1, c207.x, c207.y
...
#### Vertex Shader
```hlsl
float ref_time : register(vs_3_0, c204);
