---
id: 0x93fd6d46ecedcfaf
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Normalmap Nvidia Simple Tint Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA:SIMPLE_TINT:VERTEX_COLOR`, `0x93fd6d46ecedcfaf`)
