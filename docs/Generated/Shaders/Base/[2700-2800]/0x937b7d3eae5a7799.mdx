---
id: 0x937b7d3eae5a7799
title: "Generic Shadow Caster Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:OPACITY_TEXTURE`, `0x937b7d3eae5a7799`)

This template is referenced 1 time by [generic:ALPHA_MASKED:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-axis-aligned-billboard-billboard-center-offset-billboard-up-axis-diffuse-texture-double-sided-opacity-texture).
