---
id: 0x90c059b023758dba
title: "Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 1 External Alpha Ref"
---

# Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 1 External Alpha Ref
(`generic:default:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:EXTERNAL_ALPHA_REF`, `0x90c059b023758dba`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:EXTERNAL_ALPHA_REF](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-distance-fade-1-external-alpha-ref).
