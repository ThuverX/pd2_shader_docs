---
id: 0x93b22081f6964c9f
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Instanced Normalmap Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Instanced Normalmap Self Illumination Self Illumination Bloom
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x93b22081f6964c9f`)
