---
id: 0x932796099fc7f507
title: "Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Rl Core Environment"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap Rl Core Environment
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_CORE_ENVIRONMENT`, `0x932796099fc7f507`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-diffuse-texture-instanced-normalmap-rl-core-environment).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r2.x, r1.w, -v5.w
    temp2.x = /* not implemented _pp modifier */ temp1.w + -i.color.w;
