---
id: 0x923c5f4917aee452
title: "Generic Shadow Caster Diffuse Texture Double Sided Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Diffuse Texture Double Sided Instanced Normalmap Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:NVIDIA`, `0x923c5f4917aee452`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-instanced-normalmap).
