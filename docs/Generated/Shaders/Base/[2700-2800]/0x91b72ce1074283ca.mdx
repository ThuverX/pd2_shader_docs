---
id: 0x91b72ce1074283ca
title: "Generic Default Blend Diffuse Blend Mask Gg Blend Smooth Diffuse Texture Instanced"
---

# Generic Default Blend Diffuse Blend Mask Gg Blend Smooth Diffuse Texture Instanced
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_GG:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED`, `0x91b72ce1074283ca`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_GG:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-gg-blend-smooth-diffuse-texture-instanced).
