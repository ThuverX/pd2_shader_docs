---
id: 0x8f57399d322bd6c8
title: "Effect Default Blend Add Diffuse0 Texture Double Sided View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Double Sided View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP`, `0x8f57399d322bd6c8`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-double-sided-view-angle-falloff-op).
