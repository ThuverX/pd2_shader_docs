---
id: 0x901c8657216672e8
title: "Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:VERTEX_COLOR`, `0x901c8657216672e8`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination-vertex-color).
