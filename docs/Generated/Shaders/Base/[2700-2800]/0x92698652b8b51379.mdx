---
id: 0x92698652b8b51379
title: "Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref"
---

# Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 2 External Alpha Ref
(`generic:default:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:EXTERNAL_ALPHA_REF`, `0x92698652b8b51379`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:EXTERNAL_ALPHA_REF](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-distance-fade-2-external-alpha-ref).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    temp0.x = temp0.z * temp0.x + float1(-1625);
    // mov o1.x, r0.z
