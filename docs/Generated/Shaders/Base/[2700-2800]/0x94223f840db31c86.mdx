---
id: 0x94223f840db31c86
title: "Generic Shadow Caster Blue Mask Tint Diffuse Texture Normalmap Nvidia Skinned 1weight"
---

# Generic Shadow Caster Blue Mask Tint Diffuse Texture Normalmap Nvidia Skinned 1weight
(`generic:shadow_caster:BLUE_MASK_TINT:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_1WEIGHT`, `0x94223f840db31c86`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-normalmap-skinned-1weight).
