---
id: 0x93d01959a657979b
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Self Illumination Skinned 1weight"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Self Illumination Skinned 1weight
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SKINNED_1WEIGHT`, `0x93d01959a657979b`)
