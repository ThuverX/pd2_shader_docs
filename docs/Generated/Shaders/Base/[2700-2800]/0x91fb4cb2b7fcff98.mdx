---
id: 0x91fb4cb2b7fcff98
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Vertex Color"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture Double Sided External Alpha Ref Normalmap Opacity Texture Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR`, `0x91fb4cb2b7fcff98`)
