---
id: 0x930adf87be5dec6c
title: "Generic Default Alpha Masked Diffuse Texture Normalmap Opacity Texture Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture Normalmap Opacity Texture Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR`, `0x930adf87be5dec6c`)
