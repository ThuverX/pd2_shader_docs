---
id: 0xa5471ac823eb4483
title: "Opacity Default Cube Environment Mapping Diffuse Texture Nvidia"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA`, `0xa5471ac823eb4483`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture).
