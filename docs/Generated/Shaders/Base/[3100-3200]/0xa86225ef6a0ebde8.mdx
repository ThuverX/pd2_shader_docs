---
id: 0xa86225ef6a0ebde8
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Skinned 2weights"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Skinned 2weights
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_2WEIGHTS`, `0xa86225ef6a0ebde8`)
