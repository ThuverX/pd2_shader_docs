---
id: 0xa78401b33b076b3a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:NVIDIA:SKINNED_3WEIGHTS`, `0xa78401b33b076b3a`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-skinned-3weights).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v7.xxyz, c177.x, c177.y
    ...
    // mad r0.yzw, v8.xxyz, c177.x, c177.y
    ...
    // mad r0.yzw, v3.xxyz, c177.x, c177.y
    ...
    // mov r1.x, c175.x
    temp1.x = ref_time.x;
    // mad o4.xy, r1.x, c176, v6
    o.texcoord.xy = temp1.xx * ref_uv_speed.xy + i.texcoord.xy;
    // mad o4.zw, r1.x, c176.xyxy, v4.xyxy
