---
id: 0xa8c854ffc53a2ce0
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Opacity Texture Simple Tint"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Opacity Texture Simple Tint
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT`, `0xa8c854ffc53a2ce0`)
