---
id: 0xa634c1d7ea9c9538
title: "Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Uvanim Skinned 1weight"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Uvanim Skinned 1weight
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NVIDIA:OPACITY_UVANIM:SKINNED_1WEIGHT`, `0xa634c1d7ea9c9538`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_UVANIM:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-diffuse-uvanim-opacity-uvanim-skinned-1weight).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.yzw, v2.xxyz, c177.x, c177.y
    ...
    // dp3 o4.y, r2, c163
    o.texcoord2.y = dot(temp2.xyz, (world_matrix._m01_m11_m21_m31).xyz);
    // dp3 o4.z, r2, c164
    o.texcoord2.z = dot(temp2.xyz, (world_matrix._m02_m12_m22_m32).xyz);
    // mov r1.x, c175.x
    temp1.x = ref_time.x;
    // mad o3.xy, r1.x, c176, v4
    o.texcoord = temp1.x * ref_uv_speed + i.texcoord;
    // mad o1.xy, r1.x, c176, v3
