---
id: 0xa664d06a76e68081
title: "Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 1weight"
---

# Shadow Caster Only Shadow Caster Nvidia Shadow Caster Only Skinned 1weight
(`shadow_caster_only:shadow_caster:NVIDIA:SHADOW_CASTER_ONLY:SKINNED_1WEIGHT`, `0xa664d06a76e68081`)

This template is referenced 1 time by [shadow_caster_only:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-skinned-1weight).
