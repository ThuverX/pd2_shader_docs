---
id: 0xa9b78e9e9f764385
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Normal Cube Environment Mapping Diffuse Texture Instanced Normalmap World Up Blend"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Normal Cube Environment Mapping Diffuse Texture Instanced Normalmap World Up Blend
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:WORLD_UP_BLEND`, `0xa9b78e9e9f764385`)
