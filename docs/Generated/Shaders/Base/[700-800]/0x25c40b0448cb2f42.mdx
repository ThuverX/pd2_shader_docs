---
id: 0x25c40b0448cb2f42
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Core Environment Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Core Environment Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION`, `0x25c40b0448cb2f42`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-core-environment-self-illumination).
