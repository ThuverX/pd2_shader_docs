---
id: 0x287dab80f3fd21b2
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Skinned 3weights"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Skinned 3weights
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:SKINNED_3WEIGHTS`, `0x287dab80f3fd21b2`)
