---
id: 0x2534d24234ac1087
title: "Generic Shadow Caster Diffuse Texture Gloss Control Value Nvidia Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Gloss Control Value Nvidia Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NVIDIA:SELF_ILLUMINATION`, `0x2534d24234ac1087`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gloss-control-value-self-illumination).
