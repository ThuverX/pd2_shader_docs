---
id: 0x25ee0efd5f29a83f
title: "Generic Shadow Caster Ati Diffuse Texture Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Ati Diffuse Texture Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:ATI:DIFFUSE_TEXTURE:RL_COPS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x25ee0efd5f29a83f`)
