---
id: 0x23d6e382bd1ecd39
title: "Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Controller Opacity Uvanim Vertex Color"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Controller Opacity Uvanim Vertex Color
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:NVIDIA:OPACITY_CONTROLLER:OPACITY_UVANIM:VERTEX_COLOR`, `0x23d6e382bd1ecd39`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_CONTROLLER:OPACITY_UVANIM:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-opacity-controller-opacity-uvanim-vertex-color).
