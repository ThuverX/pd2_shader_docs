---
id: 0x23f571d2e41457a6
title: "Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim"
---

# Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM`, `0x23f571d2e41457a6`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim).
