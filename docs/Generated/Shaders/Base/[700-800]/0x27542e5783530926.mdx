---
id: 0x27542e5783530926
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE`, `0x27542e5783530926`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gloss-control-value).
