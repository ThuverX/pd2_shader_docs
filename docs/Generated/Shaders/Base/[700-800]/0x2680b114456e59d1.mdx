---
id: 0x2680b114456e59d1
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Environment"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl Environment
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_ENVIRONMENT`, `0x2680b114456e59d1`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-rl-environment).
