---
id: 0x2537811f4556ea9d
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Self Illumination Mask Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Self Illumination Mask Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_MASK:VERTEX_COLOR`, `0x2537811f4556ea9d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION:SELF_ILLUMINATION_MASK:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-self-illumination-self-illumination-mask-vertex-color).
This template uses the following inputs:
 |Name|UI Name|Type|
|---|---|---|
|diffuse_texture|Diffuse Texture (UV1)|texture|
|self_illumination_texture|Self Illumination Texture (UV4)|texture|
|filter_color_texture|Self Illumination Mask (UV4)|texture|
