---
id: 0x26d70562a8686539
title: "Generic Default Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Normalmap Simple Tint"
---

# Generic Default Blend Diffuse Blend Mask Control Blend Mask Seperate Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Normalmap Simple Tint
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT`, `0x26d70562a8686539`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-blend-mask-seperate-diffuse-texture-gloss-blurs-cubemap-gloss-control-value-normalmap-simple-tint).
...
float3 ref_tint_color : register(ps_3_0, c2);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r0.xyz, r3, c2
    temp0.xyz = temp3.xyz * ref_tint_color.xyz;
    // mov_pp oC1.w, r3.w
