...
# Generic Shadow Caster Axis Aligned Billboard Billboard Center Offset Billboard Up Axis Diffuse Texture Double Sided
(`generic:shadow_caster:AXIS_ALIGNED_BILLBOARD:BILLBOARD_CENTER_OFFSET:BILLBOARD_UP_AXIS:DIFFUSE_TEXTURE:DOUBLE_SIDED`, `0x25a4315f3636956d`)
