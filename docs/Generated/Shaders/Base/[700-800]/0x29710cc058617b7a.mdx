---
id: 0x29710cc058617b7a
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Rl Civilians Skinned 3weights Vertex Color Vertex Color Character
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_CHARACTER`, `0x29710cc058617b7a`)
