---
id: 0x2584c99646f87f53
title: "Generic Default Alpha Masked Depth Scaling Diffuse Texture Double Sided External Alpha Ref Normalmap"
---

# Generic Default Alpha Masked Depth Scaling Diffuse Texture Double Sided External Alpha Ref Normalmap
(`generic:default:ALPHA_MASKED:DEPTH_SCALING:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP`, `0x2584c99646f87f53`)
