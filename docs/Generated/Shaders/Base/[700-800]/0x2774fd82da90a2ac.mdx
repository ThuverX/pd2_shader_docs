---
id: 0x2774fd82da90a2ac
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING`, `0x2774fd82da90a2ac`)
