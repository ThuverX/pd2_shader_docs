---
id: 0x25c62bd05842a85f
title: "Landscape Default Blend Masks Mat0 Mat0 Blend World Mask Mat0 Nm Mat1 Mat1 Blend World Mask Mat1 Nm Mat2 Mat2 Blend World Mask Mat2 Nm Mat3 Mat3 Blend World Mask Mat3 Nm Overlay Over Detail World Mask A Wetness World Overlay Mask Texture World Overlay Texture"
---

# Landscape Default Blend Masks Mat0 Mat0 Blend World Mask Mat0 Nm Mat1 Mat1 Blend World Mask Mat1 Nm Mat2 Mat2 Blend World Mask Mat2 Nm Mat3 Mat3 Blend World Mask Mat3 Nm Overlay Over Detail World Mask A Wetness World Overlay Mask Texture World Overlay Texture
(`landscape:default:BLEND_MASKS:MAT0:MAT0_BLEND_WORLD_MASK:MAT0_NM:MAT1:MAT1_BLEND_WORLD_MASK:MAT1_NM:MAT2:MAT2_BLEND_WORLD_MASK:MAT2_NM:MAT3:MAT3_BLEND_WORLD_MASK:MAT3_NM:OVERLAY_OVER_DETAIL:WORLD_MASK_A_WETNESS:WORLD_OVERLAY_MASK_TEXTURE:WORLD_OVERLAY_TEXTURE`, `0x25c62bd05842a85f`)

This template is referenced 1 time by [landscape:BLEND_MASKS:MAT0:MAT0_BLEND_WORLD_MASK:MAT0_NM:MAT1:MAT1_BLEND_WORLD_MASK:MAT1_NM:MAT2:MAT2_BLEND_WORLD_MASK:MAT2_NM:MAT3:MAT3_BLEND_WORLD_MASK:MAT3_NM:OVERLAY_OVER_DETAIL:WORLD_MASK_A_WETNESS:WORLD_OVERLAY_MASK_TEXTURE:WORLD_OVERLAY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#landscape-blend-masks-mat0-mat0-blend-world-mask-mat0-nm-mat1-mat1-blend-world-mask-mat1-nm-mat2-mat2-blend-world-mask-mat2-nm-mat3-mat3-blend-world-mask-mat3-nm-overlay-over-detail-world-mask-a-wetness-world-overlay-mask-texture-world-overlay-texture).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    if (i.texcoord1.w < ref_detail_fadeout.y) {
        ...
        // texld_pp r5, v1, s4
        temp5 = /* not implemented _pp modifier */ tex2D(diffuse_layer1_texture, i.texcoord.xy);
        // texld_pp r6, v1, s6
        temp6 = /* not implemented _pp modifier */ tex2D(diffuse_layer2_texture, i.texcoord.xy);
        // texld_pp r7, v1, s8
        temp7 = /* not implemented _pp modifier */ tex2D(diffuse_layer3_texture, i.texcoord.xy);
        // texld_pp r8, v1, s3
        temp8 = /* not implemented _pp modifier */ tex2D(normal_layer0_texture, i.texcoord.xy);
        // texld_pp r9, v1, s5
        temp9 = /* not implemented _pp modifier */ tex2D(normal_layer1_texture, i.texcoord.xy);
        // texld_pp r10, v1, s7
        temp10 = /* not implemented _pp modifier */ tex2D(normal_layer2_texture, i.texcoord.xy);
        // texld_pp r11, v1, s9
        temp11 = /* not implemented _pp modifier */ tex2D(normal_layer3_texture, i.texcoord.xy);
