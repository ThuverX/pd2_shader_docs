---
id: 0x2a3d2c3e6933acef
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_3WEIGHTS`, `0x2a3d2c3e6933acef`)
