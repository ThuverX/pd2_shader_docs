---
id: 0x253593b478251a9e
title: "Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap"
---

# Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap
(`generic:default:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP`, `0x253593b478251a9e`)
