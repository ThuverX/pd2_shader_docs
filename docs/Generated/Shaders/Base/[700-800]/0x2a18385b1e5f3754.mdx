---
id: 0x2a18385b1e5f3754
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Double Sided Nvidia Skinned 3weights"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Double Sided Nvidia Skinned 3weights
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:SKINNED_3WEIGHTS`, `0x2a18385b1e5f3754`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:DOUBLE_SIDED:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-double-sided-skinned-3weights).
