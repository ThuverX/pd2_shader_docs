---
id: 0x3b437292c6bc5a90
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Instanced Normalmap Vertex Color"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Instanced Normalmap Vertex Color
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:INSTANCED:NORMALMAP:VERTEX_COLOR`, `0x3b437292c6bc5a90`)
