---
id: 0x3b7585695a125e6b
title: "Generic Shadow Caster Nvidia Rl 3rd Weapons Vertex Color"
---

# Generic Shadow Caster Nvidia Rl 3rd Weapons Vertex Color
(`generic:shadow_caster:NVIDIA:RL_3RD_WEAPONS:VERTEX_COLOR`, `0x3b7585695a125e6b`)

This template is referenced 1 time by [generic:RL_3RD_WEAPONS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-rl-3rd-weapons-vertex-color).
