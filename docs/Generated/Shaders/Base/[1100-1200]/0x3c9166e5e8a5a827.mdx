---
id: 0x3c9166e5e8a5a827
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Gsma Texture Normalmap Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Gsma Texture Normalmap Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x3c9166e5e8a5a827`)
