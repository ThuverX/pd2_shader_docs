---
id: 0x3c4c14325f45045c
title: "Generic Default Blend Diffuse Blend Fade Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Fade Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_FADE:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x3c4c14325f45045c`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_FADE:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-fade-diffuse-texture-gsma-texture-normalmap-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mov_pp r2.x, c1.x
    temp2.x = /* not implemented _pp modifier */ float1(1);
