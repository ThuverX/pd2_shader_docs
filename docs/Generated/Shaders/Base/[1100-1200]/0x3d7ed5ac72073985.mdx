---
id: 0x3d7ed5ac72073985
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Controller"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Opacity Controller
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_CONTROLLER`, `0x3d7ed5ac72073985`)
