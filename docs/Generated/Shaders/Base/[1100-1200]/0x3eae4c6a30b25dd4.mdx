---
id: 0x3eae4c6a30b25dd4
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gloss Control Value"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gloss Control Value
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE`, `0x3eae4c6a30b25dd4`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-gloss-control-value).
