---
id: 0x3e26078f7a3bbe83
title: "Generic Shadow Caster Ati Blend Diffuse Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR`, `0x3e26078f7a3bbe83`)
