---
id: 0x3d738bbfa1e22a62
title: "Opacity Default Diffuse Texture Nvidia Self Illumination Self Illumination Tint"
---

# Opacity Default Diffuse Texture Nvidia Self Illumination Self Illumination Tint
(`opacity:default:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT`, `0x3d738bbfa1e22a62`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-self-illumination-self-illumination-tint).
