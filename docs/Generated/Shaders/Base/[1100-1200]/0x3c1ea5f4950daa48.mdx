---
id: 0x3c1ea5f4950daa48
title: "Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap"
---

# Generic Default Alpha Masked Diffuse Texture Gloss Control Value Normalmap
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP`, `0x3c1ea5f4950daa48`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-gloss-control-value-normalmap).
