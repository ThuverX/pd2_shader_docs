---
id: 0x3b36e48f6a819bd1
title: "Effect Default Blend Add Diffuse0 Texture Vertex Color View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Vertex Color View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:VERTEX_COLOR:VIEW_ANGLE_FALLOFF_OP`, `0x3b36e48f6a819bd1`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:VERTEX_COLOR:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-vertex-color-view-angle-falloff-op).
