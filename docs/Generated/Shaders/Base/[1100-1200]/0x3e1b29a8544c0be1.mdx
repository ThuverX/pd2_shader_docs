---
id: 0x3e1b29a8544c0be1
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Self Illumination"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Self Illumination
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION`, `0x3e1b29a8544c0be1`)
