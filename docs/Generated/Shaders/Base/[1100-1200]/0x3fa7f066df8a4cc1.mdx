---
id: 0x3fa7f066df8a4cc1
title: "Generic Default Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights"
---

# Generic Default Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Civilians Skinned 3weights
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x3fa7f066df8a4cc1`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-global-environment-mapping-gloss-blurs-cubemap-gsma-texture-normalmap-rl-civilians-skinned-3weights).
