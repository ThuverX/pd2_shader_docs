---
id: 0x3fe33b7de87e23c9
title: "Generic Shadow Caster Ati Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Ati Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x3fe33b7de87e23c9`)
