---
id: 0x3b490d44b5469cad
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Normalmap Nvidia Rl Civilians Skinned 3weights"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Normalmap Nvidia Rl Civilians Skinned 3weights
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:NVIDIA:RL_CIVILIANS:SKINNED_3WEIGHTS`, `0x3b490d44b5469cad`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-global-environment-mapping-normalmap-rl-civilians-skinned-3weights).
