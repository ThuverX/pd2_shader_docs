---
id: 0x3f0d4c4a387da0e8
title: "Effect Default Blend Add Diffuse0 Texture Instanced View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Instanced View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:INSTANCED:VIEW_ANGLE_FALLOFF_OP`, `0x3f0d4c4a387da0e8`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:INSTANCED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-instanced-view-angle-falloff-op).
