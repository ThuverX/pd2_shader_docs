---
id: 0x3ca0f286470fe487
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SIMPLE_TINT`, `0x3ca0f286470fe487`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-normalmap-simple-tint).
