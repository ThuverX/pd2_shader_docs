---
id: 0x3f4025c194da519b
title: "Generic Shadow Caster Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Contour Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Rl Cops Skinned 3weights
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:NVIDIA:RL_COPS:SKINNED_3WEIGHTS`, `0x3f4025c194da519b`)
