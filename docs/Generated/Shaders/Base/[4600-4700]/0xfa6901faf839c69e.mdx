---
id: 0xfa6901faf839c69e
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller Self Illumination Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller Self Illumination Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:SELF_ILLUMINATION:VERTEX_COLOR`, `0xfa6901faf839c69e`)
