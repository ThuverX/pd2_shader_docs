---
id: 0xfa2a0de579c77a47
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Fade Take Fog"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Opacity Fade Take Fog
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:OPACITY_FADE:TAKE_FOG`, `0xfa2a0de579c77a47`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE:TAKE_FOG](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-opacity-fade-take-fog).
