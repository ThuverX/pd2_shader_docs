---
id: 0xfb1ceab25908594b
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Bigprops Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Bigprops Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_BIGPROPS:SELF_ILLUMINATION:VERTEX_COLOR`, `0xfb1ceab25908594b`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:RL_BIGPROPS:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-rl-bigprops-self-illumination-vertex-color).
