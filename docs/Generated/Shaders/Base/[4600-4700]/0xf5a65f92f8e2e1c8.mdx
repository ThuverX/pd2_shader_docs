---
id: 0xf5a65f92f8e2e1c8
title: "Generic Shadow Caster Diffuse Texture Instanced Self Illumination Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Self Illumination Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION:VERTEX_COLOR`, `0xf5a65f92f8e2e1c8`)
