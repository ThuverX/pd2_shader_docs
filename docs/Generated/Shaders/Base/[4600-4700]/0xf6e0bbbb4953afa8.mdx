---
id: 0xf6e0bbbb4953afa8
title: "Shadow Caster Only Shadow Caster Alpha Masked Instanced Nvidia Shadow Caster Only"
---

# Shadow Caster Only Shadow Caster Alpha Masked Instanced Nvidia Shadow Caster Only
(`shadow_caster_only:shadow_caster:ALPHA_MASKED:INSTANCED:NVIDIA:SHADOW_CASTER_ONLY`, `0xf6e0bbbb4953afa8`)

This template is referenced 1 time by [shadow_caster_only:ALPHA_MASKED:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-alpha-masked-instanced).
