---
id: 0xf73ab16b819d3234
title: "Generic Customizable Default Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Wear Tear Masking"
---

# Generic Customizable Default Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Wear Tear Masking
(`generic_customizable:default:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:WEAR_TEAR_MASKING`, `0xf73ab16b819d3234`)

This template is referenced 1 time by [generic_customizable:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:WEAR_TEAR_MASKING](/docs/Generated/Render%20Templates/base.render_template_database#generic-customizable-cube-environment-mapping-decal-sticker-uv2-diffuse-texture-gradientmap-normalmap-pattern-gradientmap-pattern-gradientmap-angle-offset-pattern-uv2-wear-tear-masking).
