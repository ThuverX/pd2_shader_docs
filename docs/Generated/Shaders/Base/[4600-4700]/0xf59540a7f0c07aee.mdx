---
id: 0xf59540a7f0c07aee
title: "Opacity Default Ati Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Controller Opacity Uvanim Self Illumination Self Illumination Uvanim"
---

# Opacity Default Ati Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Opacity Controller Opacity Uvanim Self Illumination Self Illumination Uvanim
(`opacity:default:ATI:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_CONTROLLER:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0xf59540a7f0c07aee`)
