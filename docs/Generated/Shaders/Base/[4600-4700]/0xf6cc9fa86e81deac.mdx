---
id: 0xf6cc9fa86e81deac
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Normal Diffuse Texture Gsma Texture Normalmap Rl Environment Vertex Color"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Normal Diffuse Texture Gsma Texture Normalmap Rl Environment Vertex Color
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_NORMAL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR`, `0xf6cc9fa86e81deac`)
