---
id: 0xf8b82e57b7f52394
title: "Shadow Caster Only Shadow Caster Double Sided Nvidia Shadow Caster Only Vegetation Bending"
---

# Shadow Caster Only Shadow Caster Double Sided Nvidia Shadow Caster Only Vegetation Bending
(`shadow_caster_only:shadow_caster:DOUBLE_SIDED:NVIDIA:SHADOW_CASTER_ONLY:VEGETATION_BENDING`, `0xf8b82e57b7f52394`)

This template is referenced 1 time by [shadow_caster_only:DOUBLE_SIDED:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-double-sided-vegetation-bending).
