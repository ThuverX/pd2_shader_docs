---
id: 0xf8ead1807040dcd2
title: "Generic Default Contour Detail Normal Texture Blue Detail Normal Texture Green Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Normalmap Skinned 3weights"
---

# Generic Default Contour Detail Normal Texture Blue Detail Normal Texture Green Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Normalmap Skinned 3weights
(`generic:default:CONTOUR:DETAIL_NORMAL_TEXTURE_BLUE:DETAIL_NORMAL_TEXTURE_GREEN:DETAIL_NORMAL_TEXTURE_RED:DETAIL_RGB_MASK:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0xf8ead1807040dcd2`)

This template is referenced 1 time by [generic:CONTOUR:DETAIL_NORMAL_TEXTURE_BLUE:DETAIL_NORMAL_TEXTURE_GREEN:DETAIL_NORMAL_TEXTURE_RED:DETAIL_RGB_MASK:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-detail-normal-texture-blue-detail-normal-texture-green-detail-normal-texture-red-detail-rgb-mask-diffuse-texture-normalmap-skinned-3weights).
...
sampler2D normal_layer1_texture : register(ps_3_0, s4);
sampler2D normal_layer2_texture : register(ps_3_0, s5);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // dcl_2d s4
    // dcl_2d s5
    // mul r0.xy, c2, v1.zwzw
    temp0.xy = ref_green_detail_scale.xy * i.texcoord.zw;
    // texld_pp r0, r0, s4
    temp0 = /* not implemented _pp modifier */ tex2D(normal_layer1_texture, temp0.xy);
    ...
    // mul r1.xy, c0, v1.zwzw
    temp1.xy = ref_red_detail_scale.xy * i.texcoord.zw;
    // texld_pp r1, r1, s3
    ...
    // texld r2, v1.zwzw, s2
    temp2 = tex2D(diffuse_layer0_texture, i.texcoord.zw);
    // mul r0.w, r2.x, c1.x
    temp0.w = temp2.x * ref_red_detail_intensity.x;
    // mad r0.xyz, r0.w, -r1, r0
    temp0.xyz = temp0.www * -temp1.xyz + temp0.xyz;
    // mul r1.xyz, r1, r0.w
    temp1.xyz = temp1.xyz * temp0.www;
    // mul r0.w, r2.y, c3.x
    temp0.w = temp2.y * ref_green_detail_intensity.x;
    // mul r1.w, r2.z, c5.x
    temp1.w = temp2.z * ref_blue_detail_intensity.x;
    // mad r0.xyz, r0.w, r0, r1
    temp0.xyz = temp0.www * temp0.xyz + temp1.xyz;
    // mul r1.xy, c4, v1.zwzw
    temp1.xy = ref_blue_detail_scale.xy * i.texcoord.zw;
    // texld_pp r2, r1, s5
    temp2 = /* not implemented _pp modifier */ tex2D(normal_layer2_texture, temp1.xy);
    // add_pp r1.xy, r2.wyzw, c6.x
    temp1.xy = /* not implemented _pp modifier */ temp2.wy + float2(-0.5, -0.5);
    // add_pp r1.xy, r1, r1
    temp1.xy = /* not implemented _pp modifier */ temp1.xy + temp1.xy;
    // mul_pp r0.w, r1.x, r1.x
    temp0.w = /* not implemented _pp modifier */ temp1.x * temp1.x;
    ...
    temp2.xyz = lerp(temp0.xyz, temp1.xyz, temp1.www);
    // add r0.xyz, -r2, c6.y
...
float4 VertexMain(VertexMain_Input i) : POSITION
{
    float4 out_position;
    float4 temp0, temp1;
    float2 addr0;
    ...
    // dp4 o0.x, r0, c170
    out_position.x = dot(temp0, (proj_matrix._m00_m10_m20_m30));
    // dp4 o0.y, r0, c171
    out_position.y = dot(temp0, (proj_matrix._m01_m11_m21_m31));
    // dp4 o0.z, r0, c172
    out_position.z = dot(temp0, (proj_matrix._m02_m12_m22_m32));
    // dp4 o0.w, r0, c173
    out_position.w = dot(temp0, (proj_matrix._m03_m13_m23_m33));
    // 
