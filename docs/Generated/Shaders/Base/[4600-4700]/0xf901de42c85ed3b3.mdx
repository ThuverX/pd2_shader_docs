---
id: 0xf901de42c85ed3b3
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Control Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Control Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xf901de42c85ed3b3`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-control-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r0.y, r1.w, -v6.w
    temp0.y = /* not implemented _pp modifier */ temp1.w + -i.color.w;
    ...
    // add r0.y, r2.x, -r3.x
    temp0.y = temp2.x + -temp3.x;
    // lrp_pp r1.w, r0.x, r2.y, r3.y
    temp1.w = /* not implemented _pp modifier */ lerp(temp3.y, temp2.y, temp0.x);
    // mad oC0.w, r0.x, r0.y, r3.x
    o.color.w = temp0.x * temp0.y + temp3.x;
    // texld_pp r2, v1, s0
