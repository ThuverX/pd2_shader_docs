---
id: 0xf5b5444fb07f403e
title: "Generic Default Blend Diffuse Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Vertex Color"
---

# Generic Default Blend Diffuse Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops Vertex Color
(`generic:default:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR`, `0xf5b5444fb07f403e`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-cube-environment-mapping-diffuse-texture-normalmap-rl-bigprops-vertex-color).
