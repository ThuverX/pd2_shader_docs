---
id: 0xf936b2e6a7daa390
title: "Generic Default Depth Scaling Diffuse Texture Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Depth Scaling Diffuse Texture Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:DEPTH_SCALING:DIFFUSE_TEXTURE:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xf936b2e6a7daa390`)
