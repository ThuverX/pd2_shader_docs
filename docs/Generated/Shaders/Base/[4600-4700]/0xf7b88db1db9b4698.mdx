---
id: 0xf7b88db1db9b4698
title: "Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Smooth Diffuse Texture Instanced Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP`, `0xf7b88db1db9b4698`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-diffuse-texture-instanced-normalmap).
