---
id: 0xf884b409cb63eb2a
title: "Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Fade Blend Mask Control Blend Mask D A Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Fade Blend Mask Control Blend Mask D A Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_FADE:BLEND_MASK_CONTROL:BLEND_MASK_D_A:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xf884b409cb63eb2a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_FADE:BLEND_MASK_CONTROL:BLEND_MASK_D_A:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-diffuse-uv2-blend-fade-blend-mask-control-blend-mask-d-a-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gsma-texture-normalmap-vertex-color).
...
|blend_fade_value|Blend fade value|scalar|.
...
float ref_blend_fade_value : register(ps_3_0, c3);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // texld_pp r3, v1.zwzw, s1
    temp3 = /* not implemented _pp modifier */ tex2D(diffuse_layer0_texture, i.texcoord.zw);
    // mov_pp r4.x, c4.x
    temp4.x = /* not implemented _pp modifier */ float1(1);
    // add_sat_pp r0.w, r4.x, -c3.x
    ;// error
