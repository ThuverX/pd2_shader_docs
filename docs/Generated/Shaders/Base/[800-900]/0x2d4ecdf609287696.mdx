---
id: 0x2d4ecdf609287696
title: "Generic Shadow Caster Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Rl Cops Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:NVIDIA:RL_COPS:SKINNED_3WEIGHTS`, `0x2d4ecdf609287696`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-global-environment-mapping-gloss-blurs-cubemap-gsma-texture-normalmap-rl-cops-skinned-3weights).
