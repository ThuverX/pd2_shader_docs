---
id: 0x2e0071c8f0d8fa56
title: "Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Players Simple Tint Skinned 3weights"
---

# Generic Default Alpha Masked Contour Diffuse Texture External Alpha Ref Normalmap Opacity Texture Rl Players Simple Tint Skinned 3weights
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_PLAYERS:SIMPLE_TINT:SKINNED_3WEIGHTS`, `0x2e0071c8f0d8fa56`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:RL_PLAYERS:SIMPLE_TINT:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-external-alpha-ref-normalmap-opacity-texture-rl-players-simple-tint-skinned-3weights).
