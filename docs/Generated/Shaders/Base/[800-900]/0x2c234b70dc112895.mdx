---
id: 0x2c234b70dc112895
title: "Generic Default Diffuse Texture Gsma Texture Normalmap Self Illumination Simple Tint"
---

# Generic Default Diffuse Texture Gsma Texture Normalmap Self Illumination Simple Tint
(`generic:default:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SIMPLE_TINT`, `0x2c234b70dc112895`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-normalmap-self-illumination-simple-tint).
