---
id: 0x2a8b574a92ea8c0c
title: "Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Vegetation Bending"
---

# Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Vegetation Bending
(`generic:default:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING`, `0x2a8b574a92ea8c0c`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-distance-fade-3-double-sided-external-alpha-ref-instanced-vegetation-bending).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mad_pp oC1, r1.w, c3.xxxy, c3.zzyx
    o.color1 = /* not implemented _pp modifier */ temp1.w * float4(0, 0, 0, 1) + float4(0.5, 0.5, 1, 0);
    // mov oC0.w, c4.z
