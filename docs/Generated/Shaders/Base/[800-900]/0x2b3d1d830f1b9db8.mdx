---
id: 0x2b3d1d830f1b9db8
title: "Generic Shadow Caster Ati Depth Scaling Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Skinned 3weights"
---

# Generic Shadow Caster Ati Depth Scaling Diffuse Texture Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Skinned 3weights
(`generic:shadow_caster:ATI:DEPTH_SCALING:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x2b3d1d830f1b9db8`)
