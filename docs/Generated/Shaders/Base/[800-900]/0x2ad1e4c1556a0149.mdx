---
id: 0x2ad1e4c1556a0149
title: "Effect Default Blend Add Diffuse0 Texture Double Sided Intersection Fadeout View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Double Sided Intersection Fadeout View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP`, `0x2ad1e4c1556a0149`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:INTERSECTION_FADEOUT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-double-sided-intersection-fadeout-view-angle-falloff-op).
