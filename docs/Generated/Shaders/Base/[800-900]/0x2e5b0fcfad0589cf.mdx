---
id: 0x2e5b0fcfad0589cf
title: "Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Normalmap Uv1"
---

# Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Normalmap Uv1
(`generic:default:DEPTH_SCALING:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:NORMALMAP_UV1`, `0x2e5b0fcfad0589cf`)
