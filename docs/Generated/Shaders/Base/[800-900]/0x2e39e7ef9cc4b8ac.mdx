---
id: 0x2e39e7ef9cc4b8ac
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value Rl Backdrop"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Gloss Control Value Rl Backdrop
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE:RL_BACKDROP`, `0x2e39e7ef9cc4b8ac`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_CONTROL_VALUE:RL_BACKDROP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-gloss-control-value-rl-backdrop).
