---
id: 0x2c3e10a9ab2e3dad
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Double Sided View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Double Sided View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP`, `0x2c3e10a9ab2e3dad`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:DOUBLE_SIDED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-uvanim-double-sided-view-angle-falloff-op).
