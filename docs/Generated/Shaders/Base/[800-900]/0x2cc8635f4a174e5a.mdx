---
id: 0x2cc8635f4a174e5a
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Self Illumination"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Self Illumination
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SELF_ILLUMINATION`, `0x2cc8635f4a174e5a`)
