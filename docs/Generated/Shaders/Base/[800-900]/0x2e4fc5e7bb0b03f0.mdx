---
id: 0x2e4fc5e7bb0b03f0
title: "Generic Shadow Caster Diffuse Texture Gsma Texture Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Diffuse Texture Gsma Texture Instanced Normalmap Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA`, `0x2e4fc5e7bb0b03f0`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-gsma-texture-instanced-normalmap).
