---
id: 0x61767876829d1778
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Gsma Texture Opacity Texture Simple Tint"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Gsma Texture Opacity Texture Simple Tint
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:OPACITY_TEXTURE:SIMPLE_TINT`, `0x61767876829d1778`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:OPACITY_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-gsma-texture-opacity-texture-simple-tint).
