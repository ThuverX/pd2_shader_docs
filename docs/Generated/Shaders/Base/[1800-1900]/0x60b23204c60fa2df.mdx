---
id: 0x60b23204c60fa2df
title: "Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Skinned 1weight"
---

# Generic Default Alpha Masked Diffuse Texture Double Sided External Alpha Ref Gsma Alpha Masking Gsma Texture Normalmap Skinned 1weight
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_ALPHA_MASKING:GSMA_TEXTURE:NORMALMAP:SKINNED_1WEIGHT`, `0x60b23204c60fa2df`)
