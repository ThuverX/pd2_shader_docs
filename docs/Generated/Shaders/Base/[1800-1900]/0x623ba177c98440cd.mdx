---
id: 0x623ba177c98440cd
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Nvidia Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NVIDIA:VERTEX_COLOR`, `0x623ba177c98440cd`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-vertex-color).
