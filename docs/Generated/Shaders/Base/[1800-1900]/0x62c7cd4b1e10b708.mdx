---
id: 0x62c7cd4b1e10b708
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Rl Bigprops Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Normalmap Rl Bigprops Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT`, `0x62c7cd4b1e10b708`)
