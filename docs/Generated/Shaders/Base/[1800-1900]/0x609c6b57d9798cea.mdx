---
id: 0x609c6b57d9798cea
title: "Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Opacity Controller Opacity Fade Vertex Color"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Nvidia Opacity Controller Opacity Fade Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:OPACITY_CONTROLLER:OPACITY_FADE:VERTEX_COLOR`, `0x609c6b57d9798cea`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:OPACITY_FADE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-opacity-controller-opacity-fade-vertex-color).
