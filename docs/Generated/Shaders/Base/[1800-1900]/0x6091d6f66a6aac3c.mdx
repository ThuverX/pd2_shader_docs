---
id: 0x6091d6f66a6aac3c
title: "Generic Default Cube Environment Mapping Diffuse Texture Double Sided Normalmap Vegetation Bending"
---

# Generic Default Cube Environment Mapping Diffuse Texture Double Sided Normalmap Vegetation Bending
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:VEGETATION_BENDING`, `0x6091d6f66a6aac3c`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-double-sided-normalmap-vegetation-bending).
