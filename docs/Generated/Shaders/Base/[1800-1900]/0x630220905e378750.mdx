---
id: 0x630220905e378750
title: "Effect Default Blend Add Diffuse0 Texture Fps Skinned 3weights View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Fps Skinned 3weights View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:FPS:SKINNED_3WEIGHTS:VIEW_ANGLE_FALLOFF_OP`, `0x630220905e378750`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:FPS:SKINNED_3WEIGHTS:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-fps-skinned-3weights-view-angle-falloff-op).
