---
id: 0x5fba8beee4a2ab2d
title: "Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Uvanim Self Illumination Self Illumination Tint Self Illumination Uvanim Take Fog"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Nvidia Opacity Uvanim Self Illumination Self Illumination Tint Self Illumination Uvanim Take Fog
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NVIDIA:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SELF_ILLUMINATION_UVANIM:TAKE_FOG`, `0x5fba8beee4a2ab2d`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SELF_ILLUMINATION_UVANIM:TAKE_FOG](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-diffuse-uvanim-opacity-uvanim-self-illumination-self-illumination-tint-self-illumination-uvanim-take-fog).
