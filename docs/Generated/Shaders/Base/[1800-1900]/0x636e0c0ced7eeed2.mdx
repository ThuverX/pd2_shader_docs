---
id: 0x636e0c0ced7eeed2
title: "Generic Default Blue Mask Tint Diffuse Texture Instanced Vertex Color"
---

# Generic Default Blue Mask Tint Diffuse Texture Instanced Vertex Color
(`generic:default:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR`, `0x636e0c0ced7eeed2`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-instanced-vertex-color).
