---
id: 0x62101a8a21dd768e
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR`, `0x62101a8a21dd768e`)
