---
id: 0x60802005260117f1
title: "Generic Shadow Caster Nvidia Skinned 3weights Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Nvidia Skinned 3weights Vertex Color Vertex Color Alpha
(`generic:shadow_caster:NVIDIA:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x60802005260117f1`)

This template is referenced 1 time by [generic:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA](/docs/Generated/Render%20Templates/base.render_template_database#generic-skinned-3weights-vertex-color-vertex-color-alpha).
