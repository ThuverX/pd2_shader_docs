---
id: 0x5f5c8ea99d46084b
title: "Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Opacity Texture Simple Tint"
---

# Generic Default Alpha Masked Cube Environment Mapping Diffuse Texture Opacity Texture Simple Tint
(`generic:default:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_TEXTURE:SIMPLE_TINT`, `0x5f5c8ea99d46084b`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_TEXTURE:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-cube-environment-mapping-diffuse-texture-opacity-texture-simple-tint).
