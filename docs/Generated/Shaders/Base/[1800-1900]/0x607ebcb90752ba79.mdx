---
id: 0x607ebcb90752ba79
title: "Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 1 Double Sided External Alpha Ref Instanced Vegetation Bending"
---

# Generic Default Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 1 Double Sided External Alpha Ref Instanced Vegetation Bending
(`generic:default:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING`, `0x607ebcb90752ba79`)

This template is referenced 1 time by [generic:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_1:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-align-normal-world-z-alpha-masked-diffuse-texture-distance-fade-1-double-sided-external-alpha-ref-instanced-vegetation-bending).
