---
id: 0x6272729914c07b98
title: "Shadow Caster Only Shadow Caster Instanced Nvidia Shadow Caster Only"
---

# Shadow Caster Only Shadow Caster Instanced Nvidia Shadow Caster Only
(`shadow_caster_only:shadow_caster:INSTANCED:NVIDIA:SHADOW_CASTER_ONLY`, `0x6272729914c07b98`)

This template is referenced 1 time by [shadow_caster_only:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-instanced).
