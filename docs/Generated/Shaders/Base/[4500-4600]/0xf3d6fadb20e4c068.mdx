---
id: 0xf3d6fadb20e4c068
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Global Environment Mapping Gloss Blurs Cubemap Gloss Control Value Normalmap Vegetation Bending Vertex Alpha
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:VEGETATION_BENDING:VERTEX_ALPHA`, `0xf3d6fadb20e4c068`)
