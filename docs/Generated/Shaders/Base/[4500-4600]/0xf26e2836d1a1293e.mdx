---
id: 0xf26e2836d1a1293e
title: "Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Distance Fade 3 Gsma Texture Normalmap Vertex Color World Up Blend"
---

# Generic Default Blend Diffuse Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Distance Fade 3 Gsma Texture Normalmap Vertex Color World Up Blend
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:DISTANCE_FADE_3:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR:WORLD_UP_BLEND`, `0xf26e2836d1a1293e`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:DISTANCE_FADE_3:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR:WORLD_UP_BLEND](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-control-blend-mask-crossblend-blend-normal-diffuse-texture-distance-fade-3-gsma-texture-normalmap-vertex-color-world-up-blend).
...
float ref_world_up_blend_bias : register(vs_3_0, c9);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    float4 temp0;
    float3 temp1;
    // def c10, 2, -1, -3900, 0.00047619047
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord1 v2
    // dcl_texcoord v3
