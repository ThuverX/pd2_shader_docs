---
id: 0xf370f6125bbbe75c
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Self Illumination"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Self Illumination
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION`, `0xf370f6125bbbe75c`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-self-illumination).
