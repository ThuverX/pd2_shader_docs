---
id: 0xf1ed74f402587a5b
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP`, `0xf1ed74f402587a5b`)
