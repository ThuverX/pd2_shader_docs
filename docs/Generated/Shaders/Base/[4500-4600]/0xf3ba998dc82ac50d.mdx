---
id: 0xf3ba998dc82ac50d
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Bigprops Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Rl Bigprops Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_BIGPROPS:VERTEX_COLOR`, `0xf3ba998dc82ac50d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:RL_BIGPROPS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-rl-bigprops-vertex-color).
