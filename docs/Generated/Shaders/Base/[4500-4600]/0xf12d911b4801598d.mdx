---
id: 0xf12d911b4801598d
title: "Generic Shadow Caster Instanced Nvidia Self Illumination Vertex Color"
---

# Generic Shadow Caster Instanced Nvidia Self Illumination Vertex Color
(`generic:shadow_caster:INSTANCED:NVIDIA:SELF_ILLUMINATION:VERTEX_COLOR`, `0xf12d911b4801598d`)

This template is referenced 1 time by [generic:INSTANCED:SELF_ILLUMINATION:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-instanced-self-illumination-vertex-color).
