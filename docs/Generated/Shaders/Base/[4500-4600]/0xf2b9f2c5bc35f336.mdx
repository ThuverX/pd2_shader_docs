---
id: 0xf2b9f2c5bc35f336
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade To Solid"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade To Solid
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:OPACITY_FADE_TO_SOLID`, `0xf2b9f2c5bc35f336`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_FADE_TO_SOLID](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-opacity-fade-to-solid).
