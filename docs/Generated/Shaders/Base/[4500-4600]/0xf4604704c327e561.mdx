---
id: 0xf4604704c327e561
title: "Effect Default Blend Add Diffuse0 Texture Instanced"
---

# Effect Default Blend Add Diffuse0 Texture Instanced
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:INSTANCED`, `0xf4604704c327e561`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-instanced).
