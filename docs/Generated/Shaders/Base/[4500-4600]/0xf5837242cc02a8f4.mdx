---
id: 0xf5837242cc02a8f4
title: "Generic Default Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Gloss Control Value Normalmap"
---

# Generic Default Detail Normal Texture Red Detail Rgb Mask Diffuse Texture Gloss Control Value Normalmap
(`generic:default:DETAIL_NORMAL_TEXTURE_RED:DETAIL_RGB_MASK:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP`, `0xf5837242cc02a8f4`)

This template is referenced 1 time by [generic:DETAIL_NORMAL_TEXTURE_RED:DETAIL_RGB_MASK:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-detail-normal-texture-red-detail-rgb-mask-diffuse-texture-gloss-control-value-normalmap).
...
float ref_red_detail_intensity : register(ps_3_0, c2);
float3 ref_red_detail_scale : register(ps_3_0, c1);
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // texld r1, v1.zwzw, s2
    temp1 = tex2D(diffuse_layer0_texture, i.texcoord.zw);
    // mul r0.w, r1.x, c2.x
    temp0.w = temp1.x * ref_red_detail_intensity.x;
    // mad r0.xyz, r0.w, -r0, c3.y
    temp0.xyz = temp0.www * -temp0.xyz + float3(1, 1, 1);
    // texld_pp r1, v1.zwzw, s1
    temp1 = /* not implemented _pp modifier */ tex2D(bump_normal_texture, i.texcoord.zw);
    // add_pp r1.xy, r1.wyzw, c3.x
