---
id: 0x5820bc5d711516dc
title: "Generic Shadow Caster Depth Scaling Nvidia Self Illumination"
---

# Generic Shadow Caster Depth Scaling Nvidia Self Illumination
(`generic:shadow_caster:DEPTH_SCALING:NVIDIA:SELF_ILLUMINATION`, `0x5820bc5d711516dc`)

This template is referenced 1 time by [generic:DEPTH_SCALING:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-self-illumination).
