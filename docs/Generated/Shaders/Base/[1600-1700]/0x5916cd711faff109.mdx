---
id: 0x5916cd711faff109
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Nvidia Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NVIDIA:SKINNED_3WEIGHTS`, `0x5916cd711faff109`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-skinned-3weights).
