---
id: 0x58d66dabe39b0e9c
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep Diffuse0 Uvanim"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Threshold Sweep Diffuse0 Uvanim
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP:DIFFUSE0_UVANIM`, `0x58d66dabe39b0e9c`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_THRESHOLD_SWEEP:DIFFUSE0_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-threshold-sweep-diffuse0-uvanim).
