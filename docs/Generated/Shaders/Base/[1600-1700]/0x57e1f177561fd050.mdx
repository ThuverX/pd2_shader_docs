---
id: 0x57e1f177561fd050
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BIGPROPS:SKINNED_3WEIGHTS`, `0x57e1f177561fd050`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-rl-bigprops-skinned-3weights).
