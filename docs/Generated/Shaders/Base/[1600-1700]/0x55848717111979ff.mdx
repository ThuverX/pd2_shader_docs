---
id: 0x55848717111979ff
title: "Effect Default Blend Mul Diffuse0 Texture Threshold Reveal"
---

# Effect Default Blend Mul Diffuse0 Texture Threshold Reveal
(`effect:default:BLEND_MUL:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL`, `0x55848717111979ff`)

This template is referenced 1 time by [effect:BLEND_MUL:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-mul-diffuse0-texture-threshold-reveal).
