---
id: 0x59ff2f33671b8153
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Simple Tint Vertex Color"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Simple Tint Vertex Color
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:VERTEX_COLOR`, `0x59ff2f33671b8153`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap-simple-tint-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r3.xyz, c3, v6
    temp3.xyz = ref_tint_color.xyz * i.color.xyz;
    // mul r1.xyz, r1, r3
    temp1.xyz = temp1.xyz * temp3.xyz;
    // mad_pp oC0.xyz, r1, c4.w, r0
    o.color.xyz = /* not implemented _pp modifier */ temp1.xyz * float3(4, 4, 4) + temp0.xyz;
    // mov_pp oC0.w, r2.x
