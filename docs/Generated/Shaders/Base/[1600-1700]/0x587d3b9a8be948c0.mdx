...
This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_NORMAL:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-mask-control-blend-normal-diffuse-texture-gloss-control-value-normalmap-rl-environment-vertex-color).
