---
id: 0x599e3afb90ecc15a
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0x599e3afb90ecc15a`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-blend-smooth-cube-environment-mapping-diffuse-texture-normalmap-rl-core-environment-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // lrp_pp r5, r1.x, r3, r4
    temp5 = /* not implemented _pp modifier */ lerp(temp4, temp3, temp1.x);
    // mul r0.x, r0.w, r5.w
