---
id: 0x5861addbf16d7fa3
title: "Generic Shadow Caster Blue Mask Tint Diffuse Texture Instanced Nvidia Rl Bigprops"
---

# Generic Shadow Caster Blue Mask Tint Diffuse Texture Instanced Nvidia Rl Bigprops
(`generic:shadow_caster:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:RL_BIGPROPS`, `0x5861addbf16d7fa3`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:INSTANCED:RL_BIGPROPS](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-instanced-rl-bigprops).
