---
id: 0x567fd7bf20abf447
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Distance Fade 4 Double Sided External Alpha Ref Instanced Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_4:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:VEGETATION_BENDING`, `0x567fd7bf20abf447`)
