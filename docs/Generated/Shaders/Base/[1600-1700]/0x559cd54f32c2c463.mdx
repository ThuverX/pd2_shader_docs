---
id: 0x559cd54f32c2c463
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Rl Core Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Smooth Diffuse Texture Rl Core Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:VERTEX_COLOR`, `0x559cd54f32c2c463`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_SMOOTH:DIFFUSE_TEXTURE:RL_CORE_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-smooth-diffuse-texture-rl-core-environment-vertex-color).
