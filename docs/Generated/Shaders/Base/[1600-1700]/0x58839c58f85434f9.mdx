---
id: 0x58839c58f85434f9
title: "Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Foliage Rendering Normalmap Nvidia Vegetation Bending"
---

# Generic Shadow Caster Align Normal World Z Alpha Masked Diffuse Texture Double Sided External Alpha Ref Foliage Rendering Normalmap Nvidia Vegetation Bending
(`generic:shadow_caster:ALIGN_NORMAL_WORLD_Z:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:FOLIAGE_RENDERING:NORMALMAP:NVIDIA:VEGETATION_BENDING`, `0x58839c58f85434f9`)
