---
id: 0x593139502f13025a
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:VERTEX_COLOR`, `0x593139502f13025a`)
