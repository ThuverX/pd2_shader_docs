---
id: 0x54e4d1ff3caff315
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Self Illumination Uvanim"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Self Illumination Self Illumination Uvanim
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0x54e4d1ff3caff315`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-self-illumination-self-illumination-uvanim).
