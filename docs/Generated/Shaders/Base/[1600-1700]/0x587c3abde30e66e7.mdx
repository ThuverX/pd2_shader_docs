---
id: 0x587c3abde30e66e7
title: "Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced Normalmap Nvidia Rl Environment"
---

# Generic Shadow Caster Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced Normalmap Nvidia Rl Environment
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_ENVIRONMENT`, `0x587c3abde30e66e7`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-smooth-blend-tint-second-diffuse-texture-instanced-normalmap-rl-environment).
