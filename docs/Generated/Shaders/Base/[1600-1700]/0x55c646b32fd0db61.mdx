---
id: 0x55c646b32fd0db61
title: "Effect Default Blend Add Diffuse0 Texture Double Sided Instanced View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Double Sided Instanced View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:INSTANCED:VIEW_ANGLE_FALLOFF_OP`, `0x55c646b32fd0db61`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DOUBLE_SIDED:INSTANCED:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-double-sided-instanced-view-angle-falloff-op).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mul r0.x, r0.x, c211.z
    temp0.x = temp0.x * float1(4);
    // mova a0.x, r0.x
    addr0.x = temp0.x;
    // mad r0.xyz, v2, c211.x, c211.y
    ...
    // mad r0, v0.xyzx, -c211.yyyw, -c211.wwwy
