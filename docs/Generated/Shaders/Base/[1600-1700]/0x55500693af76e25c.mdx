---
id: 0x55500693af76e25c
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Diffuse Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Diffuse Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x55500693af76e25c`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-diffuse-texture-normalmap-vertex-color).
