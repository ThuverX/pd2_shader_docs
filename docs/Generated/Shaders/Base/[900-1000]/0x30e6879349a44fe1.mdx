---
id: 0x30e6879349a44fe1
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Normal Uvanim Nvidia"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Normalmap Normal Uvanim Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM:NVIDIA`, `0x30e6879349a44fe1`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-normalmap-normal-uvanim).
