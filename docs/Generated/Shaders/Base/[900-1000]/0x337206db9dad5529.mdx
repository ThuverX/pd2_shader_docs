---
id: 0x337206db9dad5529
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Self Illumination Self Illumination Bloom"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Self Illumination Self Illumination Bloom
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x337206db9dad5529`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-external-alpha-ref-self-illumination-self-illumination-bloom).
