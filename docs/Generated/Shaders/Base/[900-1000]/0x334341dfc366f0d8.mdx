---
id: 0x334341dfc366f0d8
title: "Generic Shadow Caster Diffuse Texture Distance Fade 3 Normalmap Nvidia Rl Core Environment"
---

# Generic Shadow Caster Diffuse Texture Distance Fade 3 Normalmap Nvidia Rl Core Environment
(`generic:shadow_caster:DIFFUSE_TEXTURE:DISTANCE_FADE_3:NORMALMAP:NVIDIA:RL_CORE_ENVIRONMENT`, `0x334341dfc366f0d8`)
