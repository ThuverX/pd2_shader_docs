---
id: 0x3448233684aad37f
title: "Generic Default Cube Environment Mapping Water Diffuse Texture Water Big"
---

# Generic Default Cube Environment Mapping Water Diffuse Texture Water Big
(`generic:default:CUBE_ENVIRONMENT_MAPPING_WATER:DIFFUSE_TEXTURE:WATER_BIG`, `0x3448233684aad37f`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING_WATER:DIFFUSE_TEXTURE:WATER_BIG](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-water-diffuse-texture-water-big).
