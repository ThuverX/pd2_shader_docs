---
id: 0x30a0588f3cc3aebd
title: "Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Nvidia Vertex Color"
---

# Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Nvidia Vertex Color
(`generic:shadow_caster:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:VERTEX_COLOR`, `0x30a0588f3cc3aebd`)

This template is referenced 1 time by [generic:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-cube-environment-mapping-diffuse-texture-vertex-color).
