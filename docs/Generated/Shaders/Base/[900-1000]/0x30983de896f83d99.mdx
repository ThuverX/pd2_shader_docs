---
id: 0x30983de896f83d99
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Rl Environment Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Rl Environment Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:RL_ENVIRONMENT:VERTEX_COLOR`, `0x30983de896f83d99`)
