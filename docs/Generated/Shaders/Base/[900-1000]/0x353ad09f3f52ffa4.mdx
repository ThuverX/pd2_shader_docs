---
id: 0x353ad09f3f52ffa4
title: "Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Instanced Normalmap Opacity Texture Self Illumination Self Illumination Tint"
---

# Generic Shadow Caster Alpha Masked Ati Diffuse Texture External Alpha Ref Instanced Normalmap Opacity Texture Self Illumination Self Illumination Tint
(`generic:shadow_caster:ALPHA_MASKED:ATI:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT`, `0x353ad09f3f52ffa4`)
