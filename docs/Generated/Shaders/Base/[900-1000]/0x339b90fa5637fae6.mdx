---
id: 0x339b90fa5637fae6
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA`, `0x339b90fa5637fae6`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-normalmap).
