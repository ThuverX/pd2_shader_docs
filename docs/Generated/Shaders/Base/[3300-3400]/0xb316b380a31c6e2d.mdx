---
id: 0xb316b380a31c6e2d
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xb316b380a31c6e2d`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-normalmap-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
