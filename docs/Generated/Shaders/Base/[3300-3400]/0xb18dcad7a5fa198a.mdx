---
id: 0xb18dcad7a5fa198a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Opacity Fade Opacity Uvanim"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Diffuse Uvanim Opacity Fade Opacity Uvanim
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:OPACITY_FADE:OPACITY_UVANIM`, `0xb18dcad7a5fa198a`)
