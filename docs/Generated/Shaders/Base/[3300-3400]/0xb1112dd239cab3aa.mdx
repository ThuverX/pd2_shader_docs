---
id: 0xb1112dd239cab3aa
title: "Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Mask Control Blend Mask D A Blend Normal Blend Normal Uv2 Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Mask Control Blend Mask D A Blend Normal Blend Normal Uv2 Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_MASK_CONTROL:BLEND_MASK_D_A:BLEND_NORMAL:BLEND_NORMAL_UV2:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0xb1112dd239cab3aa`)
