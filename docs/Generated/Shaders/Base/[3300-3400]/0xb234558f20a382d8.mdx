---
id: 0xb234558f20a382d8
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia Opacity Fade"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Normalmap Nvidia Opacity Fade
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:NVIDIA:OPACITY_FADE`, `0xb234558f20a382d8`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP:OPACITY_FADE](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-normalmap-opacity-fade).
