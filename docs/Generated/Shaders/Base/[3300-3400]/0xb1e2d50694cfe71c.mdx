---
id: 0xb1e2d50694cfe71c
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Self Illumination"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Self Illumination
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SELF_ILLUMINATION`, `0xb1e2d50694cfe71c`)
