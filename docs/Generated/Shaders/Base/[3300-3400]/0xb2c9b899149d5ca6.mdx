---
id: 0xb2c9b899149d5ca6
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Gsma Texture Normalmap Nvidia"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Gsma Texture Normalmap Nvidia
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NVIDIA`, `0xb2c9b899149d5ca6`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-gsma-texture-normalmap).
