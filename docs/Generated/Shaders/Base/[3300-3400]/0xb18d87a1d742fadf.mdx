---
id: 0xb18d87a1d742fadf
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Skinned 3weights Vertex Color"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Gsma Texture Normalmap Skinned 3weights Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR`, `0xb18d87a1d742fadf`)
