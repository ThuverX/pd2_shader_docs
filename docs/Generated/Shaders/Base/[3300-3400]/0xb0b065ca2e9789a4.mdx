---
id: 0xb0b065ca2e9789a4
title: "Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops"
---

# Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Normalmap Rl Bigprops
(`generic:shadow_caster:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_BIGPROPS`, `0xb0b065ca2e9789a4`)
