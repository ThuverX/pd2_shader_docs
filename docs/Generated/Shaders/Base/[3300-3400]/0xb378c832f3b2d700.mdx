---
id: 0xb378c832f3b2d700
title: "Generic Default Blend Diffuse Blend Mask D A Blend Normal Blend Smooth Blend Tint Second Diffuse Texture Normalmap Rl Core Environment"
---

# Generic Default Blend Diffuse Blend Mask D A Blend Normal Blend Smooth Blend Tint Second Diffuse Texture Normalmap Rl Core Environment
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT`, `0xb378c832f3b2d700`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_NORMAL:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-d-a-blend-normal-blend-smooth-blend-tint-second-diffuse-texture-normalmap-rl-core-environment).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mad r0.xyz, r1.z, r0, c0.z
    temp0.xyz = temp1.zzz * temp0.xyz + float3(1, 1, 1);
    // mul_pp r0.xyz, r0, r1.y
    temp0.xyz = /* not implemented _pp modifier */ temp0.xyz * temp1.yyy;
    // mov_pp r0.w, r1.x
    temp0.w = /* not implemented _pp modifier */ temp1.x;
    // texld_pp r2, v1, s0
    temp2 = /* not implemented _pp modifier */ tex2D(diffuse_texture, i.texcoord.xy);
    // lrp_pp r3, r1.w, r2, r0
    temp3 = /* not implemented _pp modifier */ lerp(temp0, temp2, temp1.w);
    // mov_pp oC0.xyz, r3
