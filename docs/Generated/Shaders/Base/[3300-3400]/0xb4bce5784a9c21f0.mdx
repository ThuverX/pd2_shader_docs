---
id: 0xb4bce5784a9c21f0
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:VIEW_ANGLE_FALLOFF_OP`, `0xb4bce5784a9c21f0`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-uvanim-view-angle-falloff-op).
