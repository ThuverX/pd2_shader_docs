---
id: 0xb3ffd5220546c873
title: "Generic Shadow Caster Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Contour Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xb3ffd5220546c873`)
