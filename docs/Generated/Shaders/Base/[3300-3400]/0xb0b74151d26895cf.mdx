---
id: 0xb0b74151d26895cf
title: "Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight Vertex Color"
---

# Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight Vertex Color
(`generic:shadow_caster:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT:VERTEX_COLOR`, `0xb0b74151d26895cf`)
