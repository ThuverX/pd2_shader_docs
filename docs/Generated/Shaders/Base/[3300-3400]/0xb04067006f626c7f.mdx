...
This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING_WATER:DIFFUSE_TEXTURE:VEGETATION_BENDING:WATER_BIG](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-water-diffuse-texture-vegetation-bending-water-big).
