---
id: 0xb550a33709b8f416
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Simple Tint Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Simple Tint Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:SIMPLE_TINT:SKINNED_1WEIGHT`, `0xb550a33709b8f416`)
