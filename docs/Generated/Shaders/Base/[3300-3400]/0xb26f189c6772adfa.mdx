---
id: 0xb26f189c6772adfa
title: "Generic Default Blue Mask Tint Contour Cube Environment Mapping Diffuse Texture Normalmap"
---

# Generic Default Blue Mask Tint Contour Cube Environment Mapping Diffuse Texture Normalmap
(`generic:default:BLUE_MASK_TINT:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP`, `0xb26f189c6772adfa`)
