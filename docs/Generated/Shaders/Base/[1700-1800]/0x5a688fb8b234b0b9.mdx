---
id: 0x5a688fb8b234b0b9
title: "Effect Default Scope Scope Lense Distortion"
---

# Effect Default Scope Scope Lense Distortion
(`effect:default:SCOPE:SCOPE_LENSE_DISTORTION`, `0x5a688fb8b234b0b9`)

This template is referenced 1 time by [effect:SCOPE:SCOPE_LENSE_DISTORTION](/docs/Generated/Render%20Templates/base.render_template_database#effect-scope-scope-lense-distortion).
...
float3 ref_scope_distortion_params : register(ps_3_0, c6);
float ref_scope_fadeout : register(ps_3_0, c3);
float3 ref_scope_inner_vignett : register(ps_3_0, c1);
float3 ref_scope_k : register(ps_3_0, c4);
float3 ref_scope_kcube : register(ps_3_0, c5);
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    temp0.y = float1(1);
    // add r0.x, r0.y, -c3.x
    temp0.x = temp0.y + -ref_scope_fadeout.x;
    // mul_pp r0.xyz, r0.x, r3
    temp0.xyz = /* not implemented _pp modifier */ temp0.xxx * temp3.xyz;
