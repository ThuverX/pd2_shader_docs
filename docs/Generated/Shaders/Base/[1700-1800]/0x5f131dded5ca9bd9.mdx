---
id: 0x5f131dded5ca9bd9
title: "Opacity Default Ati Cube Environment Mapping Diffuse Texture Opacity Controller Opacity Fade Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Diffuse Texture Opacity Controller Opacity Fade Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:OPACITY_CONTROLLER:OPACITY_FADE:VERTEX_COLOR`, `0x5f131dded5ca9bd9`)
