---
id: 0x5a793055aeacea95
title: "Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Rl Environment Vertex Color"
---

# Generic Shadow Caster Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Rl Environment Vertex Color
(`generic:shadow_caster:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_ENVIRONMENT:VERTEX_COLOR`, `0x5a793055aeacea95`)
