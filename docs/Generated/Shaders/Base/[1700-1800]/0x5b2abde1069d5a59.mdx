---
id: 0x5b2abde1069d5a59
title: "Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT`, `0x5b2abde1069d5a59`)
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // mul r1.xyz, r1, c3
    temp1.xyz = temp1.xyz * ref_tint_color.xyz;
    // add_pp r1.xyz, r1, r1
