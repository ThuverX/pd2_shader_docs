---
id: 0x5df781a9efab46d7
title: "Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Normalmap Uv1 Self Illumination Self Illumination Bloom"
---

# Generic Default Depth Scaling Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Normalmap Uv1 Self Illumination Self Illumination Bloom
(`generic:default:DEPTH_SCALING:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:NORMALMAP_UV1:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x5df781a9efab46d7`)
