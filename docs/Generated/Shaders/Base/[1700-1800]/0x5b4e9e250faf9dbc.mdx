---
id: 0x5b4e9e250faf9dbc
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 1weight"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Rl Bigprops Skinned 1weight
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_BIGPROPS:SKINNED_1WEIGHT`, `0x5b4e9e250faf9dbc`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-rl-bigprops-skinned-1weight).
