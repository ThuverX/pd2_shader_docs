---
id: 0x5a6e929d7d6d3498
title: "Generic Shadow Caster Ati Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Rl Backdrop Vertex Color"
---

# Generic Shadow Caster Ati Blue Mask Tint Cube Environment Mapping Diffuse Texture Instanced Rl Backdrop Vertex Color
(`generic:shadow_caster:ATI:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_BACKDROP:VERTEX_COLOR`, `0x5a6e929d7d6d3498`)
