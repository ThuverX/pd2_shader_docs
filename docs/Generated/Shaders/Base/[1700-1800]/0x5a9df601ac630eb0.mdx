---
id: 0x5a9df601ac630eb0
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Opacity Fade To Solid"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Opacity Fade To Solid
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_FADE_TO_SOLID`, `0x5a9df601ac630eb0`)
