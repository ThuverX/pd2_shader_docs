---
id: 0x5e13e1119a483591
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Rl Environment Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Rl Environment Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:RL_ENVIRONMENT:SIMPLE_TINT`, `0x5e13e1119a483591`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:RL_ENVIRONMENT:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-normalmap-rl-environment-simple-tint).
