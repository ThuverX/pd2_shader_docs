---
id: 0x5aaaf0ba4b367afb
title: "Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Skinned 3weights"
---

# Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Skinned 3weights
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS`, `0x5aaaf0ba4b367afb`)
