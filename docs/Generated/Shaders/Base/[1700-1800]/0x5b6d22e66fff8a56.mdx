---
id: 0x5b6d22e66fff8a56
title: "Shadow Caster Only Shadow Caster Double Sided Instanced Nvidia Shadow Caster Only Vegetation Bending"
---

# Shadow Caster Only Shadow Caster Double Sided Instanced Nvidia Shadow Caster Only Vegetation Bending
(`shadow_caster_only:shadow_caster:DOUBLE_SIDED:INSTANCED:NVIDIA:SHADOW_CASTER_ONLY:VEGETATION_BENDING`, `0x5b6d22e66fff8a56`)

This template is referenced 1 time by [shadow_caster_only:DOUBLE_SIDED:INSTANCED:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#shadow-caster-only-double-sided-instanced-vegetation-bending).
