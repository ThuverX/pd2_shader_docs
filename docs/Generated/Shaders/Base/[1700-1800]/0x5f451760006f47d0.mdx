...
This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_TEXTURE:SIMPLE_TINT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-normalmap-opacity-texture-simple-tint-vertex-color).
