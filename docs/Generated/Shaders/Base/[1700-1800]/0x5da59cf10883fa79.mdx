---
id: 0x5da59cf10883fa79
title: "Generic Default Blue Mask Tint Diffuse Texture Global Environment Mapping Rl Environment Vertex Color"
---

# Generic Default Blue Mask Tint Diffuse Texture Global Environment Mapping Rl Environment Vertex Color
(`generic:default:BLUE_MASK_TINT:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:RL_ENVIRONMENT:VERTEX_COLOR`, `0x5da59cf10883fa79`)

This template is referenced 1 time by [generic:BLUE_MASK_TINT:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blue-mask-tint-diffuse-texture-global-environment-mapping-rl-environment-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // cmp_pp r1.x, r1.y, c0.z, r1.x
    temp1.x = /* not implemented _pp modifier */ (temp1.y >= 0) ? float1(1) : temp1.x;
    // mul r1.yzw, r0.z, v3.xxyz
    temp1.yzw = temp0.zzz * i.color.xyz;
    // mad r0.xyz, v3, -r0.z, r0
    temp0.xyz = i.color.xyz * -temp0.zzz + temp0.xyz;
    // mov_pp oC1.w, r0.w
