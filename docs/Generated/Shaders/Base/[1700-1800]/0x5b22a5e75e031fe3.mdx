---
id: 0x5b22a5e75e031fe3
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Self Illumination Self Illumination Bloom Simple Tint"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Opacity Texture Self Illumination Self Illumination Bloom Simple Tint
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SIMPLE_TINT`, `0x5b22a5e75e031fe3`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-opacity-texture-self-illumination-self-illumination-bloom-simple-tint).
