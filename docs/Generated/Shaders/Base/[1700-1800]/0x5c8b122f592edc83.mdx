---
id: 0x5c8b122f592edc83
title: "Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Opacity Texture Rl Civilians Skinned 1weight"
---

# Generic Default Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Gsma Texture Normalmap Opacity Texture Rl Civilians Skinned 1weight
(`generic:default:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_1WEIGHT`, `0x5c8b122f592edc83`)

This template is referenced 1 time by [generic:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:GSMA_TEXTURE:NORMALMAP:OPACITY_TEXTURE:RL_CIVILIANS:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-contour-diffuse-texture-double-sided-external-alpha-ref-gsma-texture-normalmap-opacity-texture-rl-civilians-skinned-1weight).
