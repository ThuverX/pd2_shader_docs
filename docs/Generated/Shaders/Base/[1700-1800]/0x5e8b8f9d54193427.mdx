---
id: 0x5e8b8f9d54193427
title: "Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination Self Illumination Bloom"
---

# Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Nvidia Self Illumination Self Illumination Bloom
(`generic:shadow_caster:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM`, `0x5e8b8f9d54193427`)

This template is referenced 1 time by [generic:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-depth-scaling-diffuse-texture-normalmap-self-illumination-self-illumination-bloom).
