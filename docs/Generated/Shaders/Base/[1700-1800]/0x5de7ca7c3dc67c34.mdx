---
id: 0x5de7ca7c3dc67c34
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Nvidia Opacity Fade Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:NVIDIA:OPACITY_FADE:SKINNED_3WEIGHTS`, `0x5de7ca7c3dc67c34`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_FADE:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-opacity-fade-skinned-3weights).
