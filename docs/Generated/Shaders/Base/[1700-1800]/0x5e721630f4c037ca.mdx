---
id: 0x5e721630f4c037ca
title: "Generic Default Diffuse Texture Diffuse Uvanim Self Illumination Self Illumination Uvanim"
---

# Generic Default Diffuse Texture Diffuse Uvanim Self Illumination Self Illumination Uvanim
(`generic:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0x5e721630f4c037ca`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-diffuse-uvanim-self-illumination-self-illumination-uvanim).
