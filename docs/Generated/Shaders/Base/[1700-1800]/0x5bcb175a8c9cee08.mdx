---
id: 0x5bcb175a8c9cee08
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Self Illumination Tint"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia Self Illumination Self Illumination Tint
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT`, `0x5bcb175a8c9cee08`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-self-illumination-self-illumination-tint).
