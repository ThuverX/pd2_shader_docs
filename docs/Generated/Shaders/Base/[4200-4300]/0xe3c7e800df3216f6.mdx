---
id: 0xe3c7e800df3216f6
title: "Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Control Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xe3c7e800df3216f6`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_CONTROL:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-control-diffuse-texture-gsma-texture-normalmap-vertex-color).
