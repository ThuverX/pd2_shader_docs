---
id: 0xe4a9eb4e3a5866d4
title: "Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Self Illumination Self Illumination Uvanim"
---

# Generic Default Cube Environment Mapping Diffuse Texture Diffuse Uvanim Self Illumination Self Illumination Uvanim
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0xe4a9eb4e3a5866d4`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-diffuse-uvanim-self-illumination-self-illumination-uvanim).
