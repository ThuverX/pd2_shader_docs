---
id: 0xe37053f1ee9f3c03
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xe37053f1ee9f3c03`)
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r0.w, r2.y, -v5.w
    temp0.w = /* not implemented _pp modifier */ temp2.y + -i.color.w;
    // mul_sat_pp r0.w, r0.w, c0.x
    ;// error
    // lrp_pp r2.xyz, r0.w, r0, r1
    temp2.xyz = /* not implemented _pp modifier */ lerp(temp1.xyz, temp0.xyz, temp0.www);
