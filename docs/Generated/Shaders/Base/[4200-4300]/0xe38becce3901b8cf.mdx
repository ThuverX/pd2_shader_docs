---
id: 0xe38becce3901b8cf
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask Control Blend Mask Crossblend Blend Normal Diffuse Texture Normalmap Self Illumination World Up Blend
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:DIFFUSE_TEXTURE:NORMALMAP:SELF_ILLUMINATION:WORLD_UP_BLEND`, `0xe38becce3901b8cf`)
