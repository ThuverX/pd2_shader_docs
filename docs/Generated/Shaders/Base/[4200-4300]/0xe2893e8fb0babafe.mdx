---
id: 0xe2893e8fb0babafe
title: "Effect Default Diffuse0 Texture Threshold Reveal"
---

# Effect Default Diffuse0 Texture Threshold Reveal
(`effect:default:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL`, `0xe2893e8fb0babafe`)

This template is referenced 1 time by [effect:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL](/docs/Generated/Render%20Templates/base.render_template_database#effect-diffuse0-texture-threshold-reveal).
