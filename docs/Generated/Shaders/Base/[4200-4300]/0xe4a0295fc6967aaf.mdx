---
id: 0xe4a0295fc6967aaf
title: "Generic Shadow Caster Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Cube Environment Mapping Depth Scaling Diffuse Texture Normalmap Nvidia Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xe4a0295fc6967aaf`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-depth-scaling-diffuse-texture-normalmap-skinned-3weights-vertex-color-vertex-color-alpha-vertex-color-character).
