---
id: 0xe10ab90465ec44b6
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Nvidia Self Illumination"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Nvidia Self Illumination
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION`, `0xe10ab90465ec44b6`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-self-illumination).
