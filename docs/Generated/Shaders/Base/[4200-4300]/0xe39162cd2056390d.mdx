---
id: 0xe39162cd2056390d
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Intersection Fadeout Skinned 1weight View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Uvanim Intersection Fadeout Skinned 1weight View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:INTERSECTION_FADEOUT:SKINNED_1WEIGHT:VIEW_ANGLE_FALLOFF_OP`, `0xe39162cd2056390d`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_UVANIM:INTERSECTION_FADEOUT:SKINNED_1WEIGHT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-uvanim-intersection-fadeout-skinned-1weight-view-angle-falloff-op).
...
float ref_time : register(vs_3_0, c177);
float3 ref_uv0_speed : register(vs_3_0, c178);
float3 render_target_texel_offset : register(vs_3_0, c179);
column_major float4x4 view_matrix : register(vs_3_0, c166);
float3 vp_offset : register(vs_3_0, c180);
float3 vp_size : register(vs_3_0, c181);
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    // mad r0.x, r1.y, -c181.y, r2.y
    temp0.x = temp1.y * -vp_size.y + temp2.y;
    // mov o0, r1
    o.position = temp1;
    // mul o4.zw, r1, c182.xywx
