---
id: 0xe3bdc1b800a060bc
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Nvidia Opacity Texture"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Nvidia Opacity Texture
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NVIDIA:OPACITY_TEXTURE`, `0xe3bdc1b800a060bc`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:OPACITY_TEXTURE](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-external-alpha-ref-instanced-opacity-texture).
