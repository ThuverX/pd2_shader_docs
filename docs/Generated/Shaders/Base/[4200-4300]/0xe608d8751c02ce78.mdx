---
id: 0xe608d8751c02ce78
title: "Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Self Illumination Self Illumination Bloom Self Illumination Uvanim"
---

# Generic Default Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Self Illumination Self Illumination Bloom Self Illumination Uvanim
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM`, `0xe608d8751c02ce78`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-external-alpha-ref-self-illumination-self-illumination-bloom-self-illumination-uvanim).
