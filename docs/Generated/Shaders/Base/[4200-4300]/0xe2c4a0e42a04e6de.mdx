---
id: 0xe2c4a0e42a04e6de
title: "Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Normalmap Nvidia Rl Cops Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_COPS:SKINNED_3WEIGHTS`, `0xe2c4a0e42a04e6de`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-rl-cops-skinned-3weights).
