---
id: 0xe209f25d3af9d2c8
title: "Generic Default Blend Diffuse Blend Fade Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Fade Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_FADE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP`, `0xe209f25d3af9d2c8`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_FADE:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-fade-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_sat_pp r0.x, r0.x, -c3.x
    ;// error
    // lrp_pp r4.xyz, r0.x, r2, r3
    temp4.xyz = /* not implemented _pp modifier */ lerp(temp3.xyz, temp2.xyz, temp0.xxx);
    // texld_pp r2, v1, s2
