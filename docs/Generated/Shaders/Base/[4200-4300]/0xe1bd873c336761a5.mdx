---
id: 0xe1bd873c336761a5
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Simple Tint Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Nvidia Simple Tint Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:NVIDIA:SIMPLE_TINT:VERTEX_COLOR`, `0xe1bd873c336761a5`)
