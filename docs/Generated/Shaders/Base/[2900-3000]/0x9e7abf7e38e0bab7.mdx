---
id: 0x9e7abf7e38e0bab7
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Nvidia Vegetation Bending Vertex Alpha Vertex Color Alpha"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Normalmap Nvidia Vegetation Bending Vertex Alpha Vertex Color Alpha
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:VEGETATION_BENDING:VERTEX_ALPHA:VERTEX_COLOR_ALPHA`, `0x9e7abf7e38e0bab7`)
