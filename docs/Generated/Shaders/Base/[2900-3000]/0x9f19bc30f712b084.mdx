---
id: 0x9f19bc30f712b084
title: "Decal Default Diffuse Texture Rl Fps Weapon"
---

# Decal Default Diffuse Texture Rl Fps Weapon
(`decal:default:DIFFUSE_TEXTURE:RL_FPS_WEAPON`, `0x9f19bc30f712b084`)

This template is referenced 1 time by [decal:DIFFUSE_TEXTURE:RL_FPS_WEAPON](/docs/Generated/Render%20Templates/base.render_template_database#decal-diffuse-texture-rl-fps-weapon).
