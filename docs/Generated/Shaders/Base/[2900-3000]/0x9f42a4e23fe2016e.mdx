---
id: 0x9f42a4e23fe2016e
title: "Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:BLEND_NORMAL_UV2:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x9f42a4e23fe2016e`)
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    temp0.w = /* not implemented _pp modifier */ temp4.y + temp4.x;
    // add r1.w, r0.w, c4.w
    temp1.w = temp0.w + float1(-0.75);
    // mul_pp r0.w, r0.w, c5.x
    temp0.w = /* not implemented _pp modifier */ temp0.w * float1(1.3333334);
    // cmp_pp r0.w, r1.w, c4.x, r0.w
    temp0.w = /* not implemented _pp modifier */ (temp1.w >= 0) ? float1(1) : temp0.w;
    // mul r2.xyz, r4.z, v6
    temp2.xyz = temp4.zzz * i.color.xyz;
    // mad r3.xyz, v6, -r4.z, r4
    temp3.xyz = i.color.xyz * -temp4.zzz + temp4.xyz;
    // mad_pp r2.xyz, r0.w, r3, r2
    temp2.xyz = /* not implemented _pp modifier */ temp0.www * temp3.xyz + temp2.xyz;
