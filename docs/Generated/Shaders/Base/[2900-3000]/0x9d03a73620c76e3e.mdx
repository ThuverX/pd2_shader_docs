---
id: 0x9d03a73620c76e3e
title: "Opacity Default Cube Environment Mapping Diffuse Texture Instanced Nvidia"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Instanced Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA`, `0x9d03a73620c76e3e`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-instanced).
