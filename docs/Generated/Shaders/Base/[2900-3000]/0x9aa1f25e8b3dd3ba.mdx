---
id: 0x9aa1f25e8b3dd3ba
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Nvidia Self Illumination"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Nvidia Self Illumination
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION`, `0x9aa1f25e8b3dd3ba`)

This template is referenced 1 time by [generic:DEPTH_SCALING:DIFFUSE_TEXTURE:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-depth-scaling-diffuse-texture-self-illumination).
