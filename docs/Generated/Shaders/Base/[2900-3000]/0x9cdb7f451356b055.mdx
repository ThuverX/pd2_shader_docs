---
id: 0x9cdb7f451356b055
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 3weights"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 3weights
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x9cdb7f451356b055`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-skinned-3weights).
