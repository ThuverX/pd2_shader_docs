---
id: 0x9e1fb11fafe3f01e
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Rl Environment Vertex Color"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Rl Environment Vertex Color
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:RL_ENVIRONMENT:VERTEX_COLOR`, `0x9e1fb11fafe3f01e`)
