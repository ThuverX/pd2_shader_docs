---
id: 0x9ec03d55b2a06186
title: "Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Bloom Vertex Color"
---

# Generic Default Alpha Masked Diffuse Texture External Alpha Ref Normalmap Opacity Texture Self Illumination Self Illumination Bloom Vertex Color
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_BLOOM:VERTEX_COLOR`, `0x9ec03d55b2a06186`)
