---
id: 0x9ab499c244724d33
title: "Generic Shadow Caster Contour Diffuse Texture Global Environment Mapping Normalmap Nvidia"
---

# Generic Shadow Caster Contour Diffuse Texture Global Environment Mapping Normalmap Nvidia
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP:NVIDIA`, `0x9ab499c244724d33`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-global-environment-mapping-normalmap).
