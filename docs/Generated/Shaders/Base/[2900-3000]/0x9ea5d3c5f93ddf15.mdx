---
id: 0x9ea5d3c5f93ddf15
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA:VEGETATION_BENDING`, `0x9ea5d3c5f93ddf15`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-instanced-normalmap-vegetation-bending).
