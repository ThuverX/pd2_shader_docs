---
id: 0x9eda0841af4c9eb0
title: "Generic Default Blend Diffuse Blend Mask Seperate Diffuse Texture Normalmap"
---

# Generic Default Blend Diffuse Blend Mask Seperate Diffuse Texture Normalmap
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:NORMALMAP`, `0x9eda0841af4c9eb0`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-diffuse-texture-normalmap).
