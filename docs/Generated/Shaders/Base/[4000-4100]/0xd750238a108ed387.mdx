---
id: 0xd750238a108ed387
title: "Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl 3rd Weapons Vertex Color"
---

# Generic Shadow Caster Diffuse Texture Instanced Normalmap Nvidia Rl 3rd Weapons Vertex Color
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:RL_3RD_WEAPONS:VERTEX_COLOR`, `0xd750238a108ed387`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_3RD_WEAPONS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced-normalmap-rl-3rd-weapons-vertex-color).
