---
id: 0xd4dc172db7ef6a76
title: "Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Vertex Color"
---

# Generic Shadow Caster Contour Cube Environment Mapping Diffuse Texture Normalmap Vertex Color
(`generic:shadow_caster:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xd4dc172db7ef6a76`)
