---
id: 0xd70c6dd2fb34204c
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Simple Tint"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Instanced Nvidia Simple Tint
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:NVIDIA:SIMPLE_TINT`, `0xd70c6dd2fb34204c`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-instanced-simple-tint).
