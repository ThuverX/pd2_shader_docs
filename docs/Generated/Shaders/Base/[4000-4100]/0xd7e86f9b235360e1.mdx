---
id: 0xd7e86f9b235360e1
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Vertex Color"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Instanced Vertex Color
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:INSTANCED:VERTEX_COLOR`, `0xd7e86f9b235360e1`)
