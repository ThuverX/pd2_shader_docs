---
id: 0xd9c2669e488ed728
title: "Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gloss Blurs Cubemap Gloss Control Value Normalmap Self Illumination Vegetation Bending Vertex Alpha"
---

# Generic Shadow Caster Alpha Masked Cube Environment Mapping Diffuse Texture External Alpha Ref Gloss Blurs Cubemap Gloss Control Value Normalmap Self Illumination Vegetation Bending Vertex Alpha
(`generic:shadow_caster:ALPHA_MASKED:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:NORMALMAP:SELF_ILLUMINATION:VEGETATION_BENDING:VERTEX_ALPHA`, `0xd9c2669e488ed728`)
