---
id: 0xd4e5240a8a59f0dc
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Self Illumination"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Self Illumination
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:SELF_ILLUMINATION`, `0xd4e5240a8a59f0dc`)
