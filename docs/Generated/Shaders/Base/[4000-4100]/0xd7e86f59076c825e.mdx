---
id: 0xd7e86f59076c825e
title: "Generic Shadow Caster Ati Diffuse Texture Normalmap Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Ati Diffuse Texture Normalmap Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:ATI:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xd7e86f59076c825e`)
