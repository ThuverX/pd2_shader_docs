---
id: 0xd9212230c10e5ed8
title: "Generic Shadow Caster Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint Vertex Color"
---

# Generic Shadow Caster Blend Diffuse Blend Diffuse Uv2 Blend Gsma Blend Mask Control Blend Mask Crossblend Blend Normal Blend Normal Uv2 Blue Mask Tint Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Simple Tint Vertex Color
(`generic:shadow_caster:BLEND_DIFFUSE:BLEND_DIFFUSE_UV2:BLEND_GSMA:BLEND_MASK_CONTROL:BLEND_MASK_CROSSBLEND:BLEND_NORMAL:BLEND_NORMAL_UV2:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:SIMPLE_TINT:VERTEX_COLOR`, `0xd9212230c10e5ed8`)
