---
id: 0xd83410fdb063e471
title: "Generic Shadow Caster Diffuse Texture Instanced Nvidia"
---

# Generic Shadow Caster Diffuse Texture Instanced Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:INSTANCED:NVIDIA`, `0xd83410fdb063e471`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:INSTANCED](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-instanced).
