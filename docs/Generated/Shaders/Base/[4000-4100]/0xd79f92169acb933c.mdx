---
id: 0xd79f92169acb933c
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Normalmap"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 3 Double Sided External Alpha Ref Instanced Normalmap
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP`, `0xd79f92169acb933c`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_3:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-3-double-sided-external-alpha-ref-instanced-normalmap).
...
VertexMain_Output VertexMain(VertexMain_Input i)
{
    ...
    float addr0;
    // def c210, 2, -1, 4, -0
    // def c211, -3900, 0.00047619047, 0, 0
    // dcl_position v0
    // dcl_normal v1
    // dcl_texcoord1 v2
    // dcl_texcoord v3
    ...
    temp0.x = temp0.z * temp0.y + float1(-3900);
    // mov o1.x, r0.z
