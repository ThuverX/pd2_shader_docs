---
id: 0xd9a5808e15a4538a
title: "Generic Default Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Gsma Blend Normal Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0xd9a5808e15a4538a`)
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r1.w, r1.w, -v6.w
    temp1.w = /* not implemented _pp modifier */ temp1.w + -i.color.w;
    ...
    // mad_pp oC0.xyz, r4, v6, r2
    o.color.xyz = /* not implemented _pp modifier */ temp4.xyz * i.color.xyz + temp2.xyz;
    // mov oC0.w, r0.y
    o.color.w = temp0.y;
    // mov_pp oC1.w, r0.x
