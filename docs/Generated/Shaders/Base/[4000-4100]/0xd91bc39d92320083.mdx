---
id: 0xd91bc39d92320083
title: "Generic Customizable Shadow Caster Ati Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Skinned 3weights Wear Tear Masking"
---

# Generic Customizable Shadow Caster Ati Cube Environment Mapping Decal Sticker Uv2 Diffuse Texture Gradientmap Normalmap Pattern Gradientmap Pattern Gradientmap Angle Offset Pattern Uv2 Skinned 3weights Wear Tear Masking
(`generic_customizable:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DECAL_STICKER_UV2:DIFFUSE_TEXTURE:GRADIENTMAP:NORMALMAP:PATTERN_GRADIENTMAP:PATTERN_GRADIENTMAP_ANGLE_OFFSET:PATTERN_UV2:SKINNED_3WEIGHTS:WEAR_TEAR_MASKING`, `0xd91bc39d92320083`)
