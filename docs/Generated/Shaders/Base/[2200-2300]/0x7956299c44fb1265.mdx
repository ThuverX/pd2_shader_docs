---
id: 0x7956299c44fb1265
title: "Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 3weights"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Normalmap Nvidia Skinned 3weights
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:SKINNED_3WEIGHTS`, `0x7956299c44fb1265`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-diffuse-texture-normalmap-skinned-3weights).
