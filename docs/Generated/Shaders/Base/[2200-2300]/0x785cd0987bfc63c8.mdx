---
id: 0x785cd0987bfc63c8
title: "Generic Shadow Caster Diffuse Texture Normalmap Normalmap Uv1 Nvidia Skinned 3weights"
---

# Generic Shadow Caster Diffuse Texture Normalmap Normalmap Uv1 Nvidia Skinned 3weights
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:NORMALMAP_UV1:NVIDIA:SKINNED_3WEIGHTS`, `0x785cd0987bfc63c8`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:NORMALMAP:NORMALMAP_UV1:SKINNED_3WEIGHTS](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-normalmap-normalmap-uv1-skinned-3weights).
