---
id: 0x76f2acc862d435bb
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Double Sided External Alpha Ref Instanced Normalmap Nvidia
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:NVIDIA`, `0x76f2acc862d435bb`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-double-sided-external-alpha-ref-instanced-normalmap).
