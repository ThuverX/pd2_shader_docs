---
id: 0x78d6a1d11a44e7f8
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Nvidia Self Illumination"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Fps Nvidia Self Illumination
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:NVIDIA:SELF_ILLUMINATION`, `0x78d6a1d11a44e7f8`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:FPS:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-fps-self-illumination).
