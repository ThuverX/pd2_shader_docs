---
id: 0x77e8752932dbb340
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Self Illumination"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Self Illumination
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION`, `0x77e8752932dbb340`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gsma-texture-instanced-normalmap-self-illumination).
