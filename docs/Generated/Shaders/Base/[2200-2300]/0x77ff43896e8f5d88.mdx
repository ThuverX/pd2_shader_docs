---
id: 0x77ff43896e8f5d88
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Self Illumination Self Illumination Tint Simple Tint Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim Double Sided Self Illumination Self Illumination Tint Simple Tint Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:DOUBLE_SIDED:SELF_ILLUMINATION:SELF_ILLUMINATION_TINT:SIMPLE_TINT:VEGETATION_BENDING`, `0x77ff43896e8f5d88`)
