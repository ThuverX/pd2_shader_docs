---
id: 0x786fe6a4354bd77d
title: "Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Uvanim"
---

# Opacity Default Diffuse Texture Diffuse Uvanim Normalmap Normal Uvanim Nvidia Opacity Uvanim
(`opacity:default:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:NVIDIA:OPACITY_UVANIM`, `0x786fe6a4354bd77d`)

This template is referenced 1 time by [opacity:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:NORMALMAP:NORMAL_UVANIM:OPACITY_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#opacity-diffuse-texture-diffuse-uvanim-normalmap-normal-uvanim-opacity-uvanim).
