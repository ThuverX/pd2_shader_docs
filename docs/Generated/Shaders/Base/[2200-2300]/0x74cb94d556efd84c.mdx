---
id: 0x74cb94d556efd84c
title: "Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade To Solid Take Fog"
---

# Opacity Default Ati Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Fade To Solid Take Fog
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_FADE_TO_SOLID:TAKE_FOG`, `0x74cb94d556efd84c`)
