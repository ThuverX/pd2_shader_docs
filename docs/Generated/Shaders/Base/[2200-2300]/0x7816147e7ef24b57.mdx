---
id: 0x7816147e7ef24b57
title: "Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops"
---

# Generic Default Blue Mask Tint Cube Environment Mapping Diffuse Texture Normalmap Rl Bigprops
(`generic:default:BLUE_MASK_TINT:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_BIGPROPS`, `0x7816147e7ef24b57`)
