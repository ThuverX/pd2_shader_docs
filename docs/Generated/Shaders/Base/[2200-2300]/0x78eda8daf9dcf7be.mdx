---
id: 0x78eda8daf9dcf7be
title: "Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Vertex Color"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture External Alpha Ref Instanced Normalmap Vertex Color
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP:VERTEX_COLOR`, `0x78eda8daf9dcf7be`)
