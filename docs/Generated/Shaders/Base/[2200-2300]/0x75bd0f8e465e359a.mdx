---
id: 0x75bd0f8e465e359a
title: "Generic Shadow Caster Ati Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced"
---

# Generic Shadow Caster Ati Blend Diffuse Blend Mask D A Blend Smooth Blend Tint Second Diffuse Texture Instanced
(`generic:shadow_caster:ATI:BLEND_DIFFUSE:BLEND_MASK_D_A:BLEND_SMOOTH:BLEND_TINT_SECOND:DIFFUSE_TEXTURE:INSTANCED`, `0x75bd0f8e465e359a`)
