---
id: 0x7917abcbcb9a6542
title: "Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Skinned 3weights"
---

# Generic Shadow Caster Ati Cube Environment Mapping Diffuse Texture Normalmap Rl Core Environment Skinned 3weights
(`generic:shadow_caster:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:RL_CORE_ENVIRONMENT:SKINNED_3WEIGHTS`, `0x7917abcbcb9a6542`)
