---
id: 0x777bf1050c78838c
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x777bf1050c78838c`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-blend-smooth-cube-environment-mapping-diffuse-texture-gsma-texture-normalmap-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // texld_pp r1, v1, s2
    temp1 = /* not implemented _pp modifier */ tex2D(diffuse_layer1_texture, i.texcoord.xy);
    // add_pp r1.x, r1.y, -v6.w
    temp1.x = /* not implemented _pp modifier */ temp1.y + -i.color.w;
    // mul_sat_pp r1.x, r1.x, c3.x
    ;// error
    ...
    // mad r1.yzw, r1.y, -r0.xxyz, r3.xxyz
    temp1.yzw = temp1.yyy * -temp0.xyz + temp3.xyz;
    ...
    // lrp_pp r5.xyz, r1.x, r2, r4
    temp5.xyz = /* not implemented _pp modifier */ lerp(temp4.xyz, temp2.xyz, temp1.xxx);
    // mad_pp oC0.xyz, r5, v6, r0
    o.color.xyz = /* not implemented _pp modifier */ temp5.xyz * i.color.xyz + temp0.xyz;
    // mov_pp oC0.w, r3.x
    o.color.w = /* not implemented _pp modifier */ temp3.x;
    // mov_pp oC1.w, r3.y
    o.color1.w = /* not implemented _pp modifier */ temp3.y;
    // mov oC2, v0.x
