---
id: 0x77a773c3c2887db2
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Fps Normalmap Nvidia"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Double Sided Fps Normalmap Nvidia
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:FPS:NORMALMAP:NVIDIA`, `0x77a773c3c2887db2`)

This template is referenced 1 time by [opacity:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:DOUBLE_SIDED:FPS:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#opacity-cube-environment-mapping-cube-fresnel-diffuse-texture-double-sided-fps-normalmap).
