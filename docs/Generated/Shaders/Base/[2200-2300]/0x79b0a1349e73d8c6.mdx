---
id: 0x79b0a1349e73d8c6
title: "Opacity Default Cube Environment Mapping Diffuse Texture Double Sided Opacity Controller Vertex Color"
---

# Opacity Default Cube Environment Mapping Diffuse Texture Double Sided Opacity Controller Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:OPACITY_CONTROLLER:VERTEX_COLOR`, `0x79b0a1349e73d8c6`)
