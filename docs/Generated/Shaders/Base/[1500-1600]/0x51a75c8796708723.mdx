---
id: 0x51a75c8796708723
title: "Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Nvidia Vegetation Bending"
---

# Generic Shadow Caster Alpha Masked Diffuse Texture Diffuse Uvanim External Alpha Ref Nvidia Vegetation Bending
(`generic:shadow_caster:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:NVIDIA:VEGETATION_BENDING`, `0x51a75c8796708723`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DIFFUSE_UVANIM:EXTERNAL_ALPHA_REF:VEGETATION_BENDING](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-diffuse-uvanim-external-alpha-ref-vegetation-bending).
