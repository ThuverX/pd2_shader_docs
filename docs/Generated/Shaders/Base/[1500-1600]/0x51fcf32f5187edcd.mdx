---
id: 0x51fcf32f5187edcd
title: "Generic Shadow Caster Depth Scaling Diffuse Texture Fps Detail Normalmap Nvidia Vertex Color Vertex Color Alpha"
---

# Generic Shadow Caster Depth Scaling Diffuse Texture Fps Detail Normalmap Nvidia Vertex Color Vertex Color Alpha
(`generic:shadow_caster:DEPTH_SCALING:DIFFUSE_TEXTURE:FPS_DETAIL:NORMALMAP:NVIDIA:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x51fcf32f5187edcd`)
