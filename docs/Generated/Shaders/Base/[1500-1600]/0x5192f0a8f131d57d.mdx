---
id: 0x5192f0a8f131d57d
title: "Generic Default Contour Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight"
---

# Generic Default Contour Cube Environment Mapping Diffuse Texture Normalmap Skinned 1weight
(`generic:default:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT`, `0x5192f0a8f131d57d`)

This template is referenced 1 time by [generic:CONTOUR:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-cube-environment-mapping-diffuse-texture-normalmap-skinned-1weight).
