---
id: 0x4fb8ab42228d7a0b
title: "Effect Default Blend Add Diffuse0 Texture Threshold Reveal"
---

# Effect Default Blend Add Diffuse0 Texture Threshold Reveal
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL`, `0x4fb8ab42228d7a0b`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:THRESHOLD_REVEAL](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-threshold-reveal).
