---
id: 0x530726fb47e395b0
title: "Generic Default Cube Environment Mapping Diffuse Texture Double Sided Simple Tint"
---

# Generic Default Cube Environment Mapping Diffuse Texture Double Sided Simple Tint
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:SIMPLE_TINT`, `0x530726fb47e395b0`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-double-sided-simple-tint).
