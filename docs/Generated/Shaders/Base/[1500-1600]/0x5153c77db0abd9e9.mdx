---
id: 0x5153c77db0abd9e9
title: "Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Opacity Texture Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Ati Cube Environment Mapping Diffuse Texture External Alpha Ref Normalmap Opacity Texture Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:EXTERNAL_ALPHA_REF:NORMALMAP:OPACITY_TEXTURE:SKINNED_1WEIGHT`, `0x5153c77db0abd9e9`)
