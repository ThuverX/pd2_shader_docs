---
id: 0x4fa027e7e8b5b4aa
title: "Generic Default Alpha Masked Diffuse Texture Distance Fade 2 Double Sided External Alpha Ref Instanced Normalmap"
---

# Generic Default Alpha Masked Diffuse Texture Distance Fade 2 Double Sided External Alpha Ref Instanced Normalmap
(`generic:default:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP`, `0x4fa027e7e8b5b4aa`)

This template is referenced 1 time by [generic:ALPHA_MASKED:DIFFUSE_TEXTURE:DISTANCE_FADE_2:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-alpha-masked-diffuse-texture-distance-fade-2-double-sided-external-alpha-ref-instanced-normalmap).
