---
id: 0x5486f40f450114c4
title: "Generic Default Blend Diffuse Blend Gsma Blend Normal Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Vertex Color"
---

# Generic Default Blend Diffuse Blend Gsma Blend Normal Diffuse Texture Global Environment Mapping Gsma Texture Normalmap Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR`, `0x5486f40f450114c4`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_GSMA:BLEND_NORMAL:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-gsma-blend-normal-diffuse-texture-global-environment-mapping-gsma-texture-normalmap-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    temp0.xy = temp0.yx + -temp1.yx;
    // texld_pp r2, v1, s1
    temp2 = /* not implemented _pp modifier */ tex2D(diffuse_layer0_texture, i.texcoord.xy);
    // add_pp r0.z, r2.w, -v5.w
    temp0.z = /* not implemented _pp modifier */ temp2.w + -i.color.w;
    // mul_sat_pp r0.z, r0.z, c0.x
    ;// error
    // mad_pp oC1.w, r0.z, r0.x, r1.y
    o.color1.w = /* not implemented _pp modifier */ temp0.z * temp0.x + temp1.y;
    // mad oC0.w, r0.z, r0.y, r1.x
    o.color.w = temp0.z * temp0.y + temp1.x;
    // texld_pp r1, v1, s0
