---
id: 0x52485bf79f05465a
title: "Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Opacity Controller Vertex Color"
---

# Opacity Default Ati Cube Environment Mapping Diffuse Texture Normalmap Opacity Controller Vertex Color
(`opacity:default:ATI:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:OPACITY_CONTROLLER:VERTEX_COLOR`, `0x52485bf79f05465a`)
