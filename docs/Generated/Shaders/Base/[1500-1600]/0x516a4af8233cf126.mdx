---
id: 0x516a4af8233cf126
title: "Generic Default Cube Environment Mapping Diffuse Texture Normalmap Normal Uvanim"
---

# Generic Default Cube Environment Mapping Diffuse Texture Normalmap Normal Uvanim
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM`, `0x516a4af8233cf126`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:NORMALMAP:NORMAL_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-normalmap-normal-uvanim).
