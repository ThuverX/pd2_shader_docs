---
id: 0x507257529763a53b
title: "Generic Default Diffuse Texture Distance Fade 4 Normalmap Rl Core Environment"
---

# Generic Default Diffuse Texture Distance Fade 4 Normalmap Rl Core Environment
(`generic:default:DIFFUSE_TEXTURE:DISTANCE_FADE_4:NORMALMAP:RL_CORE_ENVIRONMENT`, `0x507257529763a53b`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DISTANCE_FADE_4:NORMALMAP:RL_CORE_ENVIRONMENT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-distance-fade-4-normalmap-rl-core-environment).
