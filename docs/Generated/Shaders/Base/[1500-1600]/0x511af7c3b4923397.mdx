---
id: 0x511af7c3b4923397
title: "Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Nvidia"
---

# Generic Shadow Caster Contour Depth Scaling Diffuse Texture Normalmap Nvidia
(`generic:shadow_caster:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA`, `0x511af7c3b4923397`)

This template is referenced 1 time by [generic:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-depth-scaling-diffuse-texture-normalmap).
