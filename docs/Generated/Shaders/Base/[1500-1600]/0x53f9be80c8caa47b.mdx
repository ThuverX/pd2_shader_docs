---
id: 0x53f9be80c8caa47b
title: "Generic Shadow Caster Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Rl Cops Skinned 1weight"
---

# Generic Shadow Caster Alpha Masked Contour Diffuse Texture Double Sided External Alpha Ref Normalmap Nvidia Opacity Texture Rl Cops Skinned 1weight
(`generic:shadow_caster:ALPHA_MASKED:CONTOUR:DIFFUSE_TEXTURE:DOUBLE_SIDED:EXTERNAL_ALPHA_REF:NORMALMAP:NVIDIA:OPACITY_TEXTURE:RL_COPS:SKINNED_1WEIGHT`, `0x53f9be80c8caa47b`)
