---
id: 0x54249c1915db0237
title: "Generic Default Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Default Diffuse Texture Normalmap Rl Civilians Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:default:DIFFUSE_TEXTURE:NORMALMAP:RL_CIVILIANS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0x54249c1915db0237`)
