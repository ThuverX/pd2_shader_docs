---
id: 0x52f45f1ca2a78d31
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Simple Tint"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gsma Texture Instanced Normalmap Nvidia Simple Tint
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA:SIMPLE_TINT`, `0x52f45f1ca2a78d31`)
