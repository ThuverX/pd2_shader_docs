---
id: 0x528dee9cc7be83c0
title: "Generic Default Cube Environment Mapping Diffuse Texture Double Sided Normalmap"
---

# Generic Default Cube Environment Mapping Diffuse Texture Double Sided Normalmap
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP`, `0x528dee9cc7be83c0`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:DOUBLE_SIDED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-double-sided-normalmap).
