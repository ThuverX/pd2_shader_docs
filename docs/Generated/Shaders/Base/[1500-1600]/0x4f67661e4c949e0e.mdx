---
id: 0x4f67661e4c949e0e
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Opacity Controller
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:OPACITY_CONTROLLER`, `0x4f67661e4c949e0e`)
