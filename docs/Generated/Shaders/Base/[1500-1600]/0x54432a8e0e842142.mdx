---
id: 0x54432a8e0e842142
title: "Generic Shadow Caster Contour Diffuse Texture Normalmap Nvidia Rl 3rd Weapons Vertex Color"
---

# Generic Shadow Caster Contour Diffuse Texture Normalmap Nvidia Rl 3rd Weapons Vertex Color
(`generic:shadow_caster:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:NVIDIA:RL_3RD_WEAPONS:VERTEX_COLOR`, `0x54432a8e0e842142`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:NORMALMAP:RL_3RD_WEAPONS:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-normalmap-rl-3rd-weapons-vertex-color).
