---
id: 0x530f171a1b12548d
title: "Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color Vertex Color Alpha"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gsma Texture Normalmap Vertex Color Vertex Color Alpha
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:VERTEX_COLOR:VERTEX_COLOR_ALPHA`, `0x530f171a1b12548d`)
