---
id: 0xc1764c2c1a8faecc
title: "Generic Shadow Caster Diffuse Texture Normalmap Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character"
---

# Generic Shadow Caster Diffuse Texture Normalmap Rl Cops Skinned 3weights Vertex Color Vertex Color Alpha Vertex Color Character
(`generic:shadow_caster:DIFFUSE_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS:VERTEX_COLOR:VERTEX_COLOR_ALPHA:VERTEX_COLOR_CHARACTER`, `0xc1764c2c1a8faecc`)
