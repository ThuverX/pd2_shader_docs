---
id: 0xc07ac35dfd748b19
title: "Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Instanced Normalmap Nvidia Vertex Color"
---

# Generic Shadow Caster Cube Environment Mapping Diffuse Texture Gloss Blurs Cubemap Gloss Control Value Instanced Normalmap Nvidia Vertex Color
(`generic:shadow_caster:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:INSTANCED:NORMALMAP:NVIDIA:VERTEX_COLOR`, `0xc07ac35dfd748b19`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_BLURS_CUBEMAP:GLOSS_CONTROL_VALUE:INSTANCED:NORMALMAP:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gloss-blurs-cubemap-gloss-control-value-instanced-normalmap-vertex-color).
