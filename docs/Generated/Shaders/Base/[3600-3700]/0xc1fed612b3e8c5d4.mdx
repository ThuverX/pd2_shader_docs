---
id: 0xc1fed612b3e8c5d4
title: "Generic Default Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Simple Tint"
---

# Generic Default Cube Environment Mapping Diffuse Texture Gloss Control Value Normalmap Simple Tint
(`generic:default:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT`, `0xc1fed612b3e8c5d4`)

This template is referenced 1 time by [generic:CUBE_ENVIRONMENT_MAPPING:DIFFUSE_TEXTURE:GLOSS_CONTROL_VALUE:NORMALMAP:SIMPLE_TINT](/docs/Generated/Render%20Templates/base.render_template_database#generic-cube-environment-mapping-diffuse-texture-gloss-control-value-normalmap-simple-tint).
