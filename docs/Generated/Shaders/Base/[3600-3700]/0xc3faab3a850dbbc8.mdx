---
id: 0xc3faab3a850dbbc8
title: "Generic Shadow Caster Ati Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights"
---

# Generic Shadow Caster Ati Diffuse Texture Double Sided Global Environment Mapping Gloss Blurs Cubemap Gsma Texture Normalmap Rl Cops Skinned 3weights
(`generic:shadow_caster:ATI:DIFFUSE_TEXTURE:DOUBLE_SIDED:GLOBAL_ENVIRONMENT_MAPPING:GLOSS_BLURS_CUBEMAP:GSMA_TEXTURE:NORMALMAP:RL_COPS:SKINNED_3WEIGHTS`, `0xc3faab3a850dbbc8`)
