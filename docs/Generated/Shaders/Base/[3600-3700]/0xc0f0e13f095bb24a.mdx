---
id: 0xc0f0e13f095bb24a
title: "Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Opacity Controller Vertex Color"
---

# Opacity Default Cube Environment Mapping Cube Fresnel Diffuse Texture Instanced Normalmap Opacity Controller Vertex Color
(`opacity:default:CUBE_ENVIRONMENT_MAPPING:CUBE_FRESNEL:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:OPACITY_CONTROLLER:VERTEX_COLOR`, `0xc0f0e13f095bb24a`)
