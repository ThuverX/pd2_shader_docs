---
id: 0xc2aef78310c02c3c
title: "Generic Shadow Caster Diffuse Texture Nvidia Rl Civilians Self Illumination Skinned 1weight"
---

# Generic Shadow Caster Diffuse Texture Nvidia Rl Civilians Self Illumination Skinned 1weight
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:RL_CIVILIANS:SELF_ILLUMINATION:SKINNED_1WEIGHT`, `0xc2aef78310c02c3c`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:RL_CIVILIANS:SELF_ILLUMINATION:SKINNED_1WEIGHT](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-rl-civilians-self-illumination-skinned-1weight).
