---
id: 0xc47e9add0391ff05
title: "Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap Rl Environment Vertex Color"
---

# Generic Default Blend Diffuse Blend Mask Seperate Blend Normal Blend Smooth Diffuse Texture Instanced Normalmap Rl Environment Vertex Color
(`generic:default:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR`, `0xc47e9add0391ff05`)

This template is referenced 1 time by [generic:BLEND_DIFFUSE:BLEND_MASK_SEPERATE:BLEND_NORMAL:BLEND_SMOOTH:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP:RL_ENVIRONMENT:VERTEX_COLOR](/docs/Generated/Render%20Templates/base.render_template_database#generic-blend-diffuse-blend-mask-seperate-blend-normal-blend-smooth-diffuse-texture-instanced-normalmap-rl-environment-vertex-color).
...
PixelMain_Output PixelMain(PixelMain_Input i)
{
    ...
    // add_pp r2.x, r2.y, -v5.w
    temp2.x = /* not implemented _pp modifier */ temp2.y + -i.color.w;
    // mul_sat_pp r2.x, r2.x, c0.x
    ;// error
