---
id: 0xc1848dddc5a04d27
title: "Generic Shadow Caster Diffuse Texture Global Environment Mapping Gsma Texture Instanced Normalmap Nvidia"
---

# Generic Shadow Caster Diffuse Texture Global Environment Mapping Gsma Texture Instanced Normalmap Nvidia
(`generic:shadow_caster:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:INSTANCED:NORMALMAP:NVIDIA`, `0xc1848dddc5a04d27`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:GLOBAL_ENVIRONMENT_MAPPING:GSMA_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-global-environment-mapping-gsma-texture-instanced-normalmap).
