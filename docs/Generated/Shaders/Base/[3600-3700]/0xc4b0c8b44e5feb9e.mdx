---
id: 0xc4b0c8b44e5feb9e
title: "Generic Shadow Caster Diffuse Texture Double Sided Instanced Normalmap Nvidia Self Illumination"
---

# Generic Shadow Caster Diffuse Texture Double Sided Instanced Normalmap Nvidia Self Illumination
(`generic:shadow_caster:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:NVIDIA:SELF_ILLUMINATION`, `0xc4b0c8b44e5feb9e`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:DOUBLE_SIDED:INSTANCED:NORMALMAP:SELF_ILLUMINATION](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-double-sided-instanced-normalmap-self-illumination).
