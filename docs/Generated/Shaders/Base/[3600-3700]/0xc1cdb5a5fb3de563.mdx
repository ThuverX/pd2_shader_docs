---
id: 0xc1cdb5a5fb3de563
title: "Generic Shadow Caster Contour Depth Scaling Diffuse Texture Gsma Texture Normalmap Normalmap Uv1 Nvidia"
---

# Generic Shadow Caster Contour Depth Scaling Diffuse Texture Gsma Texture Normalmap Normalmap Uv1 Nvidia
(`generic:shadow_caster:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NORMALMAP_UV1:NVIDIA`, `0xc1cdb5a5fb3de563`)

This template is referenced 1 time by [generic:CONTOUR:DEPTH_SCALING:DIFFUSE_TEXTURE:GSMA_TEXTURE:NORMALMAP:NORMALMAP_UV1](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-depth-scaling-diffuse-texture-gsma-texture-normalmap-normalmap-uv1).
