---
id: 0xc450198d71a3ebce
title: "Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint View Angle Falloff Op"
---

# Effect Default Blend Add Diffuse0 Texture Diffuse0 Tint View Angle Falloff Op
(`effect:default:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:VIEW_ANGLE_FALLOFF_OP`, `0xc450198d71a3ebce`)

This template is referenced 1 time by [effect:BLEND_ADD:DIFFUSE0_TEXTURE:DIFFUSE0_TINT:VIEW_ANGLE_FALLOFF_OP](/docs/Generated/Render%20Templates/base.render_template_database#effect-blend-add-diffuse0-texture-diffuse0-tint-view-angle-falloff-op).
