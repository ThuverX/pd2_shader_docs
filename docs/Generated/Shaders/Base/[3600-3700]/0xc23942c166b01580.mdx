---
id: 0xc23942c166b01580
title: "Generic Default Contour Diffuse Texture Instanced Normalmap"
---

# Generic Default Contour Diffuse Texture Instanced Normalmap
(`generic:default:CONTOUR:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP`, `0xc23942c166b01580`)

This template is referenced 1 time by [generic:CONTOUR:DIFFUSE_TEXTURE:INSTANCED:NORMALMAP](/docs/Generated/Render%20Templates/base.render_template_database#generic-contour-diffuse-texture-instanced-normalmap).
...
#### Pixel Shader
```hlsl
float3 ref_contour_color : register(ps_3_0, c0);
float ref_contour_opacity : register(ps_3_0, c1);
float4 PixelMain() : COLOR
{
    float4 out_color;
    float temp0;
    // frc r0.x, -c1.x
    temp0.x = frac(-ref_contour_opacity.x);
    // add_pp oC0.w, r0.x, c1.x
    out_color.w = /* not implemented _pp modifier */ temp0.x + ref_contour_opacity.x;
    // mov_pp oC0.xyz, c0
