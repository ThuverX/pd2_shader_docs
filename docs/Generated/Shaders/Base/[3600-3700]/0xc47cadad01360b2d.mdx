---
id: 0xc47cadad01360b2d
title: "Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Self Illumination Uvanim"
---

# Generic Shadow Caster Diffuse Texture Nvidia Self Illumination Self Illumination Uvanim
(`generic:shadow_caster:DIFFUSE_TEXTURE:NVIDIA:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM`, `0xc47cadad01360b2d`)

This template is referenced 1 time by [generic:DIFFUSE_TEXTURE:SELF_ILLUMINATION:SELF_ILLUMINATION_UVANIM](/docs/Generated/Render%20Templates/base.render_template_database#generic-diffuse-texture-self-illumination-self-illumination-uvanim).
