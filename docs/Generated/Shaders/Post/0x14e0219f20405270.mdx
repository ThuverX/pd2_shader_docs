...
This template is referenced 1 time by [post_color_grading:CAMERA](/docs/Generated/Render%20Templates/post.render_template_database#post-color-grading-camera).
