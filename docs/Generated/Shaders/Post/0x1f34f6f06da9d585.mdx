---
id: 0x1f34f6f06da9d585
title: "Post Shadow Upscale Default Step Two"
---

# Post Shadow Upscale Default Step Two
(`post_shadow_upscale:default:STEP_TWO`, `0x1f34f6f06da9d585`)

This template is referenced 1 time by [post_shadow_upscale:STEP_TWO](/docs/Generated/Render%20Templates/post.render_template_database#post-shadow-upscale-step-two).
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    // add r0.x, r0.z, r1.z
    temp0.x = temp0.z + temp1.z;
    // texld r2, v1.zwzw, s0
    temp2 = tex2D(diffuse_texture, i.texcoord1.zw);
    // add r0.x, r0.x, r2.z
    temp0.x = temp0.x + temp2.z;
    // texld r3, v2, s0
    temp3 = tex2D(diffuse_texture, i.texcoord2.xy);
    // add r0.x, r0.x, r3.z
    temp0.x = temp0.x + temp3.z;
    // texld r4, v2.zwzw, s0
    temp4 = tex2D(diffuse_texture, i.texcoord2.zw);
    // add r0.x, r0.x, r4.w
    temp0.x = temp0.x + temp4.w;
    // min r0.y, r4.w, r3.w
    temp0.y = min(temp4.w, temp3.w);
    // min r1.x, r0.y, r2.w
    temp1.x = min(temp0.y, temp2.w);
    // min r0.y, r1.x, r1.w
    temp0.y = min(temp1.x, temp1.w);
    // min oC0.y, r0.y, r0.w
    out_color.y = min(temp0.y, temp0.w);
    // mul oC0.x, r0.x, c0.x
