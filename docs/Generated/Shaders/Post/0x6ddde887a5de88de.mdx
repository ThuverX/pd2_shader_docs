---
id: 0x6ddde887a5de88de
title: "Post Night Vision Default Vr"
---

# Post Night Vision Default Vr
(`post_night_vision:default:VR`, `0x6ddde887a5de88de`)

This template is referenced 1 time by [post_night_vision:VR](/docs/Generated/Render%20Templates/post.render_template_database#post-night-vision-vr).
...
float4 PixelMain(PixelMain_Input i) : COLOR
{
    ...
    // add_pp oC0, r0.x, r1
    out_color = /* not implemented _pp modifier */ temp0.x + temp1;
    // 
