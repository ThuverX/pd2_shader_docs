---
title: "Lookup8 hashing algorithm"
---

Payday 2 uses a hash function called Lookup8 by [Bob Jenkins](http://burtleburtle.net/bob/). It is used to hash strings, and is used in the game to hash the names of assets, units, and other things. This is done as looking up numbers is faster than looking up strings. They are represented by 64-bit unsigned integers.
...
We can use these hashlists to, for example, get the name of a shader template from its hash.

| Hash | String | Description |
| --- | --- | --- |
|0xd27572dffb2bf04d|ambient|The name of a shader technique|
|0xacd7e97e39acda9e|amcar|The name of a weapon|
|...|...|...|

One of the most complete hashlists can be found [here](https://github.com/Luffyyy/PAYDAY-2-Hashlist).

## Implementation

The implementation of the algorithm is as follows (from [Bob's website](https://burtleburtle.net/bob/c/lookup8.c)):
